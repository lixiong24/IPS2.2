...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class UserMessageRepositoryADO : IUserMessageRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public UserMessageRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from UserMessage where 1=1 ";
		...
		{
			return _DB.GetMaxID("UserMessage", "MessageID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("UserMessage", "MessageID"));
		}
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(UserMessageEntity entity)
		{
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.Int32 messageID)
		{
			string strSQL = "delete from UserMessage where " +
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 messageID)
		{
			string strSQL = "delete from UserMessage where " +
		...
		{
			string strSQL = "delete from UserMessage where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(UserMessageEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update UserMessage SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public UserMessageEntity GetEntity(System.Int32 messageID)
		{
			string strCondition = string.Empty;
			strCondition += " and MessageID = @MessageID";
		...
		/// </summary>
		/// <returns></returns>
		public async Task<UserMessageEntity> GetEntityAsync(System.Int32 messageID)
		{
			string strCondition = string.Empty;
			strCondition += " and MessageID = @MessageID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual UserMessageEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<UserMessageEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<UserMessageEntity> list = new List<UserMessageEntity>();
			string strSQL = "select * from UserMessage where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<UserMessageEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<UserMessageEntity> list = new List<UserMessageEntity>();
			string strSQL = "select * from UserMessage where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from UserMessage where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<UserMessageEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<UserMessageEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<UserMessageEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
