...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class U_IntegralProductLogRepositoryADO : IU_IntegralProductLogRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		{
			string strSQL = "select " + statistic + " from U_IntegralProductLog where 1=1 ";
		...
		{
			return _DB.GetMaxID("U_IntegralProductLog", "ID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("U_IntegralProductLog", "ID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(U_IntegralProductLogEntity entity)
		{
			if(entity.ID <= 0) entity.ID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into U_IntegralProductLog ("+
							"ID,"+
							"ProductID,"+
							"UserID,"+
							"NeedS,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(U_IntegralProductLogEntity entity)
		{
			if(entity.ID <= 0) entity.ID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(U_IntegralProductLogEntity entity)
		{
			if(entity.ID <= 0) entity.ID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(U_IntegralProductLogEntity entity)
		{
			if(entity.ID <= 0) entity.ID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(U_IntegralProductLogEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(U_IntegralProductLogEntity entity, bool IsSave)
		{
		...
		{
			string strSQL = "delete from U_IntegralProductLog where " +
		...
		{
			string strSQL = "delete from U_IntegralProductLog where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(U_IntegralProductLogEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update U_IntegralProductLog SET "+
			"ProductID = @ProductID,"+
			"UserID = @UserID,"+
			"NeedS = @NeedS,"+
			"BuyTime = @BuyTime,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(U_IntegralProductLogEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update U_IntegralProductLog SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update U_IntegralProductLog SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public U_IntegralProductLogEntity GetEntity(System.Int32 id)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<U_IntegralProductLogEntity> GetEntityAsync(System.Int32 id)
		{
			string strCondition = string.Empty;
			strCondition += " and ID = @ID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual U_IntegralProductLogEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			U_IntegralProductLogEntity obj = null;
			string strSQL = "select top 1 * from U_IntegralProductLog where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<U_IntegralProductLogEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			U_IntegralProductLogEntity obj = null;
			string strSQL = "select top 1 * from U_IntegralProductLog where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<U_IntegralProductLogEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<U_IntegralProductLogEntity> list = new List<U_IntegralProductLogEntity>();
			string strSQL = "select * from U_IntegralProductLog where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<U_IntegralProductLogEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<U_IntegralProductLogEntity> list = new List<U_IntegralProductLogEntity>();
			string strSQL = "select * from U_IntegralProductLog where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from U_IntegralProductLog where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<U_IntegralProductLogEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		public virtual IList<U_IntegralProductLogEntity> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			...
			{
				TableName = "U_IntegralProductLog";
			}
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<U_IntegralProductLogEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<U_IntegralProductLogEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(U_IntegralProductLogEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("ID", entity.ID);
			dict.Add("ProductID", entity.ProductID);
			dict.Add("UserID", entity.UserID);
			dict.Add("NeedS", entity.NeedS);
			dict.Add("BuyTime", entity.BuyTime);
			dict.Add("BuyCounts", entity.BuyCounts);
			dict.Add("BuyState", entity.BuyState);
		}
		/// <summary>
		/// 通过数据读取器生成实体类
		/// </summary>
