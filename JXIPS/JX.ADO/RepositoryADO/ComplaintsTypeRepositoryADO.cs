...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class ComplaintsTypeRepositoryADO : IComplaintsTypeRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public ComplaintsTypeRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from ComplaintsType where 1=1 ";
		...
		{
			return _DB.GetMaxID("ComplaintsType", "CID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("ComplaintsType", "CID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(ComplaintsTypeEntity entity)
		{
			if(entity.CID <= 0) entity.CID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into ComplaintsType ("+
							"CID,"+
							"CDType,"+
							"CName) "+
							"values("+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(ComplaintsTypeEntity entity)
		{
			if(entity.CID <= 0) entity.CID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(ComplaintsTypeEntity entity)
		{
			if(entity.CID <= 0) entity.CID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(ComplaintsTypeEntity entity)
		{
			if(entity.CID <= 0) entity.CID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(ComplaintsTypeEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(ComplaintsTypeEntity entity, bool IsSave)
		{
		...
		{
			string strSQL = "delete from ComplaintsType where " +
		...
		{
			string strSQL = "delete from ComplaintsType where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(ComplaintsTypeEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update ComplaintsType SET "+
			"CDType = @CDType,"+
			"CName = @CName"+
			" WHERE "+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(ComplaintsTypeEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update ComplaintsType SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update ComplaintsType SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public ComplaintsTypeEntity GetEntity(System.Int32 cid)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<ComplaintsTypeEntity> GetEntityAsync(System.Int32 cid)
		{
			string strCondition = string.Empty;
			strCondition += " and CID = @CID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual ComplaintsTypeEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			ComplaintsTypeEntity obj = null;
			string strSQL = "select top 1 * from ComplaintsType where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<ComplaintsTypeEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			ComplaintsTypeEntity obj = null;
			string strSQL = "select top 1 * from ComplaintsType where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<ComplaintsTypeEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<ComplaintsTypeEntity> list = new List<ComplaintsTypeEntity>();
			string strSQL = "select * from ComplaintsType where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<ComplaintsTypeEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<ComplaintsTypeEntity> list = new List<ComplaintsTypeEntity>();
			string strSQL = "select * from ComplaintsType where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from ComplaintsType where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<ComplaintsTypeEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ComplaintsTypeEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ComplaintsTypeEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(ComplaintsTypeEntity entity, Dictionary<string, object> dict)
		{
