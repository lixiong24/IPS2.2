...
namespace JX.ADO
{
	...
	/// 数据库表：Address 的仓储实现类.
	/// </summary>
	public partial class AddressRepositoryADO : IAddressRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public AddressRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from Address where 1=1 ";
		...
		{
			return _DB.GetMaxID("Address", "AddressID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("Address", "AddressID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(AddressEntity entity)
		{
			if(entity.AddressID <= 0) entity.AddressID=GetNewID();
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(AddressEntity entity)
		{
			if(entity.AddressID <= 0) entity.AddressID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(AddressEntity entity)
		{
			if(entity.AddressID <= 0) entity.AddressID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
			...
			{
				return DataConverter.CLng(entity.AddressID);
			}
			return -1;
		}
		/// <summary>
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(AddressEntity entity)
		{
			if(entity.AddressID <= 0) entity.AddressID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.Int32 addressID)
		{
			string strSQL = "delete from Address where " +
			
			"AddressID = @AddressID"; 
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			dict.Add("AddressID", addressID);
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 addressID)
		{
			string strSQL = "delete from Address where " +
		...
		{
			string strSQL = "delete from Address where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(AddressEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update Address SET "+
			"UserName = @UserName,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(AddressEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update Address SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update Address SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public AddressEntity GetEntity(System.Int32 addressID)
		{
			string strCondition = string.Empty;
			strCondition += " and AddressID = @AddressID";
		...
		/// </summary>
		/// <returns></returns>
		public async Task<AddressEntity> GetEntityAsync(System.Int32 addressID)
		{
			string strCondition = string.Empty;
			strCondition += " and AddressID = @AddressID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual AddressEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			AddressEntity obj = null;
			string strSQL = "select top 1 * from Address where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<AddressEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			AddressEntity obj = null;
			string strSQL = "select top 1 * from Address where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<AddressEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<AddressEntity> list = new List<AddressEntity>();
			string strSQL = "select * from Address where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<AddressEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<AddressEntity> list = new List<AddressEntity>();
			string strSQL = "select * from Address where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from Address where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<AddressEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<AddressEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<AddressEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(AddressEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("AddressID", entity.AddressID);
			dict.Add("UserName", entity.UserName);
			dict.Add("ConsigneeName", entity.ConsigneeName);
			...
			dict.Add("Addresses", entity.Addresses);
