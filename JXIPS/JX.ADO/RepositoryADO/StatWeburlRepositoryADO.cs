...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class StatWeburlRepositoryADO : IStatWeburlRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public StatWeburlRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from StatWeburl where 1=1 ";
		...
		{
			return _DB.GetMaxID("StatWeburl", "TWeburl");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("StatWeburl", "TWeburl"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(StatWeburlEntity entity)
		{
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into StatWeburl ("+
							"TWeburl,"+
							"TWebNum) "+
							"values("+
							"@TWeburl,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(StatWeburlEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(StatWeburlEntity entity)
		{
			...
			{
				return DataConverter.CLng(entity.TWeburl);
			}
			return -1;
		}
		/// <summary>
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(StatWeburlEntity entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(StatWeburlEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(StatWeburlEntity entity, bool IsSave)
		{
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.String tWeburl)
		{
			string strSQL = "delete from StatWeburl where " +
			
			"TWeburl = @TWeburl"; 
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			dict.Add("TWeburl", tWeburl);
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.String tWeburl)
		{
			string strSQL = "delete from StatWeburl where " +
		...
		{
			string strSQL = "delete from StatWeburl where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(StatWeburlEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update StatWeburl SET "+
			"TWebNum = @TWebNum"+
			" WHERE "+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(StatWeburlEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update StatWeburl SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update StatWeburl SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public StatWeburlEntity GetEntity(System.String tWeburl)
		{
			string strCondition = string.Empty;
			strCondition += " and TWeburl = @TWeburl";
		...
		/// </summary>
		/// <returns></returns>
		public async Task<StatWeburlEntity> GetEntityAsync(System.String tWeburl)
		{
			string strCondition = string.Empty;
			strCondition += " and TWeburl = @TWeburl";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual StatWeburlEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			StatWeburlEntity obj = null;
			string strSQL = "select top 1 * from StatWeburl where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<StatWeburlEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			StatWeburlEntity obj = null;
			string strSQL = "select top 1 * from StatWeburl where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<StatWeburlEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<StatWeburlEntity> list = new List<StatWeburlEntity>();
			string strSQL = "select * from StatWeburl where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<StatWeburlEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<StatWeburlEntity> list = new List<StatWeburlEntity>();
			string strSQL = "select * from StatWeburl where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from StatWeburl where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<StatWeburlEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatWeburlEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatWeburlEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(StatWeburlEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("TWeburl", entity.TWeburl);
			dict.Add("TWebNum", entity.TWebNum);
		}
		/// <summary>
		/// 通过数据读取器生成实体类
		/// </summary>
