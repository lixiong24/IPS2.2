...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class NodesModelTemplateRepositoryADO : INodesModelTemplateRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public NodesModelTemplateRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from NodesModelTemplate where 1=1 ";
		...
		{
			return _DB.GetMaxID("NodesModelTemplate", "NodeID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("NodesModelTemplate", "NodeID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(NodesModelTemplateEntity entity)
		{
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into NodesModelTemplate ("+
							"NodeID,"+
							"ModelID,"+
							"DefaultTemplateFile) "+
							"values("+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(NodesModelTemplateEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(NodesModelTemplateEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(NodesModelTemplateEntity entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(NodesModelTemplateEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(NodesModelTemplateEntity entity, bool IsSave)
		{
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.Int32 nodeID, System.Int32 modelID)
		{
			string strSQL = "delete from NodesModelTemplate where " +
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 nodeID, System.Int32 modelID)
		{
			string strSQL = "delete from NodesModelTemplate where " +
		...
		{
			string strSQL = "delete from NodesModelTemplate where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(NodesModelTemplateEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update NodesModelTemplate SET "+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(NodesModelTemplateEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update NodesModelTemplate SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update NodesModelTemplate SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public NodesModelTemplateEntity GetEntity(System.Int32 nodeID, System.Int32 modelID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<NodesModelTemplateEntity> GetEntityAsync(System.Int32 nodeID, System.Int32 modelID)
		{
			string strCondition = string.Empty;
			strCondition += " and NodeID = @NodeID";
			strCondition += " and ModelID = @ModelID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual NodesModelTemplateEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			NodesModelTemplateEntity obj = null;
			string strSQL = "select top 1 * from NodesModelTemplate where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<NodesModelTemplateEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			NodesModelTemplateEntity obj = null;
			string strSQL = "select top 1 * from NodesModelTemplate where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<NodesModelTemplateEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<NodesModelTemplateEntity> list = new List<NodesModelTemplateEntity>();
			string strSQL = "select * from NodesModelTemplate where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<NodesModelTemplateEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<NodesModelTemplateEntity> list = new List<NodesModelTemplateEntity>();
			string strSQL = "select * from NodesModelTemplate where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from NodesModelTemplate where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<NodesModelTemplateEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<NodesModelTemplateEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<NodesModelTemplateEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(NodesModelTemplateEntity entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static NodesModelTemplateEntity GetEntityFromrdr(NullableDataReader rdr)
		{
			NodesModelTemplateEntity info = new NodesModelTemplateEntity();
