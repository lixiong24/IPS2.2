...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class ProducerRepositoryADO : IProducerRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public ProducerRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from Producer where 1=1 ";
		...
		{
			return _DB.GetMaxID("Producer", "ProducerID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("Producer", "ProducerID"));
		}
		...
		{
			if(entity.ProducerID <= 0) entity.ProducerID=GetNewID();
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(ProducerEntity entity)
		{
			if(entity.ProducerID <= 0) entity.ProducerID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(ProducerEntity entity)
		{
			if(entity.ProducerID <= 0) entity.ProducerID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.Int32 producerID)
		{
			string strSQL = "delete from Producer where " +
			
			"ProducerID = @ProducerID"; 
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			dict.Add("ProducerID", producerID);
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 producerID)
		{
			string strSQL = "delete from Producer where " +
		...
		{
			string strSQL = "delete from Producer where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(ProducerEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update Producer SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public ProducerEntity GetEntity(System.Int32 producerID)
		{
			string strCondition = string.Empty;
			strCondition += " and ProducerID = @ProducerID";
		...
		/// </summary>
		/// <returns></returns>
		public async Task<ProducerEntity> GetEntityAsync(System.Int32 producerID)
		{
			string strCondition = string.Empty;
			strCondition += " and ProducerID = @ProducerID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual ProducerEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<ProducerEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<ProducerEntity> list = new List<ProducerEntity>();
			string strSQL = "select * from Producer where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<ProducerEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<ProducerEntity> list = new List<ProducerEntity>();
			string strSQL = "select * from Producer where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from Producer where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<ProducerEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ProducerEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ProducerEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
