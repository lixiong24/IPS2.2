...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class DeliverLogRepositoryADO : IDeliverLogRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public DeliverLogRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from DeliverLog where 1=1 ";
		...
		{
			return _DB.GetMaxID("DeliverLog", "DeliverID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("DeliverLog", "DeliverID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(DeliverLogEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(DeliverLogEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(DeliverLogEntity entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(DeliverLogEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(DeliverLogEntity entity, bool IsSave)
		{
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.Int32 deliverID)
		{
			string strSQL = "delete from DeliverLog where " +
			
			"DeliverID = @DeliverID"; 
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			dict.Add("DeliverID", deliverID);
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 deliverID)
		{
			string strSQL = "delete from DeliverLog where " +
		...
		{
			string strSQL = "delete from DeliverLog where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(DeliverLogEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update DeliverLog SET "+
			"OrderID = @OrderID,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(DeliverLogEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update DeliverLog SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update DeliverLog SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public DeliverLogEntity GetEntity(System.Int32 deliverID)
		{
			string strCondition = string.Empty;
			strCondition += " and DeliverID = @DeliverID";
		...
		/// </summary>
		/// <returns></returns>
		public async Task<DeliverLogEntity> GetEntityAsync(System.Int32 deliverID)
		{
			string strCondition = string.Empty;
			strCondition += " and DeliverID = @DeliverID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<DeliverLogEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			DeliverLogEntity obj = null;
			string strSQL = "select top 1 * from DeliverLog where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<DeliverLogEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<DeliverLogEntity> list = new List<DeliverLogEntity>();
			string strSQL = "select * from DeliverLog where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<DeliverLogEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<DeliverLogEntity> list = new List<DeliverLogEntity>();
			string strSQL = "select * from DeliverLog where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from DeliverLog where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<DeliverLogEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<DeliverLogEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<DeliverLogEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(DeliverLogEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("DeliverID", entity.DeliverID);
			dict.Add("OrderID", entity.OrderID);
			dict.Add("DeliverDate", entity.DeliverDate);
			dict.Add("DeliverDirection", entity.DeliverDirection);
			dict.Add("HandlerName", entity.HandlerName);
			dict.Add("CourierId", entity.CourierId);
			dict.Add("ExpressNumber", entity.ExpressNumber);
			dict.Add("Inputer", entity.Inputer);
			dict.Add("Remark", entity.Remark);
			dict.Add("IsReceived", entity.IsReceived);
			dict.Add("ReceivedDate", entity.ReceivedDate);
		...
		/// <returns></returns>
		private static DeliverLogEntity GetEntityFromrdr(NullableDataReader rdr)
		{
			DeliverLogEntity info = new DeliverLogEntity();
			info.DeliverID = rdr.GetInt32("DeliverID");
			info.OrderID = rdr.GetInt32("OrderID");
			info.DeliverDate = rdr.GetNullableDateTime("DeliverDate");
			...
			info.IsReceived = rdr.GetBoolean("IsReceived");
			info.ReceivedDate = rdr.GetNullableDateTime("ReceivedDate");
