...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class WorkNextProcessRolesRepositoryADO : IWorkNextProcessRolesRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public WorkNextProcessRolesRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from WorkNextProcessRoles where 1=1 ";
		...
		{
			return _DB.GetMaxID("WorkNextProcessRoles", "WorkID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("WorkNextProcessRoles", "WorkID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(WorkNextProcessRolesEntity entity)
		{
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into WorkNextProcessRoles ("+
							"WorkID,"+
							"RoleID) "+
							"values("+
							"@WorkID,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(WorkNextProcessRolesEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(WorkNextProcessRolesEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(WorkNextProcessRolesEntity entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(WorkNextProcessRolesEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(WorkNextProcessRolesEntity entity, bool IsSave)
		{
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.Int32 workID, System.Int32 roleID)
		{
			string strSQL = "delete from WorkNextProcessRoles where " +
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 workID, System.Int32 roleID)
		{
			string strSQL = "delete from WorkNextProcessRoles where " +
		...
		{
			string strSQL = "delete from WorkNextProcessRoles where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(WorkNextProcessRolesEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update WorkNextProcessRoles SET "+
			" WHERE "+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(WorkNextProcessRolesEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update WorkNextProcessRoles SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update WorkNextProcessRoles SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public WorkNextProcessRolesEntity GetEntity(System.Int32 workID, System.Int32 roleID)
		{
			string strCondition = string.Empty;
			strCondition += " and WorkID = @WorkID";
		...
		/// </summary>
		/// <returns></returns>
		public async Task<WorkNextProcessRolesEntity> GetEntityAsync(System.Int32 workID, System.Int32 roleID)
		{
			string strCondition = string.Empty;
			strCondition += " and WorkID = @WorkID";
			strCondition += " and RoleID = @RoleID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual WorkNextProcessRolesEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			WorkNextProcessRolesEntity obj = null;
			string strSQL = "select top 1 * from WorkNextProcessRoles where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<WorkNextProcessRolesEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			WorkNextProcessRolesEntity obj = null;
			string strSQL = "select top 1 * from WorkNextProcessRoles where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<WorkNextProcessRolesEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<WorkNextProcessRolesEntity> list = new List<WorkNextProcessRolesEntity>();
			string strSQL = "select * from WorkNextProcessRoles where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<WorkNextProcessRolesEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<WorkNextProcessRolesEntity> list = new List<WorkNextProcessRolesEntity>();
			string strSQL = "select * from WorkNextProcessRoles where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from WorkNextProcessRoles where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<WorkNextProcessRolesEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		public virtual IList<WorkNextProcessRolesEntity> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			...
			{
				TableName = "WorkNextProcessRoles";
			}
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<WorkNextProcessRolesEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<WorkNextProcessRolesEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(WorkNextProcessRolesEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("WorkID", entity.WorkID);
		...
		/// <returns></returns>
		private static WorkNextProcessRolesEntity GetEntityFromrdr(NullableDataReader rdr)
		{
			WorkNextProcessRolesEntity info = new WorkNextProcessRolesEntity();
