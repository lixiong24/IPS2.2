...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class CouponLogRepositoryADO : ICouponLogRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public CouponLogRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from CouponLog where 1=1 ";
		...
		{
			return _DB.GetMaxID("CouponLog", "ID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("CouponLog", "ID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(CouponLogEntity entity)
		{
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into CouponLog ("+
							"CouponID,"+
							"CouponNum,"+
							"UserID,"+
							"OrderID,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(CouponLogEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(CouponLogEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(CouponLogEntity entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(CouponLogEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(CouponLogEntity entity, bool IsSave)
		{
		...
		{
			string strSQL = "delete from CouponLog where " +
		...
		{
			string strSQL = "delete from CouponLog where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(CouponLogEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update CouponLog SET "+
			"CouponID = @CouponID,"+
			"CouponNum = @CouponNum,"+
			"UserID = @UserID,"+
			"OrderID = @OrderID,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(CouponLogEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update CouponLog SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update CouponLog SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public CouponLogEntity GetEntity(System.Int32 id)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<CouponLogEntity> GetEntityAsync(System.Int32 id)
		{
			string strCondition = string.Empty;
			strCondition += " and ID = @ID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual CouponLogEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			CouponLogEntity obj = null;
			string strSQL = "select top 1 * from CouponLog where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<CouponLogEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			CouponLogEntity obj = null;
			string strSQL = "select top 1 * from CouponLog where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<CouponLogEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<CouponLogEntity> list = new List<CouponLogEntity>();
			string strSQL = "select * from CouponLog where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<CouponLogEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<CouponLogEntity> list = new List<CouponLogEntity>();
			string strSQL = "select * from CouponLog where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from CouponLog where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<CouponLogEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CouponLogEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CouponLogEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(CouponLogEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("ID", entity.ID);
			dict.Add("CouponID", entity.CouponID);
			dict.Add("CouponNum", entity.CouponNum);
			dict.Add("UserID", entity.UserID);
			dict.Add("OrderID", entity.OrderID);
			dict.Add("Usetimes", entity.Usetimes);
		}
		/// <summary>
		/// 通过数据读取器生成实体类
		/// </summary>
		...
		/// <returns></returns>
		private static CouponLogEntity GetEntityFromrdr(NullableDataReader rdr)
		{
			CouponLogEntity info = new CouponLogEntity();
			info.ID = rdr.GetInt32("ID");
			info.CouponID = rdr.GetInt32("CouponID");
			info.CouponNum = rdr.GetString("CouponNum");
			info.UserID = rdr.GetInt32("UserID");
			info.OrderID = rdr.GetInt32("OrderID");
			info.Usetimes = rdr.GetInt32("Usetimes");
			return info;
		}
		#endregion
	}
