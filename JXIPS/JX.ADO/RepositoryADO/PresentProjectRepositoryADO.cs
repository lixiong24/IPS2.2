...
{
	/// <summary>
	/// 数据库表：PresentProject 的仓储实现类.
	/// </summary>
	public partial class PresentProjectRepositoryADO : IPresentProjectRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public PresentProjectRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from PresentProject where 1=1 ";
		...
		{
			return _DB.GetMaxID("PresentProject", "ProjectID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("PresentProject", "ProjectID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(PresentProjectEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(PresentProjectEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(PresentProjectEntity entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(PresentProjectEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(PresentProjectEntity entity, bool IsSave)
		{
		...
		{
			string strSQL = "delete from PresentProject where " +
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 projectID)
		{
			string strSQL = "delete from PresentProject where " +
		...
		{
			string strSQL = "delete from PresentProject where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(PresentProjectEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update PresentProject SET "+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(PresentProjectEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update PresentProject SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update PresentProject SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public PresentProjectEntity GetEntity(System.Int32 projectID)
		{
			string strCondition = string.Empty;
			strCondition += " and ProjectID = @ProjectID";
		...
		/// </summary>
		/// <returns></returns>
		public async Task<PresentProjectEntity> GetEntityAsync(System.Int32 projectID)
		{
			string strCondition = string.Empty;
			strCondition += " and ProjectID = @ProjectID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual PresentProjectEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			PresentProjectEntity obj = null;
			string strSQL = "select top 1 * from PresentProject where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<PresentProjectEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			PresentProjectEntity obj = null;
			string strSQL = "select top 1 * from PresentProject where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<PresentProjectEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<PresentProjectEntity> list = new List<PresentProjectEntity>();
			string strSQL = "select * from PresentProject where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<PresentProjectEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<PresentProjectEntity> list = new List<PresentProjectEntity>();
			string strSQL = "select * from PresentProject where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from PresentProject where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<PresentProjectEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<PresentProjectEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<PresentProjectEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(PresentProjectEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("ProjectID", entity.ProjectID);
			dict.Add("ProjectName", entity.ProjectName);
			dict.Add("BeginDate", entity.BeginDate);
			dict.Add("EndDate", entity.EndDate);
			dict.Add("MinMoney", entity.MinMoney);
			dict.Add("MaxMoney", entity.MaxMoney);
			dict.Add("PresentContent", entity.PresentContent);
			dict.Add("Price", entity.Price);
			dict.Add("PresentID", entity.PresentID);
			dict.Add("Cash", entity.Cash);
		...
		/// <returns></returns>
		private static PresentProjectEntity GetEntityFromrdr(NullableDataReader rdr)
		{
			PresentProjectEntity info = new PresentProjectEntity();
