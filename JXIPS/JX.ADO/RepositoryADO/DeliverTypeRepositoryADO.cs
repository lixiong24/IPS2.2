...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class DeliverTypeRepositoryADO : IDeliverTypeRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		{
			string strSQL = "select " + statistic + " from DeliverType where 1=1 ";
		...
		{
			return _DB.GetMaxID("DeliverType", "TypeID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("DeliverType", "TypeID"));
		}
		...
		{
			if(entity.TypeID <= 0) entity.TypeID=GetNewID();
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(DeliverTypeEntity entity)
		{
			if(entity.TypeID <= 0) entity.TypeID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(DeliverTypeEntity entity)
		{
			if(entity.TypeID <= 0) entity.TypeID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		{
			string strSQL = "delete from DeliverType where " +
		...
		{
			string strSQL = "delete from DeliverType where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(DeliverTypeEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update DeliverType SET "+
			"TypeName = @TypeName,"+
			"Intro = @Intro,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(DeliverTypeEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update DeliverType SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update DeliverType SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public DeliverTypeEntity GetEntity(System.Int32 typeID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<DeliverTypeEntity> GetEntityAsync(System.Int32 typeID)
		{
			string strCondition = string.Empty;
			strCondition += " and TypeID = @TypeID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual DeliverTypeEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<DeliverTypeEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<DeliverTypeEntity> list = new List<DeliverTypeEntity>();
			string strSQL = "select * from DeliverType where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<DeliverTypeEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<DeliverTypeEntity> list = new List<DeliverTypeEntity>();
			string strSQL = "select * from DeliverType where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from DeliverType where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<DeliverTypeEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<DeliverTypeEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<DeliverTypeEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
