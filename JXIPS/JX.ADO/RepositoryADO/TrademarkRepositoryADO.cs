...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class TrademarkRepositoryADO : ITrademarkRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public TrademarkRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from Trademark where 1=1 ";
		...
		{
			return _DB.GetMaxID("Trademark", "TrademarkID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("Trademark", "TrademarkID"));
		}
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(TrademarkEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(TrademarkEntity entity)
		{
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.Int32 trademarkID)
		{
			string strSQL = "delete from Trademark where " +
			
			"TrademarkID = @TrademarkID"; 
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			dict.Add("TrademarkID", trademarkID);
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 trademarkID)
		{
			string strSQL = "delete from Trademark where " +
		...
		{
			string strSQL = "delete from Trademark where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(TrademarkEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update Trademark SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public TrademarkEntity GetEntity(System.Int32 trademarkID)
		{
			string strCondition = string.Empty;
			strCondition += " and TrademarkID = @TrademarkID";
		...
		/// </summary>
		/// <returns></returns>
		public async Task<TrademarkEntity> GetEntityAsync(System.Int32 trademarkID)
		{
			string strCondition = string.Empty;
			strCondition += " and TrademarkID = @TrademarkID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual TrademarkEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<TrademarkEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<TrademarkEntity> list = new List<TrademarkEntity>();
			string strSQL = "select * from Trademark where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<TrademarkEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<TrademarkEntity> list = new List<TrademarkEntity>();
			string strSQL = "select * from Trademark where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from Trademark where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<TrademarkEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<TrademarkEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<TrademarkEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
