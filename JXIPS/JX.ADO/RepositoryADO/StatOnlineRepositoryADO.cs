...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class StatOnlineRepositoryADO : IStatOnlineRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		{
			string strSQL = "select " + statistic + " from StatOnline where 1=1 ";
		...
		{
			return _DB.GetMaxID("StatOnline", "ID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("StatOnline", "ID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(StatOnlineEntity entity)
		{
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into StatOnline ("+
							"UserIP,"+
							"UserAgent,"+
							"UserPage,"+
							"OnTime,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(StatOnlineEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(StatOnlineEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(StatOnlineEntity entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(StatOnlineEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(StatOnlineEntity entity, bool IsSave)
		{
		...
		{
			string strSQL = "delete from StatOnline where " +
		...
		{
			string strSQL = "delete from StatOnline where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(StatOnlineEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update StatOnline SET "+
			"UserIP = @UserIP,"+
			"UserAgent = @UserAgent,"+
			"UserPage = @UserPage,"+
			"OnTime = @OnTime,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(StatOnlineEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update StatOnline SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update StatOnline SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public StatOnlineEntity GetEntity(System.Int32 id)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<StatOnlineEntity> GetEntityAsync(System.Int32 id)
		{
			string strCondition = string.Empty;
			strCondition += " and ID = @ID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual StatOnlineEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			StatOnlineEntity obj = null;
			string strSQL = "select top 1 * from StatOnline where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<StatOnlineEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			StatOnlineEntity obj = null;
			string strSQL = "select top 1 * from StatOnline where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<StatOnlineEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<StatOnlineEntity> list = new List<StatOnlineEntity>();
			string strSQL = "select * from StatOnline where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<StatOnlineEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<StatOnlineEntity> list = new List<StatOnlineEntity>();
			string strSQL = "select * from StatOnline where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from StatOnline where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<StatOnlineEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatOnlineEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatOnlineEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(StatOnlineEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("ID", entity.ID);
			dict.Add("UserIP", entity.UserIP);
			dict.Add("UserAgent", entity.UserAgent);
			dict.Add("UserPage", entity.UserPage);
			dict.Add("OnTime", entity.OnTime);
			dict.Add("LastTime", entity.LastTime);
		}
		/// <summary>
		/// 通过数据读取器生成实体类
		/// </summary>
		...
		/// <returns></returns>
		private static StatOnlineEntity GetEntityFromrdr(NullableDataReader rdr)
		{
			StatOnlineEntity info = new StatOnlineEntity();
			...
			info.OnTime = rdr.GetNullableDateTime("OnTime");
			info.LastTime = rdr.GetNullableDateTime("LastTime");
			return info;
		}
		#endregion
	}
