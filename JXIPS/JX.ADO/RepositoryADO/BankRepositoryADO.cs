...
namespace JX.ADO
{
	...
	/// 数据库表：Bank 的仓储实现类.
	/// </summary>
	public partial class BankRepositoryADO : IBankRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		{
			string strSQL = "select " + statistic + " from Bank where 1=1 ";
		...
		{
			return _DB.GetMaxID("Bank", "BankID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("Bank", "BankID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(BankEntity entity)
		{
			if(entity.BankID <= 0) entity.BankID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into Bank ("+
							"BankID,"+
							"BankShortName,"+
							"BankName,"+
							"Accounts,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(BankEntity entity)
		{
			if(entity.BankID <= 0) entity.BankID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(BankEntity entity)
		{
			if(entity.BankID <= 0) entity.BankID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
			...
			{
				return DataConverter.CLng(entity.BankID);
			}
			return -1;
		}
		/// <summary>
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(BankEntity entity)
		{
			if(entity.BankID <= 0) entity.BankID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(BankEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(BankEntity entity, bool IsSave)
		{
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.Int32 bankID)
		{
			string strSQL = "delete from Bank where " +
			
			"BankID = @BankID"; 
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			dict.Add("BankID", bankID);
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 bankID)
		{
			string strSQL = "delete from Bank where " +
		...
		{
			string strSQL = "delete from Bank where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(BankEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update Bank SET "+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(BankEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update Bank SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update Bank SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public BankEntity GetEntity(System.Int32 bankID)
		{
			string strCondition = string.Empty;
			strCondition += " and BankID = @BankID";
		...
		/// </summary>
		/// <returns></returns>
		public async Task<BankEntity> GetEntityAsync(System.Int32 bankID)
		{
			string strCondition = string.Empty;
			strCondition += " and BankID = @BankID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<BankEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<BankEntity> list = new List<BankEntity>();
			string strSQL = "select * from Bank where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<BankEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<BankEntity> list = new List<BankEntity>();
			string strSQL = "select * from Bank where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from Bank where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<BankEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<BankEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<BankEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
