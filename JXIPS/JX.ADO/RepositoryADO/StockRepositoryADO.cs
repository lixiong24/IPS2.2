...
namespace JX.ADO
{
	...
	/// 数据库表：Stock 的仓储实现类.
	/// </summary>
	public partial class StockRepositoryADO : IStockRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		{
			string strSQL = "select " + statistic + " from Stock where 1=1 ";
		...
		{
			return _DB.GetMaxID("Stock", "StockID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("Stock", "StockID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(StockEntity entity)
		{
			if(entity.StockID <= 0) entity.StockID=GetNewID();
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(StockEntity entity)
		{
			if(entity.StockID <= 0) entity.StockID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(StockEntity entity)
		{
			if(entity.StockID <= 0) entity.StockID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
			...
			{
				return DataConverter.CLng(entity.StockID);
			}
			return -1;
		}
		/// <summary>
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(StockEntity entity)
		{
			if(entity.StockID <= 0) entity.StockID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(StockEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(StockEntity entity, bool IsSave)
		{
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.Int32 stockID)
		{
			string strSQL = "delete from Stock where " +
			
			"StockID = @StockID"; 
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			dict.Add("StockID", stockID);
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 stockID)
		{
			string strSQL = "delete from Stock where " +
		...
		{
			string strSQL = "delete from Stock where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(StockEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(StockEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update Stock SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update Stock SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public StockEntity GetEntity(System.Int32 stockID)
		{
			string strCondition = string.Empty;
			strCondition += " and StockID = @StockID";
		...
		/// </summary>
		/// <returns></returns>
		public async Task<StockEntity> GetEntityAsync(System.Int32 stockID)
		{
			string strCondition = string.Empty;
			strCondition += " and StockID = @StockID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual StockEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			StockEntity obj = null;
			string strSQL = "select top 1 * from Stock where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<StockEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			StockEntity obj = null;
			string strSQL = "select top 1 * from Stock where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<StockEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<StockEntity> list = new List<StockEntity>();
			string strSQL = "select * from Stock where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<StockEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<StockEntity> list = new List<StockEntity>();
			string strSQL = "select * from Stock where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from Stock where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<StockEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StockEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StockEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(StockEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("StockID", entity.StockID);
			dict.Add("StockNum", entity.StockNum);
			dict.Add("InputTime", entity.InputTime);
			dict.Add("Inputer", entity.Inputer);
			dict.Add("StockType", entity.StockType);
