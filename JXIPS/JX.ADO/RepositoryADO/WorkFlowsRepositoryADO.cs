...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class WorkFlowsRepositoryADO : IWorkFlowsRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public WorkFlowsRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from WorkFlows where 1=1 ";
		...
		{
			return _DB.GetMaxID("WorkFlows", "FlowID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("WorkFlows", "FlowID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(WorkFlowsEntity entity)
		{
			if(entity.FlowID <= 0) entity.FlowID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into WorkFlows ("+
							"FlowID,"+
							"FlowName,"+
							"Description) "+
							"values("+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(WorkFlowsEntity entity)
		{
			if(entity.FlowID <= 0) entity.FlowID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(WorkFlowsEntity entity)
		{
			if(entity.FlowID <= 0) entity.FlowID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(WorkFlowsEntity entity)
		{
			if(entity.FlowID <= 0) entity.FlowID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(WorkFlowsEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(WorkFlowsEntity entity, bool IsSave)
		{
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.Int32 flowID)
		{
			string strSQL = "delete from WorkFlows where " +
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 flowID)
		{
			string strSQL = "delete from WorkFlows where " +
		...
		{
			string strSQL = "delete from WorkFlows where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(WorkFlowsEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update WorkFlows SET "+
			"FlowName = @FlowName,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(WorkFlowsEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update WorkFlows SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update WorkFlows SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public WorkFlowsEntity GetEntity(System.Int32 flowID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<WorkFlowsEntity> GetEntityAsync(System.Int32 flowID)
		{
			string strCondition = string.Empty;
			strCondition += " and FlowID = @FlowID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual WorkFlowsEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			WorkFlowsEntity obj = null;
			string strSQL = "select top 1 * from WorkFlows where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<WorkFlowsEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			WorkFlowsEntity obj = null;
			string strSQL = "select top 1 * from WorkFlows where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<WorkFlowsEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<WorkFlowsEntity> list = new List<WorkFlowsEntity>();
			string strSQL = "select * from WorkFlows where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<WorkFlowsEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<WorkFlowsEntity> list = new List<WorkFlowsEntity>();
			string strSQL = "select * from WorkFlows where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from WorkFlows where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<WorkFlowsEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<WorkFlowsEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<WorkFlowsEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(WorkFlowsEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("FlowID", entity.FlowID);
			dict.Add("FlowName", entity.FlowName);
		...
		/// <returns></returns>
		private static WorkFlowsEntity GetEntityFromrdr(NullableDataReader rdr)
		{
			WorkFlowsEntity info = new WorkFlowsEntity();
