...
{
	/// <summary>
	/// 数据库表：StatKeyword 的仓储实现类.
	/// </summary>
	public partial class StatKeywordRepositoryADO : IStatKeywordRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		{
			string strSQL = "select " + statistic + " from StatKeyword where 1=1 ";
		...
		{
			return _DB.GetMaxID("StatKeyword", "TKeyword");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("StatKeyword", "TKeyword"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(StatKeywordEntity entity)
		{
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into StatKeyword ("+
							"TKeyword,"+
							"TKeywordNum) "+
							"values("+
							"@TKeyword,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(StatKeywordEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(StatKeywordEntity entity)
		{
			...
			{
				return DataConverter.CLng(entity.TKeyword);
			}
			return -1;
		}
		/// <summary>
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(StatKeywordEntity entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(StatKeywordEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(StatKeywordEntity entity, bool IsSave)
		{
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.String tKeyword)
		{
			string strSQL = "delete from StatKeyword where " +
			
			"TKeyword = @TKeyword"; 
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			dict.Add("TKeyword", tKeyword);
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.String tKeyword)
		{
			string strSQL = "delete from StatKeyword where " +
		...
		{
			string strSQL = "delete from StatKeyword where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(StatKeywordEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update StatKeyword SET "+
			"TKeywordNum = @TKeywordNum"+
			" WHERE "+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(StatKeywordEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update StatKeyword SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update StatKeyword SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public StatKeywordEntity GetEntity(System.String tKeyword)
		{
			string strCondition = string.Empty;
			strCondition += " and TKeyword = @TKeyword";
		...
		/// </summary>
		/// <returns></returns>
		public async Task<StatKeywordEntity> GetEntityAsync(System.String tKeyword)
		{
			string strCondition = string.Empty;
			strCondition += " and TKeyword = @TKeyword";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual StatKeywordEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			StatKeywordEntity obj = null;
			string strSQL = "select top 1 * from StatKeyword where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<StatKeywordEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			StatKeywordEntity obj = null;
			string strSQL = "select top 1 * from StatKeyword where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<StatKeywordEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<StatKeywordEntity> list = new List<StatKeywordEntity>();
			string strSQL = "select * from StatKeyword where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<StatKeywordEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<StatKeywordEntity> list = new List<StatKeywordEntity>();
			string strSQL = "select * from StatKeyword where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from StatKeyword where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<StatKeywordEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatKeywordEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatKeywordEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(StatKeywordEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("TKeyword", entity.TKeyword);
			dict.Add("TKeywordNum", entity.TKeywordNum);
		}
		/// <summary>
		/// 通过数据读取器生成实体类
		/// </summary>
