...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class CollectionItemRepositoryADO : ICollectionItemRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public CollectionItemRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from CollectionItem where 1=1 ";
		...
		{
			return _DB.GetMaxID("CollectionItem", "ItemID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("CollectionItem", "ItemID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(CollectionItemEntity entity)
		{
			if(entity.ItemID <= 0) entity.ItemID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into CollectionItem ("+
							"ItemID,"+
							"ItemName,"+
							"UrlName,"+
							"CodeType,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(CollectionItemEntity entity)
		{
			if(entity.ItemID <= 0) entity.ItemID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(CollectionItemEntity entity)
		{
			if(entity.ItemID <= 0) entity.ItemID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(CollectionItemEntity entity)
		{
			if(entity.ItemID <= 0) entity.ItemID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(CollectionItemEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(CollectionItemEntity entity, bool IsSave)
		{
		...
		{
			string strSQL = "delete from CollectionItem where " +
		...
		{
			string strSQL = "delete from CollectionItem where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(CollectionItemEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update CollectionItem SET "+
			"ItemName = @ItemName,"+
			"UrlName = @UrlName,"+
			"CodeType = @CodeType,"+
			"Url = @Url,"+
			...
			"OrderType = @OrderType,"+
			"MaxNum = @MaxNum,"+
			"NewsCollecDate = @NewsCollecDate,"+
			"IsDetection = @IsDetection,"+
			"IsAutoCreateHtml = @IsAutoCreateHtml"+
			" WHERE "+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(CollectionItemEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update CollectionItem SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update CollectionItem SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public CollectionItemEntity GetEntity(System.Int32 itemID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<CollectionItemEntity> GetEntityAsync(System.Int32 itemID)
		{
			string strCondition = string.Empty;
			strCondition += " and ItemID = @ItemID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual CollectionItemEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			CollectionItemEntity obj = null;
			string strSQL = "select top 1 * from CollectionItem where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<CollectionItemEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			CollectionItemEntity obj = null;
			string strSQL = "select top 1 * from CollectionItem where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<CollectionItemEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<CollectionItemEntity> list = new List<CollectionItemEntity>();
			string strSQL = "select * from CollectionItem where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<CollectionItemEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<CollectionItemEntity> list = new List<CollectionItemEntity>();
			string strSQL = "select * from CollectionItem where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from CollectionItem where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<CollectionItemEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CollectionItemEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CollectionItemEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(CollectionItemEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("ItemID", entity.ItemID);
			dict.Add("ItemName", entity.ItemName);
			dict.Add("UrlName", entity.UrlName);
			dict.Add("CodeType", entity.CodeType);
			dict.Add("Url", entity.Url);
			dict.Add("Intro", entity.Intro);
			dict.Add("NodeID", entity.NodeID);
			dict.Add("InfoNodeID", entity.InfoNodeID);
			dict.Add("ModelID", entity.ModelID);
			dict.Add("SpecialID", entity.SpecialID);
			dict.Add("OrderType", entity.OrderType);
			dict.Add("MaxNum", entity.MaxNum);
			dict.Add("NewsCollecDate", entity.NewsCollecDate);
			dict.Add("IsDetection", entity.IsDetection);
			dict.Add("IsAutoCreateHtml", entity.IsAutoCreateHtml);
		}
		/// <summary>
		/// 通过数据读取器生成实体类
		/// </summary>
		...
		/// <returns></returns>
		private static CollectionItemEntity GetEntityFromrdr(NullableDataReader rdr)
		{
			CollectionItemEntity info = new CollectionItemEntity();
			...
			info.NewsCollecDate = rdr.GetNullableDateTime("NewsCollecDate");
			info.IsDetection = rdr.GetBoolean("IsDetection");
			info.IsAutoCreateHtml = rdr.GetBoolean("IsAutoCreateHtml");
			return info;
		}
		#endregion
	}
