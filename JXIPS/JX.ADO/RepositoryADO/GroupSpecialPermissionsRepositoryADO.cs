...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class GroupSpecialPermissionsRepositoryADO : IGroupSpecialPermissionsRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public GroupSpecialPermissionsRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from GroupSpecialPermissions where 1=1 ";
		...
		{
			return _DB.GetMaxID("GroupSpecialPermissions", "GroupID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("GroupSpecialPermissions", "GroupID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(GroupSpecialPermissionsEntity entity)
		{
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into GroupSpecialPermissions ("+
							"GroupID,"+
							"OperateCode,"+
							"SpecialID,"+
							"IDType) "+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(GroupSpecialPermissionsEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(GroupSpecialPermissionsEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(GroupSpecialPermissionsEntity entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(GroupSpecialPermissionsEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(GroupSpecialPermissionsEntity entity, bool IsSave)
		{
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.Int32 groupID, System.Int32 operateCode, System.Int32 specialID, System.Int32 iDType)
		{
			string strSQL = "delete from GroupSpecialPermissions where " +
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 groupID, System.Int32 operateCode, System.Int32 specialID, System.Int32 iDType)
		{
			string strSQL = "delete from GroupSpecialPermissions where " +
		...
		{
			string strSQL = "delete from GroupSpecialPermissions where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(GroupSpecialPermissionsEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update GroupSpecialPermissions SET "+
			" WHERE "+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(GroupSpecialPermissionsEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update GroupSpecialPermissions SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update GroupSpecialPermissions SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public GroupSpecialPermissionsEntity GetEntity(System.Int32 groupID, System.Int32 operateCode, System.Int32 specialID, System.Int32 iDType)
		{
			string strCondition = string.Empty;
			strCondition += " and GroupID = @GroupID";
			strCondition += " and OperateCode = @OperateCode";
			strCondition += " and SpecialID = @SpecialID";
		...
		/// </summary>
		/// <returns></returns>
		public async Task<GroupSpecialPermissionsEntity> GetEntityAsync(System.Int32 groupID, System.Int32 operateCode, System.Int32 specialID, System.Int32 iDType)
		{
			string strCondition = string.Empty;
			strCondition += " and GroupID = @GroupID";
			strCondition += " and OperateCode = @OperateCode";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual GroupSpecialPermissionsEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			GroupSpecialPermissionsEntity obj = null;
			string strSQL = "select top 1 * from GroupSpecialPermissions where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<GroupSpecialPermissionsEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			GroupSpecialPermissionsEntity obj = null;
			string strSQL = "select top 1 * from GroupSpecialPermissions where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<GroupSpecialPermissionsEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<GroupSpecialPermissionsEntity> list = new List<GroupSpecialPermissionsEntity>();
			string strSQL = "select * from GroupSpecialPermissions where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<GroupSpecialPermissionsEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<GroupSpecialPermissionsEntity> list = new List<GroupSpecialPermissionsEntity>();
			string strSQL = "select * from GroupSpecialPermissions where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from GroupSpecialPermissions where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<GroupSpecialPermissionsEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		public virtual IList<GroupSpecialPermissionsEntity> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			...
			{
				TableName = "GroupSpecialPermissions";
			}
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<GroupSpecialPermissionsEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<GroupSpecialPermissionsEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(GroupSpecialPermissionsEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("GroupID", entity.GroupID);
			dict.Add("OperateCode", entity.OperateCode);
			dict.Add("SpecialID", entity.SpecialID);
		...
		/// <returns></returns>
		private static GroupSpecialPermissionsEntity GetEntityFromrdr(NullableDataReader rdr)
		{
			GroupSpecialPermissionsEntity info = new GroupSpecialPermissionsEntity();
