...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class KeywordsRepositoryADO : IKeywordsRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public KeywordsRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from Keywords where 1=1 ";
		...
		{
			return _DB.GetMaxID("Keywords", "KeywordID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("Keywords", "KeywordID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(KeywordsEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(KeywordsEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(KeywordsEntity entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(KeywordsEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(KeywordsEntity entity, bool IsSave)
		{
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.Int32 keywordID)
		{
			string strSQL = "delete from Keywords where " +
			
			"KeywordID = @KeywordID"; 
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			dict.Add("KeywordID", keywordID);
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 keywordID)
		{
			string strSQL = "delete from Keywords where " +
		...
		{
			string strSQL = "delete from Keywords where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(KeywordsEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update Keywords SET "+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(KeywordsEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update Keywords SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update Keywords SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public KeywordsEntity GetEntity(System.Int32 keywordID)
		{
			string strCondition = string.Empty;
			strCondition += " and KeywordID = @KeywordID";
		...
		/// </summary>
		/// <returns></returns>
		public async Task<KeywordsEntity> GetEntityAsync(System.Int32 keywordID)
		{
			string strCondition = string.Empty;
			strCondition += " and KeywordID = @KeywordID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual KeywordsEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			KeywordsEntity obj = null;
			string strSQL = "select top 1 * from Keywords where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<KeywordsEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			KeywordsEntity obj = null;
			string strSQL = "select top 1 * from Keywords where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<KeywordsEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<KeywordsEntity> list = new List<KeywordsEntity>();
			string strSQL = "select * from Keywords where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<KeywordsEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<KeywordsEntity> list = new List<KeywordsEntity>();
			string strSQL = "select * from Keywords where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from Keywords where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<KeywordsEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<KeywordsEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<KeywordsEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(KeywordsEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("KeywordID", entity.KeywordID);
			dict.Add("KeywordText", entity.KeywordText);
			dict.Add("KeywordType", entity.KeywordType);
			...
			dict.Add("QuoteTimes", entity.QuoteTimes);
		}
		/// <summary>
		/// 通过数据读取器生成实体类
		/// </summary>
