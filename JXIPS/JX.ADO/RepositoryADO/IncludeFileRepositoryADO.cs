...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class IncludeFileRepositoryADO : IIncludeFileRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public IncludeFileRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from IncludeFile where 1=1 ";
		...
		{
			return _DB.GetMaxID("IncludeFile", "ID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("IncludeFile", "ID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(IncludeFileEntity entity)
		{
			if(entity.ID <= 0) entity.ID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into IncludeFile ("+
							"ID,"+
							"Name,"+
							"Description,"+
							"IncludeType,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(IncludeFileEntity entity)
		{
			if(entity.ID <= 0) entity.ID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(IncludeFileEntity entity)
		{
			if(entity.ID <= 0) entity.ID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(IncludeFileEntity entity)
		{
			if(entity.ID <= 0) entity.ID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(IncludeFileEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(IncludeFileEntity entity, bool IsSave)
		{
		...
		{
			string strSQL = "delete from IncludeFile where " +
		...
		{
			string strSQL = "delete from IncludeFile where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(IncludeFileEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update IncludeFile SET "+
			"Name = @Name,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(IncludeFileEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update IncludeFile SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update IncludeFile SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public IncludeFileEntity GetEntity(System.Int32 id)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<IncludeFileEntity> GetEntityAsync(System.Int32 id)
		{
			string strCondition = string.Empty;
			strCondition += " and ID = @ID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IncludeFileEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			IncludeFileEntity obj = null;
			string strSQL = "select top 1 * from IncludeFile where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IncludeFileEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			IncludeFileEntity obj = null;
			string strSQL = "select top 1 * from IncludeFile where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<IncludeFileEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<IncludeFileEntity> list = new List<IncludeFileEntity>();
			string strSQL = "select * from IncludeFile where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<IncludeFileEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<IncludeFileEntity> list = new List<IncludeFileEntity>();
			string strSQL = "select * from IncludeFile where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from IncludeFile where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<IncludeFileEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<IncludeFileEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<IncludeFileEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(IncludeFileEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("ID", entity.ID);
			dict.Add("Name", entity.Name);
			dict.Add("Description", entity.Description);
			dict.Add("IncludeType", entity.IncludeType);
			dict.Add("AssociateType", entity.AssociateType);
		...
		/// <returns></returns>
		private static IncludeFileEntity GetEntityFromrdr(NullableDataReader rdr)
		{
			IncludeFileEntity info = new IncludeFileEntity();
			info.ID = rdr.GetInt32("ID");
			info.Name = rdr.GetString("Name");
			info.Description = rdr.GetString("Description");
			info.IncludeType = rdr.GetInt32("IncludeType");
			info.AssociateType = rdr.GetInt32("AssociateType");
