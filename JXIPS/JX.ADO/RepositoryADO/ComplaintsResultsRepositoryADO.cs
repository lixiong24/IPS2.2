...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class ComplaintsResultsRepositoryADO : IComplaintsResultsRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		{
			string strSQL = "select " + statistic + " from ComplaintsResults where 1=1 ";
		...
		{
			return _DB.GetMaxID("ComplaintsResults", "RID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("ComplaintsResults", "RID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(ComplaintsResultsEntity entity)
		{
			if(entity.RID <= 0) entity.RID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into ComplaintsResults ("+
							"RID,"+
							"CID,"+
							"RAdminID,"+
							"RContent,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(ComplaintsResultsEntity entity)
		{
			if(entity.RID <= 0) entity.RID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(ComplaintsResultsEntity entity)
		{
			if(entity.RID <= 0) entity.RID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
			...
			{
				return DataConverter.CLng(entity.RID);
			}
			return -1;
		}
		/// <summary>
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(ComplaintsResultsEntity entity)
		{
			if(entity.RID <= 0) entity.RID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(ComplaintsResultsEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(ComplaintsResultsEntity entity, bool IsSave)
		{
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.Int32 rid)
		{
			string strSQL = "delete from ComplaintsResults where " +
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 rid)
		{
			string strSQL = "delete from ComplaintsResults where " +
		...
		{
			string strSQL = "delete from ComplaintsResults where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(ComplaintsResultsEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update ComplaintsResults SET "+
			"CID = @CID,"+
			"RAdminID = @RAdminID,"+
			"RContent = @RContent,"+
			"RTime = @RTime,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(ComplaintsResultsEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update ComplaintsResults SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update ComplaintsResults SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public ComplaintsResultsEntity GetEntity(System.Int32 rid)
		{
			string strCondition = string.Empty;
			strCondition += " and RID = @RID";
		...
		/// </summary>
		/// <returns></returns>
		public async Task<ComplaintsResultsEntity> GetEntityAsync(System.Int32 rid)
		{
			string strCondition = string.Empty;
			strCondition += " and RID = @RID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual ComplaintsResultsEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			ComplaintsResultsEntity obj = null;
			string strSQL = "select top 1 * from ComplaintsResults where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<ComplaintsResultsEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			ComplaintsResultsEntity obj = null;
			string strSQL = "select top 1 * from ComplaintsResults where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<ComplaintsResultsEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<ComplaintsResultsEntity> list = new List<ComplaintsResultsEntity>();
			string strSQL = "select * from ComplaintsResults where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<ComplaintsResultsEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<ComplaintsResultsEntity> list = new List<ComplaintsResultsEntity>();
			string strSQL = "select * from ComplaintsResults where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from ComplaintsResults where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<ComplaintsResultsEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ComplaintsResultsEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ComplaintsResultsEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(ComplaintsResultsEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("RID", entity.RID);
			dict.Add("CID", entity.CID);
			dict.Add("RAdminID", entity.RAdminID);
			dict.Add("RContent", entity.RContent);
			dict.Add("RTime", entity.RTime);
			dict.Add("RState", entity.RState);
		}
		/// <summary>
		/// 通过数据读取器生成实体类
		/// </summary>
