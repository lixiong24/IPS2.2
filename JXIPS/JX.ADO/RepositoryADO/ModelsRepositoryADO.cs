...
namespace JX.ADO
{
	...
	/// 数据库表：Models 的仓储实现类.
	/// </summary>
	public partial class ModelsRepositoryADO : IModelsRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public ModelsRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from Models where 1=1 ";
		...
		{
			return _DB.GetMaxID("Models", "ModelID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("Models", "ModelID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(ModelsEntity entity)
		{
			if(entity.ModelID <= 0) entity.ModelID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into Models ("+
							"ModelID,"+
							"ModelName,"+
							"ModelType,"+
							"Description,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(ModelsEntity entity)
		{
			if(entity.ModelID <= 0) entity.ModelID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(ModelsEntity entity)
		{
			if(entity.ModelID <= 0) entity.ModelID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(ModelsEntity entity)
		{
			if(entity.ModelID <= 0) entity.ModelID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(ModelsEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(ModelsEntity entity, bool IsSave)
		{
		...
		{
			string strSQL = "delete from Models where " +
		...
		{
			string strSQL = "delete from Models where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(ModelsEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update Models SET "+
			"ModelName = @ModelName,"+
			"ModelType = @ModelType,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(ModelsEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update Models SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update Models SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public ModelsEntity GetEntity(System.Int32 modelID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<ModelsEntity> GetEntityAsync(System.Int32 modelID)
		{
			string strCondition = string.Empty;
			strCondition += " and ModelID = @ModelID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual ModelsEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			ModelsEntity obj = null;
			string strSQL = "select top 1 * from Models where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<ModelsEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			ModelsEntity obj = null;
			string strSQL = "select top 1 * from Models where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<ModelsEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<ModelsEntity> list = new List<ModelsEntity>();
			string strSQL = "select * from Models where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<ModelsEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<ModelsEntity> list = new List<ModelsEntity>();
			string strSQL = "select * from Models where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from Models where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<ModelsEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ModelsEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ModelsEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(ModelsEntity entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static ModelsEntity GetEntityFromrdr(NullableDataReader rdr)
		{
			ModelsEntity info = new ModelsEntity();
