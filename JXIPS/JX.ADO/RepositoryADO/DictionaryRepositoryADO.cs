...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class DictionaryRepositoryADO : IDictionaryRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		{
			string strSQL = "select " + statistic + " from Dictionary where 1=1 ";
		...
		{
			return _DB.GetMaxID("Dictionary", "FieldID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("Dictionary", "FieldID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(DictionaryEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(DictionaryEntity entity)
		{
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.Int32 fieldID)
		{
			string strSQL = "delete from Dictionary where " +
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 fieldID)
		{
			string strSQL = "delete from Dictionary where " +
		...
		{
			string strSQL = "delete from Dictionary where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update Dictionary SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public DictionaryEntity GetEntity(System.Int32 fieldID)
		{
			string strCondition = string.Empty;
			strCondition += " and FieldID = @FieldID";
		...
		/// </summary>
		/// <returns></returns>
		public async Task<DictionaryEntity> GetEntityAsync(System.Int32 fieldID)
		{
			string strCondition = string.Empty;
			strCondition += " and FieldID = @FieldID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<DictionaryEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<DictionaryEntity> list = new List<DictionaryEntity>();
			string strSQL = "select * from Dictionary where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<DictionaryEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<DictionaryEntity> list = new List<DictionaryEntity>();
			string strSQL = "select * from Dictionary where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from Dictionary where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<DictionaryEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<DictionaryEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<DictionaryEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
