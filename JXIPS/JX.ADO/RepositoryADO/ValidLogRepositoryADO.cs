...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class ValidLogRepositoryADO : IValidLogRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public ValidLogRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from ValidLog where 1=1 ";
		...
		{
			return _DB.GetMaxID("ValidLog", "LogID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("ValidLog", "LogID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(ValidLogEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(ValidLogEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(ValidLogEntity entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(ValidLogEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(ValidLogEntity entity, bool IsSave)
		{
		...
		{
			string strSQL = "delete from ValidLog where " +
		...
		{
			string strSQL = "delete from ValidLog where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(ValidLogEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update ValidLog SET "+
			"UserName = @UserName,"+
			"ValidNum = @ValidNum,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(ValidLogEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update ValidLog SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update ValidLog SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public ValidLogEntity GetEntity(System.Int32 logID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<ValidLogEntity> GetEntityAsync(System.Int32 logID)
		{
			string strCondition = string.Empty;
			strCondition += " and LogID = @LogID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual ValidLogEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			ValidLogEntity obj = null;
			string strSQL = "select top 1 * from ValidLog where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<ValidLogEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			ValidLogEntity obj = null;
			string strSQL = "select top 1 * from ValidLog where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<ValidLogEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<ValidLogEntity> list = new List<ValidLogEntity>();
			string strSQL = "select * from ValidLog where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<ValidLogEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<ValidLogEntity> list = new List<ValidLogEntity>();
			string strSQL = "select * from ValidLog where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from ValidLog where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<ValidLogEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ValidLogEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ValidLogEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(ValidLogEntity entity, Dictionary<string, object> dict)
		{
