...
{
	/// <summary>
	/// 数据库表：ShoppingCarts 的仓储实现类.
	/// </summary>
	public partial class ShoppingCartsRepositoryADO : IShoppingCartsRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public ShoppingCartsRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from ShoppingCarts where 1=1 ";
		...
		{
			return _DB.GetMaxID("ShoppingCarts", "CartItemID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("ShoppingCarts", "CartItemID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(ShoppingCartsEntity entity)
		{
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into ShoppingCarts ("+
							"UserName,"+
							"CartID,"+
							"ProductID,"+
							"Quantity,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(ShoppingCartsEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(ShoppingCartsEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(ShoppingCartsEntity entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(ShoppingCartsEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(ShoppingCartsEntity entity, bool IsSave)
		{
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.Int32 cartItemID)
		{
			string strSQL = "delete from ShoppingCarts where " +
			
			"CartItemID = @CartItemID"; 
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			dict.Add("CartItemID", cartItemID);
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 cartItemID)
		{
			string strSQL = "delete from ShoppingCarts where " +
		...
		{
			string strSQL = "delete from ShoppingCarts where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(ShoppingCartsEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update ShoppingCarts SET "+
			"UserName = @UserName,"+
			"CartID = @CartID,"+
			"ProductID = @ProductID,"+
			"Quantity = @Quantity,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(ShoppingCartsEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update ShoppingCarts SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update ShoppingCarts SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public ShoppingCartsEntity GetEntity(System.Int32 cartItemID)
		{
			string strCondition = string.Empty;
			strCondition += " and CartItemID = @CartItemID";
		...
		/// </summary>
		/// <returns></returns>
		public async Task<ShoppingCartsEntity> GetEntityAsync(System.Int32 cartItemID)
		{
			string strCondition = string.Empty;
			strCondition += " and CartItemID = @CartItemID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual ShoppingCartsEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			ShoppingCartsEntity obj = null;
			string strSQL = "select top 1 * from ShoppingCarts where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<ShoppingCartsEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			ShoppingCartsEntity obj = null;
			string strSQL = "select top 1 * from ShoppingCarts where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<ShoppingCartsEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<ShoppingCartsEntity> list = new List<ShoppingCartsEntity>();
			string strSQL = "select * from ShoppingCarts where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<ShoppingCartsEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<ShoppingCartsEntity> list = new List<ShoppingCartsEntity>();
			string strSQL = "select * from ShoppingCarts where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from ShoppingCarts where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<ShoppingCartsEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ShoppingCartsEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ShoppingCartsEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(ShoppingCartsEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("CartItemID", entity.CartItemID);
			dict.Add("UserName", entity.UserName);
			dict.Add("CartID", entity.CartID);
			dict.Add("ProductID", entity.ProductID);
			dict.Add("Quantity", entity.Quantity);
			dict.Add("IsPresent", entity.IsPresent);
			dict.Add("UpdateTime", entity.UpdateTime);
			dict.Add("TableName", entity.TableName);
			dict.Add("Property", entity.Property);
			dict.Add("InformResult", entity.InformResult);
			dict.Add("BelongsToProductID", entity.BelongsToProductID);
