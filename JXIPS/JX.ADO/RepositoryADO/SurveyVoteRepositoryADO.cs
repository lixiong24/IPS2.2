...
{
	/// <summary>
	/// 数据库表：SurveyVote 的仓储实现类.
	/// </summary>
	public partial class SurveyVoteRepositoryADO : ISurveyVoteRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		{
			string strSQL = "select " + statistic + " from SurveyVote where 1=1 ";
		...
		{
			return _DB.GetMaxID("SurveyVote", "ID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("SurveyVote", "ID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(SurveyVoteEntity entity)
		{
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into SurveyVote ("+
							"SurveyID,"+
							"QuestionID,"+
							"OptionID,"+
							"VoteAmount) "+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(SurveyVoteEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(SurveyVoteEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(SurveyVoteEntity entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(SurveyVoteEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(SurveyVoteEntity entity, bool IsSave)
		{
		...
		{
			string strSQL = "delete from SurveyVote where " +
		...
		{
			string strSQL = "delete from SurveyVote where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(SurveyVoteEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update SurveyVote SET "+
			"SurveyID = @SurveyID,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(SurveyVoteEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update SurveyVote SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update SurveyVote SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public SurveyVoteEntity GetEntity(System.Int32 id)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<SurveyVoteEntity> GetEntityAsync(System.Int32 id)
		{
			string strCondition = string.Empty;
			strCondition += " and ID = @ID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual SurveyVoteEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			SurveyVoteEntity obj = null;
			string strSQL = "select top 1 * from SurveyVote where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<SurveyVoteEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			SurveyVoteEntity obj = null;
			string strSQL = "select top 1 * from SurveyVote where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<SurveyVoteEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<SurveyVoteEntity> list = new List<SurveyVoteEntity>();
			string strSQL = "select * from SurveyVote where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<SurveyVoteEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<SurveyVoteEntity> list = new List<SurveyVoteEntity>();
			string strSQL = "select * from SurveyVote where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from SurveyVote where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<SurveyVoteEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<SurveyVoteEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<SurveyVoteEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(SurveyVoteEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("ID", entity.ID);
			dict.Add("SurveyID", entity.SurveyID);
			dict.Add("QuestionID", entity.QuestionID);
			dict.Add("OptionID", entity.OptionID);
			dict.Add("VoteAmount", entity.VoteAmount);
		}
		/// <summary>
		/// 通过数据读取器生成实体类
		/// </summary>
		...
		/// <returns></returns>
		private static SurveyVoteEntity GetEntityFromrdr(NullableDataReader rdr)
		{
			SurveyVoteEntity info = new SurveyVoteEntity();
			info.ID = rdr.GetInt32("ID");
			info.SurveyID = rdr.GetInt32("SurveyID");
			info.QuestionID = rdr.GetInt32("QuestionID");
			info.OptionID = rdr.GetInt32("OptionID");
			info.VoteAmount = rdr.GetInt32("VoteAmount");
			return info;
		}
		#endregion
	}
