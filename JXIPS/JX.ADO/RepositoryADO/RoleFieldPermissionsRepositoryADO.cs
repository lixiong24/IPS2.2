...
namespace JX.ADO
{
	...
	public partial class RoleFieldPermissionsRepositoryADO : IRoleFieldPermissionsRepositoryADO
	{
		...
		/// </summary>
		/// <param name="DB"></param>
		public RoleFieldPermissionsRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from RoleFieldPermissions where 1=1 ";
		...
		{
			return _DB.GetMaxID("RoleFieldPermissions", "RoleID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("RoleFieldPermissions", "RoleID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(RoleFieldPermissionsEntity entity)
		{
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into RoleFieldPermissions ("+
							"RoleID,"+
							"ModelID,"+
							"FieldName,"+
							"OperateCode) "+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(RoleFieldPermissionsEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(RoleFieldPermissionsEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(RoleFieldPermissionsEntity entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(RoleFieldPermissionsEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(RoleFieldPermissionsEntity entity, bool IsSave)
		{
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.Int32 roleID, System.Int32 modelID, System.String fieldName, System.String operateCode)
		{
			string strSQL = "delete from RoleFieldPermissions where " +
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 roleID, System.Int32 modelID, System.String fieldName, System.String operateCode)
		{
			string strSQL = "delete from RoleFieldPermissions where " +
		...
		{
			string strSQL = "delete from RoleFieldPermissions where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(RoleFieldPermissionsEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update RoleFieldPermissions SET "+
			" WHERE "+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(RoleFieldPermissionsEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update RoleFieldPermissions SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update RoleFieldPermissions SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public RoleFieldPermissionsEntity GetEntity(System.Int32 roleID, System.Int32 modelID, System.String fieldName, System.String operateCode)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<RoleFieldPermissionsEntity> GetEntityAsync(System.Int32 roleID, System.Int32 modelID, System.String fieldName, System.String operateCode)
		{
			string strCondition = string.Empty;
			strCondition += " and RoleID = @RoleID";
			strCondition += " and ModelID = @ModelID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual RoleFieldPermissionsEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			RoleFieldPermissionsEntity obj = null;
			string strSQL = "select top 1 * from RoleFieldPermissions where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<RoleFieldPermissionsEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			RoleFieldPermissionsEntity obj = null;
			string strSQL = "select top 1 * from RoleFieldPermissions where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<RoleFieldPermissionsEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<RoleFieldPermissionsEntity> list = new List<RoleFieldPermissionsEntity>();
			string strSQL = "select * from RoleFieldPermissions where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<RoleFieldPermissionsEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<RoleFieldPermissionsEntity> list = new List<RoleFieldPermissionsEntity>();
			string strSQL = "select * from RoleFieldPermissions where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from RoleFieldPermissions where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<RoleFieldPermissionsEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		public virtual IList<RoleFieldPermissionsEntity> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			...
			{
				TableName = "RoleFieldPermissions";
			}
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<RoleFieldPermissionsEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<RoleFieldPermissionsEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(RoleFieldPermissionsEntity entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static RoleFieldPermissionsEntity GetEntityFromrdr(NullableDataReader rdr)
		{
			RoleFieldPermissionsEntity info = new RoleFieldPermissionsEntity();
