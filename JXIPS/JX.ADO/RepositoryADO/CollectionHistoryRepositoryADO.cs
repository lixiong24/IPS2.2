...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class CollectionHistoryRepositoryADO : ICollectionHistoryRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public CollectionHistoryRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from CollectionHistory where 1=1 ";
		...
		{
			return _DB.GetMaxID("CollectionHistory", "HistoryID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("CollectionHistory", "HistoryID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(CollectionHistoryEntity entity)
		{
			if(entity.HistoryID <= 0) entity.HistoryID=GetNewID();
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(CollectionHistoryEntity entity)
		{
			if(entity.HistoryID <= 0) entity.HistoryID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.Int32 historyID)
		{
			string strSQL = "delete from CollectionHistory where " +
			
			"HistoryID = @HistoryID"; 
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			dict.Add("HistoryID", historyID);
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 historyID)
		{
			string strSQL = "delete from CollectionHistory where " +
		...
		{
			string strSQL = "delete from CollectionHistory where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(CollectionHistoryEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update CollectionHistory SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public CollectionHistoryEntity GetEntity(System.Int32 historyID)
		{
			string strCondition = string.Empty;
			strCondition += " and HistoryID = @HistoryID";
		...
		/// </summary>
		/// <returns></returns>
		public async Task<CollectionHistoryEntity> GetEntityAsync(System.Int32 historyID)
		{
			string strCondition = string.Empty;
			strCondition += " and HistoryID = @HistoryID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual CollectionHistoryEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<CollectionHistoryEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<CollectionHistoryEntity> list = new List<CollectionHistoryEntity>();
			string strSQL = "select * from CollectionHistory where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<CollectionHistoryEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<CollectionHistoryEntity> list = new List<CollectionHistoryEntity>();
			string strSQL = "select * from CollectionHistory where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from CollectionHistory where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<CollectionHistoryEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CollectionHistoryEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CollectionHistoryEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
