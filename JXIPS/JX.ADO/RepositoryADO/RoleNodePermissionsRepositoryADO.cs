...
namespace JX.ADO
{
	...
	public partial class RoleNodePermissionsRepositoryADO : IRoleNodePermissionsRepositoryADO
	{
		...
		/// </summary>
		/// <param name="DB"></param>
		public RoleNodePermissionsRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from RoleNodePermissions where 1=1 ";
		...
		{
			return _DB.GetMaxID("RoleNodePermissions", "RoleID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("RoleNodePermissions", "RoleID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(RoleNodePermissionsEntity entity)
		{
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into RoleNodePermissions ("+
							"RoleID,"+
							"NodeID,"+
							"OperateCode) "+
							"values("+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(RoleNodePermissionsEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(RoleNodePermissionsEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(RoleNodePermissionsEntity entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(RoleNodePermissionsEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(RoleNodePermissionsEntity entity, bool IsSave)
		{
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.Int32 roleID, System.Int32 nodeID, System.String operateCode)
		{
			string strSQL = "delete from RoleNodePermissions where " +
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 roleID, System.Int32 nodeID, System.String operateCode)
		{
			string strSQL = "delete from RoleNodePermissions where " +
		...
		{
			string strSQL = "delete from RoleNodePermissions where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(RoleNodePermissionsEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update RoleNodePermissions SET "+
			" WHERE "+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(RoleNodePermissionsEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update RoleNodePermissions SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update RoleNodePermissions SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public RoleNodePermissionsEntity GetEntity(System.Int32 roleID, System.Int32 nodeID, System.String operateCode)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<RoleNodePermissionsEntity> GetEntityAsync(System.Int32 roleID, System.Int32 nodeID, System.String operateCode)
		{
			string strCondition = string.Empty;
			strCondition += " and RoleID = @RoleID";
			strCondition += " and NodeID = @NodeID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual RoleNodePermissionsEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			RoleNodePermissionsEntity obj = null;
			string strSQL = "select top 1 * from RoleNodePermissions where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<RoleNodePermissionsEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			RoleNodePermissionsEntity obj = null;
			string strSQL = "select top 1 * from RoleNodePermissions where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<RoleNodePermissionsEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<RoleNodePermissionsEntity> list = new List<RoleNodePermissionsEntity>();
			string strSQL = "select * from RoleNodePermissions where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<RoleNodePermissionsEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<RoleNodePermissionsEntity> list = new List<RoleNodePermissionsEntity>();
			string strSQL = "select * from RoleNodePermissions where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from RoleNodePermissions where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<RoleNodePermissionsEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<RoleNodePermissionsEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<RoleNodePermissionsEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(RoleNodePermissionsEntity entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static RoleNodePermissionsEntity GetEntityFromrdr(NullableDataReader rdr)
		{
			RoleNodePermissionsEntity info = new RoleNodePermissionsEntity();
