...
{
	/// <summary>
	/// 数据库表：SpecialCategory 的仓储实现类.
	/// </summary>
	public partial class SpecialCategoryRepositoryADO : ISpecialCategoryRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		{
			string strSQL = "select " + statistic + " from SpecialCategory where 1=1 ";
		...
		{
			return _DB.GetMaxID("SpecialCategory", "SpecialCategoryID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("SpecialCategory", "SpecialCategoryID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(SpecialCategoryEntity entity)
		{
			if(entity.SpecialCategoryID <= 0) entity.SpecialCategoryID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into SpecialCategory ("+
							"SpecialCategoryID,"+
							"SpecialCategoryName,"+
							"SpecialCategoryDir,"+
							"SpecialTemplatePath,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(SpecialCategoryEntity entity)
		{
			if(entity.SpecialCategoryID <= 0) entity.SpecialCategoryID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(SpecialCategoryEntity entity)
		{
			if(entity.SpecialCategoryID <= 0) entity.SpecialCategoryID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
			...
			{
				return DataConverter.CLng(entity.SpecialCategoryID);
			}
			return -1;
		}
		/// <summary>
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(SpecialCategoryEntity entity)
		{
			if(entity.SpecialCategoryID <= 0) entity.SpecialCategoryID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(SpecialCategoryEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(SpecialCategoryEntity entity, bool IsSave)
		{
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.Int32 specialCategoryID)
		{
			string strSQL = "delete from SpecialCategory where " +
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 specialCategoryID)
		{
			string strSQL = "delete from SpecialCategory where " +
		...
		{
			string strSQL = "delete from SpecialCategory where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(SpecialCategoryEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update SpecialCategory SET "+
			"SpecialCategoryName = @SpecialCategoryName,"+
			"SpecialCategoryDir = @SpecialCategoryDir,"+
			"SpecialTemplatePath = @SpecialTemplatePath,"+
			"OrderSort = @OrderSort,"+
			"IsNewOpen = @IsNewOpen,"+
			"Description = @Description,"+
			"IsCreateHtml = @IsCreateHtml,"+
			"PagePostfix = @PagePostfix,"+
			"SearchTemplatePath = @SearchTemplatePath,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(SpecialCategoryEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update SpecialCategory SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update SpecialCategory SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public SpecialCategoryEntity GetEntity(System.Int32 specialCategoryID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<SpecialCategoryEntity> GetEntityAsync(System.Int32 specialCategoryID)
		{
			string strCondition = string.Empty;
			strCondition += " and SpecialCategoryID = @SpecialCategoryID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual SpecialCategoryEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			SpecialCategoryEntity obj = null;
			string strSQL = "select top 1 * from SpecialCategory where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<SpecialCategoryEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			SpecialCategoryEntity obj = null;
			string strSQL = "select top 1 * from SpecialCategory where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<SpecialCategoryEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<SpecialCategoryEntity> list = new List<SpecialCategoryEntity>();
			string strSQL = "select * from SpecialCategory where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<SpecialCategoryEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<SpecialCategoryEntity> list = new List<SpecialCategoryEntity>();
			string strSQL = "select * from SpecialCategory where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from SpecialCategory where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<SpecialCategoryEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<SpecialCategoryEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<SpecialCategoryEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		public virtual IList<SpecialCategoryEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			...
			{
				PrimaryColumn = "SpecialCategoryID";
			}
		...
		private static void GetParameters(SpecialCategoryEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("SpecialCategoryID", entity.SpecialCategoryID);
			dict.Add("SpecialCategoryName", entity.SpecialCategoryName);
			dict.Add("SpecialCategoryDir", entity.SpecialCategoryDir);
			dict.Add("SpecialTemplatePath", entity.SpecialTemplatePath);
			dict.Add("OrderSort", entity.OrderSort);
			dict.Add("IsNewOpen", entity.IsNewOpen);
			dict.Add("Description", entity.Description);
			dict.Add("IsCreateHtml", entity.IsCreateHtml);
			dict.Add("PagePostfix", entity.PagePostfix);
			dict.Add("SearchTemplatePath", entity.SearchTemplatePath);
