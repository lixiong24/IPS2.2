...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class AdvertisementZoneRepositoryADO : IAdvertisementZoneRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public AdvertisementZoneRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from AdvertisementZone where 1=1 ";
		...
		{
			return _DB.GetMaxID("AdvertisementZone", "ZoneID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("AdvertisementZone", "ZoneID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(AdvertisementZoneEntity entity)
		{
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into AdvertisementZone ("+
							"ZoneID,"+
							"ADID) "+
							"values("+
							"@ZoneID,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(AdvertisementZoneEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(AdvertisementZoneEntity entity)
		{
			...
			{
				return DataConverter.CLng(entity.ZoneID);
			}
			return -1;
		}
		/// <summary>
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(AdvertisementZoneEntity entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(AdvertisementZoneEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(AdvertisementZoneEntity entity, bool IsSave)
		{
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.Int32 zoneID, System.Int32 adid)
		{
			string strSQL = "delete from AdvertisementZone where " +
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 zoneID, System.Int32 adid)
		{
			string strSQL = "delete from AdvertisementZone where " +
		...
		{
			string strSQL = "delete from AdvertisementZone where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(AdvertisementZoneEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update AdvertisementZone SET "+
			" WHERE "+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(AdvertisementZoneEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update AdvertisementZone SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update AdvertisementZone SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public AdvertisementZoneEntity GetEntity(System.Int32 zoneID, System.Int32 adid)
		{
			string strCondition = string.Empty;
			strCondition += " and ZoneID = @ZoneID";
			strCondition += " and ADID = @ADID";
		...
		/// </summary>
		/// <returns></returns>
		public async Task<AdvertisementZoneEntity> GetEntityAsync(System.Int32 zoneID, System.Int32 adid)
		{
			string strCondition = string.Empty;
			strCondition += " and ZoneID = @ZoneID";
			strCondition += " and ADID = @ADID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual AdvertisementZoneEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			AdvertisementZoneEntity obj = null;
			string strSQL = "select top 1 * from AdvertisementZone where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<AdvertisementZoneEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			AdvertisementZoneEntity obj = null;
			string strSQL = "select top 1 * from AdvertisementZone where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<AdvertisementZoneEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<AdvertisementZoneEntity> list = new List<AdvertisementZoneEntity>();
			string strSQL = "select * from AdvertisementZone where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<AdvertisementZoneEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<AdvertisementZoneEntity> list = new List<AdvertisementZoneEntity>();
			string strSQL = "select * from AdvertisementZone where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from AdvertisementZone where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<AdvertisementZoneEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<AdvertisementZoneEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<AdvertisementZoneEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(AdvertisementZoneEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("ZoneID", entity.ZoneID);
		...
		/// <returns></returns>
		private static AdvertisementZoneEntity GetEntityFromrdr(NullableDataReader rdr)
		{
			AdvertisementZoneEntity info = new AdvertisementZoneEntity();
