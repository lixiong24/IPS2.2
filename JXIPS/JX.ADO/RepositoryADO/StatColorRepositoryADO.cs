...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class StatColorRepositoryADO : IStatColorRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public StatColorRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from StatColor where 1=1 ";
		...
		{
			return _DB.GetMaxID("StatColor", "TColor");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("StatColor", "TColor"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(StatColorEntity entity)
		{
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into StatColor ("+
							"TColor,"+
							"TColNum) "+
							"values("+
							"@TColor,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(StatColorEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(StatColorEntity entity)
		{
			...
			{
				return DataConverter.CLng(entity.TColor);
			}
			return -1;
		}
		/// <summary>
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(StatColorEntity entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(StatColorEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(StatColorEntity entity, bool IsSave)
		{
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.String tColor)
		{
			string strSQL = "delete from StatColor where " +
			
			"TColor = @TColor"; 
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			dict.Add("TColor", tColor);
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.String tColor)
		{
			string strSQL = "delete from StatColor where " +
		...
		{
			string strSQL = "delete from StatColor where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(StatColorEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update StatColor SET "+
			"TColNum = @TColNum"+
			" WHERE "+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(StatColorEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update StatColor SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update StatColor SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public StatColorEntity GetEntity(System.String tColor)
		{
			string strCondition = string.Empty;
			strCondition += " and TColor = @TColor";
		...
		/// </summary>
		/// <returns></returns>
		public async Task<StatColorEntity> GetEntityAsync(System.String tColor)
		{
			string strCondition = string.Empty;
			strCondition += " and TColor = @TColor";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual StatColorEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			StatColorEntity obj = null;
			string strSQL = "select top 1 * from StatColor where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<StatColorEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			StatColorEntity obj = null;
			string strSQL = "select top 1 * from StatColor where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<StatColorEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<StatColorEntity> list = new List<StatColorEntity>();
			string strSQL = "select * from StatColor where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<StatColorEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<StatColorEntity> list = new List<StatColorEntity>();
			string strSQL = "select * from StatColor where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from StatColor where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<StatColorEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatColorEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatColorEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(StatColorEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("TColor", entity.TColor);
			dict.Add("TColNum", entity.TColNum);
		}
		/// <summary>
		/// 通过数据读取器生成实体类
		/// </summary>
