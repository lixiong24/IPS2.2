...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class MailItemRepositoryADO : IMailItemRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public MailItemRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from MailItem where 1=1 ";
		...
		{
			return _DB.GetMaxID("MailItem", "MailListId");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("MailItem", "MailListId"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(MailItemEntity entity)
		{
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into MailItem ("+
							"MailListId,"+
							"SubscriptionItemId) "+
							"values("+
							"@MailListId,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(MailItemEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(MailItemEntity entity)
		{
			...
			{
				return DataConverter.CLng(entity.MailListId);
			}
			return -1;
		}
		/// <summary>
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(MailItemEntity entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(MailItemEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(MailItemEntity entity, bool IsSave)
		{
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.Int32 mailListId, System.Int32 subscriptionItemId)
		{
			string strSQL = "delete from MailItem where " +
			...
			Dictionary<string, object> dict = new Dictionary<string, object>();
			dict.Add("MailListId", mailListId);
			dict.Add("SubscriptionItemId", subscriptionItemId);
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 mailListId, System.Int32 subscriptionItemId)
		{
			string strSQL = "delete from MailItem where " +
		...
		{
			string strSQL = "delete from MailItem where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(MailItemEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update MailItem SET "+
			" WHERE "+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(MailItemEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update MailItem SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update MailItem SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public MailItemEntity GetEntity(System.Int32 mailListId, System.Int32 subscriptionItemId)
		{
			string strCondition = string.Empty;
			strCondition += " and MailListId = @MailListId";
			strCondition += " and SubscriptionItemId = @SubscriptionItemId";
		...
		/// </summary>
		/// <returns></returns>
		public async Task<MailItemEntity> GetEntityAsync(System.Int32 mailListId, System.Int32 subscriptionItemId)
		{
			string strCondition = string.Empty;
			strCondition += " and MailListId = @MailListId";
			strCondition += " and SubscriptionItemId = @SubscriptionItemId";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual MailItemEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			MailItemEntity obj = null;
			string strSQL = "select top 1 * from MailItem where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<MailItemEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			MailItemEntity obj = null;
			string strSQL = "select top 1 * from MailItem where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<MailItemEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<MailItemEntity> list = new List<MailItemEntity>();
			string strSQL = "select * from MailItem where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<MailItemEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<MailItemEntity> list = new List<MailItemEntity>();
			string strSQL = "select * from MailItem where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from MailItem where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<MailItemEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<MailItemEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<MailItemEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(MailItemEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("MailListId", entity.MailListId);
			dict.Add("SubscriptionItemId", entity.SubscriptionItemId);
		}
		/// <summary>
		/// 通过数据读取器生成实体类
		/// </summary>
		...
		/// <returns></returns>
		private static MailItemEntity GetEntityFromrdr(NullableDataReader rdr)
		{
			MailItemEntity info = new MailItemEntity();
			info.MailListId = rdr.GetInt32("MailListId");
			info.SubscriptionItemId = rdr.GetInt32("SubscriptionItemId");
			return info;
		}
		#endregion
	}
