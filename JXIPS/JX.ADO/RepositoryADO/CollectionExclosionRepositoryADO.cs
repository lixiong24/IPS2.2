...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class CollectionExclosionRepositoryADO : ICollectionExclosionRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public CollectionExclosionRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from CollectionExclosion where 1=1 ";
		...
		{
			return _DB.GetMaxID("CollectionExclosion", "ExclosionID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("CollectionExclosion", "ExclosionID"));
		}
		...
		{
			if(entity.ExclosionID <= 0) entity.ExclosionID=GetNewID();
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(CollectionExclosionEntity entity)
		{
			if(entity.ExclosionID <= 0) entity.ExclosionID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(CollectionExclosionEntity entity)
		{
			if(entity.ExclosionID <= 0) entity.ExclosionID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.Int32 exclosionID)
		{
			string strSQL = "delete from CollectionExclosion where " +
			
			"ExclosionID = @ExclosionID"; 
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			dict.Add("ExclosionID", exclosionID);
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 exclosionID)
		{
			string strSQL = "delete from CollectionExclosion where " +
		...
		{
			string strSQL = "delete from CollectionExclosion where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(CollectionExclosionEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update CollectionExclosion SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public CollectionExclosionEntity GetEntity(System.Int32 exclosionID)
		{
			string strCondition = string.Empty;
			strCondition += " and ExclosionID = @ExclosionID";
		...
		/// </summary>
		/// <returns></returns>
		public async Task<CollectionExclosionEntity> GetEntityAsync(System.Int32 exclosionID)
		{
			string strCondition = string.Empty;
			strCondition += " and ExclosionID = @ExclosionID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual CollectionExclosionEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<CollectionExclosionEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<CollectionExclosionEntity> list = new List<CollectionExclosionEntity>();
			string strSQL = "select * from CollectionExclosion where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<CollectionExclosionEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<CollectionExclosionEntity> list = new List<CollectionExclosionEntity>();
			string strSQL = "select * from CollectionExclosion where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from CollectionExclosion where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<CollectionExclosionEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CollectionExclosionEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CollectionExclosionEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
