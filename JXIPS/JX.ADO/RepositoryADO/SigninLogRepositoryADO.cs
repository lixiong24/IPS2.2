...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class SigninLogRepositoryADO : ISigninLogRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public SigninLogRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from SigninLog where 1=1 ";
		...
		{
			return _DB.GetMaxID("SigninLog", "GeneralID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("SigninLog", "GeneralID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(SigninLogEntity entity)
		{
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into SigninLog ("+
							"GeneralID,"+
							"UserName,"+
							"IsSignin,"+
							"SigninTime,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(SigninLogEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(SigninLogEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(SigninLogEntity entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(SigninLogEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(SigninLogEntity entity, bool IsSave)
		{
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.Int32 generalID, System.String userName)
		{
			string strSQL = "delete from SigninLog where " +
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 generalID, System.String userName)
		{
			string strSQL = "delete from SigninLog where " +
		...
		{
			string strSQL = "delete from SigninLog where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(SigninLogEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update SigninLog SET "+
			"IsSignin = @IsSignin,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(SigninLogEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update SigninLog SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update SigninLog SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public SigninLogEntity GetEntity(System.Int32 generalID, System.String userName)
		{
			string strCondition = string.Empty;
			strCondition += " and GeneralID = @GeneralID";
			strCondition += " and UserName = @UserName";
		...
		/// </summary>
		/// <returns></returns>
		public async Task<SigninLogEntity> GetEntityAsync(System.Int32 generalID, System.String userName)
		{
			string strCondition = string.Empty;
			strCondition += " and GeneralID = @GeneralID";
			strCondition += " and UserName = @UserName";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual SigninLogEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			SigninLogEntity obj = null;
			string strSQL = "select top 1 * from SigninLog where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<SigninLogEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			SigninLogEntity obj = null;
			string strSQL = "select top 1 * from SigninLog where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<SigninLogEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<SigninLogEntity> list = new List<SigninLogEntity>();
			string strSQL = "select * from SigninLog where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<SigninLogEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<SigninLogEntity> list = new List<SigninLogEntity>();
			string strSQL = "select * from SigninLog where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from SigninLog where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<SigninLogEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<SigninLogEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<SigninLogEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(SigninLogEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("GeneralID", entity.GeneralID);
			dict.Add("UserName", entity.UserName);
			dict.Add("IsSignin", entity.IsSignin);
			dict.Add("SigninTime", entity.SigninTime);
