...
namespace JX.ADO
{
	...
	public partial class AdminRolesRepositoryADO : IAdminRolesRepositoryADO
	{
		...
		/// </summary>
		/// <param name="DB"></param>
		public AdminRolesRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from AdminRoles where 1=1 ";
		...
		{
			return _DB.GetMaxID("AdminRoles", "AdminID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("AdminRoles", "AdminID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(AdminRolesEntity entity)
		{
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into AdminRoles ("+
							"AdminID,"+
							"RoleID) "+
							"values("+
							"@AdminID,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(AdminRolesEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(AdminRolesEntity entity)
		{
			...
			{
				return DataConverter.CLng(entity.AdminID);
			}
			return -1;
		}
		/// <summary>
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(AdminRolesEntity entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(AdminRolesEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(AdminRolesEntity entity, bool IsSave)
		{
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.Int32 adminID, System.Int32 roleID)
		{
			string strSQL = "delete from AdminRoles where " +
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 adminID, System.Int32 roleID)
		{
			string strSQL = "delete from AdminRoles where " +
		...
		{
			string strSQL = "delete from AdminRoles where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(AdminRolesEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update AdminRoles SET "+
			" WHERE "+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(AdminRolesEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update AdminRoles SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update AdminRoles SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public AdminRolesEntity GetEntity(System.Int32 adminID, System.Int32 roleID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<AdminRolesEntity> GetEntityAsync(System.Int32 adminID, System.Int32 roleID)
		{
			string strCondition = string.Empty;
			strCondition += " and AdminID = @AdminID";
			strCondition += " and RoleID = @RoleID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual AdminRolesEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			AdminRolesEntity obj = null;
			string strSQL = "select top 1 * from AdminRoles where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<AdminRolesEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			AdminRolesEntity obj = null;
			string strSQL = "select top 1 * from AdminRoles where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<AdminRolesEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<AdminRolesEntity> list = new List<AdminRolesEntity>();
			string strSQL = "select * from AdminRoles where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<AdminRolesEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<AdminRolesEntity> list = new List<AdminRolesEntity>();
			string strSQL = "select * from AdminRoles where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from AdminRoles where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<AdminRolesEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<AdminRolesEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<AdminRolesEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(AdminRolesEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("AdminID", entity.AdminID);
		...
		/// <returns></returns>
		private static AdminRolesEntity GetEntityFromrdr(NullableDataReader rdr)
		{
			AdminRolesEntity info = new AdminRolesEntity();
