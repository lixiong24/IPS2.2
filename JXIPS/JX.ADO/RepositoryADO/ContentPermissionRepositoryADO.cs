...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class ContentPermissionRepositoryADO : IContentPermissionRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public ContentPermissionRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from ContentPermission where 1=1 ";
		...
		{
			return _DB.GetMaxID("ContentPermission", "GeneralID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("ContentPermission", "GeneralID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(ContentPermissionEntity entity)
		{
			if(entity.GeneralID <= 0) entity.GeneralID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into ContentPermission ("+
							"GeneralID,"+
							"PermissionType,"+
							"arrGroupID) "+
							"values("+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(ContentPermissionEntity entity)
		{
			if(entity.GeneralID <= 0) entity.GeneralID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(ContentPermissionEntity entity)
		{
			if(entity.GeneralID <= 0) entity.GeneralID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(ContentPermissionEntity entity)
		{
			if(entity.GeneralID <= 0) entity.GeneralID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(ContentPermissionEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(ContentPermissionEntity entity, bool IsSave)
		{
		...
		{
			string strSQL = "delete from ContentPermission where " +
		...
		{
			string strSQL = "delete from ContentPermission where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(ContentPermissionEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update ContentPermission SET "+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(ContentPermissionEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update ContentPermission SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update ContentPermission SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public ContentPermissionEntity GetEntity(System.Int32 generalID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<ContentPermissionEntity> GetEntityAsync(System.Int32 generalID)
		{
			string strCondition = string.Empty;
			strCondition += " and GeneralID = @GeneralID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual ContentPermissionEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			ContentPermissionEntity obj = null;
			string strSQL = "select top 1 * from ContentPermission where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<ContentPermissionEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			ContentPermissionEntity obj = null;
			string strSQL = "select top 1 * from ContentPermission where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<ContentPermissionEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<ContentPermissionEntity> list = new List<ContentPermissionEntity>();
			string strSQL = "select * from ContentPermission where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<ContentPermissionEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<ContentPermissionEntity> list = new List<ContentPermissionEntity>();
			string strSQL = "select * from ContentPermission where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from ContentPermission where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<ContentPermissionEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ContentPermissionEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ContentPermissionEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(ContentPermissionEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("GeneralID", entity.GeneralID);
			dict.Add("PermissionType", entity.PermissionType);
			dict.Add("arrGroupID", entity.ArrGroupID);
		}
		/// <summary>
		/// 通过数据读取器生成实体类
		/// </summary>
