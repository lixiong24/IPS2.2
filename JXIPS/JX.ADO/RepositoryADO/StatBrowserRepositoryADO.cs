...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class StatBrowserRepositoryADO : IStatBrowserRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		{
			string strSQL = "select " + statistic + " from StatBrowser where 1=1 ";
		...
		{
			return _DB.GetMaxID("StatBrowser", "TBrowser");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("StatBrowser", "TBrowser"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(StatBrowserEntity entity)
		{
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into StatBrowser ("+
							"TBrowser,"+
							"TBrwNum) "+
							"values("+
							"@TBrowser,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(StatBrowserEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(StatBrowserEntity entity)
		{
			...
			{
				return DataConverter.CLng(entity.TBrowser);
			}
			return -1;
		}
		/// <summary>
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(StatBrowserEntity entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(StatBrowserEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(StatBrowserEntity entity, bool IsSave)
		{
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.String tBrowser)
		{
			string strSQL = "delete from StatBrowser where " +
			
			"TBrowser = @TBrowser"; 
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			dict.Add("TBrowser", tBrowser);
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.String tBrowser)
		{
			string strSQL = "delete from StatBrowser where " +
		...
		{
			string strSQL = "delete from StatBrowser where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(StatBrowserEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update StatBrowser SET "+
			"TBrwNum = @TBrwNum"+
			" WHERE "+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(StatBrowserEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update StatBrowser SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update StatBrowser SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public StatBrowserEntity GetEntity(System.String tBrowser)
		{
			string strCondition = string.Empty;
			strCondition += " and TBrowser = @TBrowser";
		...
		/// </summary>
		/// <returns></returns>
		public async Task<StatBrowserEntity> GetEntityAsync(System.String tBrowser)
		{
			string strCondition = string.Empty;
			strCondition += " and TBrowser = @TBrowser";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual StatBrowserEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			StatBrowserEntity obj = null;
			string strSQL = "select top 1 * from StatBrowser where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<StatBrowserEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			StatBrowserEntity obj = null;
			string strSQL = "select top 1 * from StatBrowser where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<StatBrowserEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<StatBrowserEntity> list = new List<StatBrowserEntity>();
			string strSQL = "select * from StatBrowser where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<StatBrowserEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<StatBrowserEntity> list = new List<StatBrowserEntity>();
			string strSQL = "select * from StatBrowser where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from StatBrowser where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<StatBrowserEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatBrowserEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatBrowserEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(StatBrowserEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("TBrowser", entity.TBrowser);
			dict.Add("TBrwNum", entity.TBrwNum);
		}
		/// <summary>
		/// 通过数据读取器生成实体类
		/// </summary>
