...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class ContentChargeRepositoryADO : IContentChargeRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public ContentChargeRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from ContentCharge where 1=1 ";
		...
		{
			return _DB.GetMaxID("ContentCharge", "GeneralID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("ContentCharge", "GeneralID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(ContentChargeEntity entity)
		{
			if(entity.GeneralID <= 0) entity.GeneralID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into ContentCharge ("+
							"GeneralID,"+
							"ChargeType,"+
							"InfoPoint,"+
							"PitchTime,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(ContentChargeEntity entity)
		{
			if(entity.GeneralID <= 0) entity.GeneralID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(ContentChargeEntity entity)
		{
			if(entity.GeneralID <= 0) entity.GeneralID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(ContentChargeEntity entity)
		{
			if(entity.GeneralID <= 0) entity.GeneralID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(ContentChargeEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(ContentChargeEntity entity, bool IsSave)
		{
		...
		{
			string strSQL = "delete from ContentCharge where " +
		...
		{
			string strSQL = "delete from ContentCharge where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(ContentChargeEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update ContentCharge SET "+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(ContentChargeEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update ContentCharge SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update ContentCharge SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public ContentChargeEntity GetEntity(System.Int32 generalID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<ContentChargeEntity> GetEntityAsync(System.Int32 generalID)
		{
			string strCondition = string.Empty;
			strCondition += " and GeneralID = @GeneralID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual ContentChargeEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			ContentChargeEntity obj = null;
			string strSQL = "select top 1 * from ContentCharge where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<ContentChargeEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			ContentChargeEntity obj = null;
			string strSQL = "select top 1 * from ContentCharge where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<ContentChargeEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<ContentChargeEntity> list = new List<ContentChargeEntity>();
			string strSQL = "select * from ContentCharge where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<ContentChargeEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<ContentChargeEntity> list = new List<ContentChargeEntity>();
			string strSQL = "select * from ContentCharge where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from ContentCharge where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<ContentChargeEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ContentChargeEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ContentChargeEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(ContentChargeEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("GeneralID", entity.GeneralID);
			dict.Add("ChargeType", entity.ChargeType);
			dict.Add("InfoPoint", entity.InfoPoint);
			dict.Add("PitchTime", entity.PitchTime);
			dict.Add("ReadTimes", entity.ReadTimes);
			dict.Add("DividePercent", entity.DividePercent);
		}
		/// <summary>
		/// 通过数据读取器生成实体类
		/// </summary>
		...
		/// <returns></returns>
		private static ContentChargeEntity GetEntityFromrdr(NullableDataReader rdr)
		{
			ContentChargeEntity info = new ContentChargeEntity();
			info.GeneralID = rdr.GetInt32("GeneralID");
			info.ChargeType = rdr.GetInt32("ChargeType");
			info.InfoPoint = rdr.GetInt32("InfoPoint");
			info.PitchTime = rdr.GetInt32("PitchTime");
			info.ReadTimes = rdr.GetInt32("ReadTimes");
			info.DividePercent = rdr.GetInt32("DividePercent");
			return info;
		}
		#endregion
	}
