...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class U_IntegralProductRepositoryADO : IU_IntegralProductRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public U_IntegralProductRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from U_IntegralProduct where 1=1 ";
		...
		{
			return _DB.GetMaxID("U_IntegralProduct", "ID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("U_IntegralProduct", "ID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(U_IntegralProductEntity entity)
		{
			if(entity.ID <= 0) entity.ID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into U_IntegralProduct ("+
							"ID,"+
							"Price,"+
							"NeedIntegral,"+
							"Stocks,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(U_IntegralProductEntity entity)
		{
			if(entity.ID <= 0) entity.ID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(U_IntegralProductEntity entity)
		{
			if(entity.ID <= 0) entity.ID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(U_IntegralProductEntity entity)
		{
			if(entity.ID <= 0) entity.ID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(U_IntegralProductEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(U_IntegralProductEntity entity, bool IsSave)
		{
		...
		{
			string strSQL = "delete from U_IntegralProduct where " +
		...
		{
			string strSQL = "delete from U_IntegralProduct where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(U_IntegralProductEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update U_IntegralProduct SET "+
			"Price = @Price,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(U_IntegralProductEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update U_IntegralProduct SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update U_IntegralProduct SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public U_IntegralProductEntity GetEntity(System.Int32 id)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<U_IntegralProductEntity> GetEntityAsync(System.Int32 id)
		{
			string strCondition = string.Empty;
			strCondition += " and ID = @ID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual U_IntegralProductEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			U_IntegralProductEntity obj = null;
			string strSQL = "select top 1 * from U_IntegralProduct where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<U_IntegralProductEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			U_IntegralProductEntity obj = null;
			string strSQL = "select top 1 * from U_IntegralProduct where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<U_IntegralProductEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<U_IntegralProductEntity> list = new List<U_IntegralProductEntity>();
			string strSQL = "select * from U_IntegralProduct where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<U_IntegralProductEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<U_IntegralProductEntity> list = new List<U_IntegralProductEntity>();
			string strSQL = "select * from U_IntegralProduct where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from U_IntegralProduct where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<U_IntegralProductEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<U_IntegralProductEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<U_IntegralProductEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(U_IntegralProductEntity entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static U_IntegralProductEntity GetEntityFromrdr(NullableDataReader rdr)
		{
			U_IntegralProductEntity info = new U_IntegralProductEntity();
			info.ID = rdr.GetInt32("ID");
			info.Price = rdr.GetString("Price");
			info.NeedIntegral = rdr.GetString("NeedIntegral");
			info.Stocks = rdr.GetString("Stocks");
