...
namespace JX.ADO
{
	...
	/// 数据库表：Courier 的仓储实现类.
	/// </summary>
	public partial class CourierRepositoryADO : ICourierRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public CourierRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from Courier where 1=1 ";
		...
		{
			return _DB.GetMaxID("Courier", "CourierID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("Courier", "CourierID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(CourierEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(CourierEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(CourierEntity entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(CourierEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(CourierEntity entity, bool IsSave)
		{
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.Int32 courierID)
		{
			string strSQL = "delete from Courier where " +
			
			"CourierID = @CourierID"; 
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			dict.Add("CourierID", courierID);
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 courierID)
		{
			string strSQL = "delete from Courier where " +
		...
		{
			string strSQL = "delete from Courier where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(CourierEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update Courier SET "+
			"ShortName = @ShortName,"+
			"FullName = @FullName,"+
			"Address = @Address,"+
			"Telephone = @Telephone,"+
			"Contacter = @Contacter,"+
			"SearchUrl = @SearchUrl,"+
			"SearchUrlMobile = @SearchUrlMobile"+
			" WHERE "+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(CourierEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update Courier SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update Courier SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public CourierEntity GetEntity(System.Int32 courierID)
		{
			string strCondition = string.Empty;
			strCondition += " and CourierID = @CourierID";
		...
		/// </summary>
		/// <returns></returns>
		public async Task<CourierEntity> GetEntityAsync(System.Int32 courierID)
		{
			string strCondition = string.Empty;
			strCondition += " and CourierID = @CourierID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual CourierEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			CourierEntity obj = null;
			string strSQL = "select top 1 * from Courier where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<CourierEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			CourierEntity obj = null;
			string strSQL = "select top 1 * from Courier where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<CourierEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<CourierEntity> list = new List<CourierEntity>();
			string strSQL = "select * from Courier where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<CourierEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<CourierEntity> list = new List<CourierEntity>();
			string strSQL = "select * from Courier where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from Courier where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<CourierEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CourierEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CourierEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(CourierEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("CourierID", entity.CourierID);
			dict.Add("ShortName", entity.ShortName);
			dict.Add("FullName", entity.FullName);
			dict.Add("Address", entity.Address);
			dict.Add("Telephone", entity.Telephone);
			dict.Add("Contacter", entity.Contacter);
			dict.Add("SearchUrl", entity.SearchUrl);
			dict.Add("SearchUrlMobile", entity.SearchUrlMobile);
		}
		/// <summary>
		/// 通过数据读取器生成实体类
		/// </summary>
		...
		/// <returns></returns>
		private static CourierEntity GetEntityFromrdr(NullableDataReader rdr)
		{
			CourierEntity info = new CourierEntity();
			info.CourierID = rdr.GetInt32("CourierID");
			info.ShortName = rdr.GetString("ShortName");
			info.FullName = rdr.GetString("FullName");
			info.Address = rdr.GetString("Address");
			info.Telephone = rdr.GetString("Telephone");
			info.Contacter = rdr.GetString("Contacter");
			info.SearchUrl = rdr.GetString("SearchUrl");
			info.SearchUrlMobile = rdr.GetString("SearchUrlMobile");
			return info;
		}
		#endregion
	}
