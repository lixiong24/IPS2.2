...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class InvoiceLogRepositoryADO : IInvoiceLogRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public InvoiceLogRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from InvoiceLog where 1=1 ";
		...
		{
			return _DB.GetMaxID("InvoiceLog", "InvoiceID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("InvoiceLog", "InvoiceID"));
		}
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(InvoiceLogEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(InvoiceLogEntity entity)
		{
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.Int32 invoiceID)
		{
			string strSQL = "delete from InvoiceLog where " +
			
			"InvoiceID = @InvoiceID"; 
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			dict.Add("InvoiceID", invoiceID);
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 invoiceID)
		{
			string strSQL = "delete from InvoiceLog where " +
		...
		{
			string strSQL = "delete from InvoiceLog where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(InvoiceLogEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update InvoiceLog SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public InvoiceLogEntity GetEntity(System.Int32 invoiceID)
		{
			string strCondition = string.Empty;
			strCondition += " and InvoiceID = @InvoiceID";
		...
		/// </summary>
		/// <returns></returns>
		public async Task<InvoiceLogEntity> GetEntityAsync(System.Int32 invoiceID)
		{
			string strCondition = string.Empty;
			strCondition += " and InvoiceID = @InvoiceID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual InvoiceLogEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<InvoiceLogEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<InvoiceLogEntity> list = new List<InvoiceLogEntity>();
			string strSQL = "select * from InvoiceLog where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<InvoiceLogEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<InvoiceLogEntity> list = new List<InvoiceLogEntity>();
			string strSQL = "select * from InvoiceLog where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from InvoiceLog where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<InvoiceLogEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<InvoiceLogEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<InvoiceLogEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
