...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class OrderLogRepositoryADO : IOrderLogRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public OrderLogRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from OrderLog where 1=1 ";
		...
		{
			return _DB.GetMaxID("OrderLog", "OrderLogID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("OrderLog", "OrderLogID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(OrderLogEntity entity)
		{
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into OrderLog ("+
							"OrderNum,"+
							"ActionName,"+
							"ActionTime,"+
							"UserIP,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(OrderLogEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(OrderLogEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(OrderLogEntity entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(OrderLogEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(OrderLogEntity entity, bool IsSave)
		{
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.Int32 orderLogID)
		{
			string strSQL = "delete from OrderLog where " +
			
			"OrderLogID = @OrderLogID"; 
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			dict.Add("OrderLogID", orderLogID);
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 orderLogID)
		{
			string strSQL = "delete from OrderLog where " +
		...
		{
			string strSQL = "delete from OrderLog where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(OrderLogEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update OrderLog SET "+
			"OrderNum = @OrderNum,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(OrderLogEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update OrderLog SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update OrderLog SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public OrderLogEntity GetEntity(System.Int32 orderLogID)
		{
			string strCondition = string.Empty;
			strCondition += " and OrderLogID = @OrderLogID";
		...
		/// </summary>
		/// <returns></returns>
		public async Task<OrderLogEntity> GetEntityAsync(System.Int32 orderLogID)
		{
			string strCondition = string.Empty;
			strCondition += " and OrderLogID = @OrderLogID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual OrderLogEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			OrderLogEntity obj = null;
			string strSQL = "select top 1 * from OrderLog where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<OrderLogEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			OrderLogEntity obj = null;
			string strSQL = "select top 1 * from OrderLog where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<OrderLogEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<OrderLogEntity> list = new List<OrderLogEntity>();
			string strSQL = "select * from OrderLog where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<OrderLogEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<OrderLogEntity> list = new List<OrderLogEntity>();
			string strSQL = "select * from OrderLog where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from OrderLog where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<OrderLogEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<OrderLogEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<OrderLogEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(OrderLogEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("OrderLogID", entity.OrderLogID);
			dict.Add("OrderNum", entity.OrderNum);
			dict.Add("ActionName", entity.ActionName);
			dict.Add("ActionTime", entity.ActionTime);
