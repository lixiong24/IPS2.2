...
namespace JX.ADO
{
	...
	/// 数据库表：Comment 的仓储实现类.
	/// </summary>
	public partial class CommentRepositoryADO : ICommentRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public CommentRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from Comment where 1=1 ";
		...
		{
			return _DB.GetMaxID("Comment", "CommentID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("Comment", "CommentID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(CommentEntity entity)
		{
			if(entity.CommentID <= 0) entity.CommentID=GetNewID();
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(CommentEntity entity)
		{
			if(entity.CommentID <= 0) entity.CommentID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(CommentEntity entity)
		{
			if(entity.CommentID <= 0) entity.CommentID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
			...
			{
				return DataConverter.CLng(entity.CommentID);
			}
			return -1;
		}
		/// <summary>
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(CommentEntity entity)
		{
			if(entity.CommentID <= 0) entity.CommentID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(CommentEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(CommentEntity entity, bool IsSave)
		{
		...
		{
			string strSQL = "delete from Comment where " +
			
			"CommentID = @CommentID"; 
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			dict.Add("CommentID", commentID);
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 commentID)
		{
			string strSQL = "delete from Comment where " +
		...
		{
			string strSQL = "delete from Comment where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(CommentEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update Comment SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public CommentEntity GetEntity(System.Int32 commentID)
		{
			string strCondition = string.Empty;
			strCondition += " and CommentID = @CommentID";
		...
		/// </summary>
		/// <returns></returns>
		public async Task<CommentEntity> GetEntityAsync(System.Int32 commentID)
		{
			string strCondition = string.Empty;
			strCondition += " and CommentID = @CommentID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual CommentEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			CommentEntity obj = null;
			string strSQL = "select top 1 * from Comment where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<CommentEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			CommentEntity obj = null;
			string strSQL = "select top 1 * from Comment where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<CommentEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<CommentEntity> list = new List<CommentEntity>();
			string strSQL = "select * from Comment where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<CommentEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<CommentEntity> list = new List<CommentEntity>();
			string strSQL = "select * from Comment where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from Comment where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<CommentEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CommentEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CommentEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
