...
namespace JX.ADO
{
	...
	/// 数据库表：Survey 的仓储实现类.
	/// </summary>
	public partial class SurveyRepositoryADO : ISurveyRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public SurveyRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from Survey where 1=1 ";
		...
		{
			return _DB.GetMaxID("Survey", "SurveyID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("Survey", "SurveyID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(SurveyEntity entity)
		{
			if(entity.SurveyID <= 0) entity.SurveyID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into Survey ("+
							"SurveyID,"+
							"SurveyName,"+
							"Description,"+
							"FileName,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(SurveyEntity entity)
		{
			if(entity.SurveyID <= 0) entity.SurveyID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(SurveyEntity entity)
		{
			if(entity.SurveyID <= 0) entity.SurveyID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
			...
			{
				return DataConverter.CLng(entity.SurveyID);
			}
			return -1;
		}
		/// <summary>
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(SurveyEntity entity)
		{
			if(entity.SurveyID <= 0) entity.SurveyID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(SurveyEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(SurveyEntity entity, bool IsSave)
		{
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.Int32 surveyID)
		{
			string strSQL = "delete from Survey where " +
			
			"SurveyID = @SurveyID"; 
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			dict.Add("SurveyID", surveyID);
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 surveyID)
		{
			string strSQL = "delete from Survey where " +
		...
		{
			string strSQL = "delete from Survey where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(SurveyEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update Survey SET "+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(SurveyEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update Survey SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update Survey SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public SurveyEntity GetEntity(System.Int32 surveyID)
		{
			string strCondition = string.Empty;
			strCondition += " and SurveyID = @SurveyID";
		...
		/// </summary>
		/// <returns></returns>
		public async Task<SurveyEntity> GetEntityAsync(System.Int32 surveyID)
		{
			string strCondition = string.Empty;
			strCondition += " and SurveyID = @SurveyID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual SurveyEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			SurveyEntity obj = null;
			string strSQL = "select top 1 * from Survey where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<SurveyEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			SurveyEntity obj = null;
			string strSQL = "select top 1 * from Survey where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<SurveyEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<SurveyEntity> list = new List<SurveyEntity>();
			string strSQL = "select * from Survey where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<SurveyEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<SurveyEntity> list = new List<SurveyEntity>();
			string strSQL = "select * from Survey where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from Survey where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<SurveyEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<SurveyEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<SurveyEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(SurveyEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("SurveyID", entity.SurveyID);
			dict.Add("SurveyName", entity.SurveyName);
			dict.Add("Description", entity.Description);
			dict.Add("FileName", entity.FileName);
			dict.Add("IPRepeat", entity.IPRepeat);
			dict.Add("CreateDate", entity.CreateDate);
			dict.Add("EndTime", entity.EndTime);
			dict.Add("IsOpen", entity.IsOpen);
			dict.Add("NeedLogin", entity.NeedLogin);
			dict.Add("PresentPoint", entity.PresentPoint);
			dict.Add("LockIPType", entity.LockIPType);
			dict.Add("SetIPLock", entity.SetIPLock);
			dict.Add("LockUrl", entity.LockUrl);
			dict.Add("SetPassword", entity.SetPassword);
			dict.Add("Template", entity.Template);
			dict.Add("QuestionField", entity.QuestionField);
			dict.Add("QuestionMaxID", entity.QuestionMaxID);
		}
		/// <summary>
		/// 通过数据读取器生成实体类
		/// </summary>
