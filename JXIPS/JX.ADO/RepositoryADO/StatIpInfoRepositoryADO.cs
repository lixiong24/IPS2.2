...
{
	/// <summary>
	/// 数据库表：StatIpInfo 的仓储实现类.
	/// </summary>
	public partial class StatIpInfoRepositoryADO : IStatIpInfoRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		{
			string strSQL = "select " + statistic + " from StatIpInfo where 1=1 ";
		...
		{
			return _DB.GetMaxID("StatIpInfo", "ID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("StatIpInfo", "ID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(StatIpInfoEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(StatIpInfoEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(StatIpInfoEntity entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(StatIpInfoEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(StatIpInfoEntity entity, bool IsSave)
		{
		...
		{
			string strSQL = "delete from StatIpInfo where " +
		...
		{
			string strSQL = "delete from StatIpInfo where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(StatIpInfoEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update StatIpInfo SET "+
			"StartIp = @StartIp,"+
			"EndIp = @EndIp,"+
			"Address = @Address"+
			" WHERE "+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(StatIpInfoEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update StatIpInfo SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update StatIpInfo SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public StatIpInfoEntity GetEntity(System.Int32 id)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<StatIpInfoEntity> GetEntityAsync(System.Int32 id)
		{
			string strCondition = string.Empty;
			strCondition += " and ID = @ID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual StatIpInfoEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			StatIpInfoEntity obj = null;
			string strSQL = "select top 1 * from StatIpInfo where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<StatIpInfoEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			StatIpInfoEntity obj = null;
			string strSQL = "select top 1 * from StatIpInfo where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<StatIpInfoEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<StatIpInfoEntity> list = new List<StatIpInfoEntity>();
			string strSQL = "select * from StatIpInfo where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<StatIpInfoEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<StatIpInfoEntity> list = new List<StatIpInfoEntity>();
			string strSQL = "select * from StatIpInfo where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from StatIpInfo where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<StatIpInfoEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatIpInfoEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatIpInfoEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(StatIpInfoEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("ID", entity.ID);
			dict.Add("StartIp", entity.StartIp);
			dict.Add("EndIp", entity.EndIp);
