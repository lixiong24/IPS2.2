...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class StatReferRepositoryADO : IStatReferRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public StatReferRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from StatRefer where 1=1 ";
		...
		{
			return _DB.GetMaxID("StatRefer", "TRefer");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("StatRefer", "TRefer"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(StatReferEntity entity)
		{
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into StatRefer ("+
							"TRefer,"+
							"TRefNum) "+
							"values("+
							"@TRefer,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(StatReferEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(StatReferEntity entity)
		{
			...
			{
				return DataConverter.CLng(entity.TRefer);
			}
			return -1;
		}
		/// <summary>
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(StatReferEntity entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(StatReferEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(StatReferEntity entity, bool IsSave)
		{
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.String tRefer)
		{
			string strSQL = "delete from StatRefer where " +
			
			"TRefer = @TRefer"; 
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			dict.Add("TRefer", tRefer);
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.String tRefer)
		{
			string strSQL = "delete from StatRefer where " +
		...
		{
			string strSQL = "delete from StatRefer where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(StatReferEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update StatRefer SET "+
			"TRefNum = @TRefNum"+
			" WHERE "+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(StatReferEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update StatRefer SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update StatRefer SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public StatReferEntity GetEntity(System.String tRefer)
		{
			string strCondition = string.Empty;
			strCondition += " and TRefer = @TRefer";
		...
		/// </summary>
		/// <returns></returns>
		public async Task<StatReferEntity> GetEntityAsync(System.String tRefer)
		{
			string strCondition = string.Empty;
			strCondition += " and TRefer = @TRefer";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual StatReferEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			StatReferEntity obj = null;
			string strSQL = "select top 1 * from StatRefer where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<StatReferEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			StatReferEntity obj = null;
			string strSQL = "select top 1 * from StatRefer where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<StatReferEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<StatReferEntity> list = new List<StatReferEntity>();
			string strSQL = "select * from StatRefer where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<StatReferEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<StatReferEntity> list = new List<StatReferEntity>();
			string strSQL = "select * from StatRefer where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from StatRefer where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<StatReferEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatReferEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatReferEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(StatReferEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("TRefer", entity.TRefer);
			dict.Add("TRefNum", entity.TRefNum);
		}
		/// <summary>
		/// 通过数据读取器生成实体类
		/// </summary>
		...
		/// <returns></returns>
		private static StatReferEntity GetEntityFromrdr(NullableDataReader rdr)
		{
			StatReferEntity info = new StatReferEntity();
			info.TRefer = rdr.GetString("TRefer");
			info.TRefNum = rdr.GetInt32("TRefNum");
			return info;
		}
		#endregion
	}
