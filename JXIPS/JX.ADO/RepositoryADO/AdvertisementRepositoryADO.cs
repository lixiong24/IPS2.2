...
{
	/// <summary>
	/// 数据库表：Advertisement 的仓储实现类.
	/// </summary>
	public partial class AdvertisementRepositoryADO : IAdvertisementRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public AdvertisementRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from Advertisement where 1=1 ";
		...
		{
			return _DB.GetMaxID("Advertisement", "ADID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("Advertisement", "ADID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(AdvertisementEntity entity)
		{
			if(entity.ADID <= 0) entity.ADID=GetNewID();
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(AdvertisementEntity entity)
		{
			if(entity.ADID <= 0) entity.ADID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
			...
			{
				return DataConverter.CLng(entity.ADID);
			}
			return -1;
		}
		/// <summary>
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(AdvertisementEntity entity)
		{
			if(entity.ADID <= 0) entity.ADID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.Int32 adid)
		{
			string strSQL = "delete from Advertisement where " +
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 adid)
		{
			string strSQL = "delete from Advertisement where " +
		...
		{
			string strSQL = "delete from Advertisement where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(AdvertisementEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update Advertisement SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public AdvertisementEntity GetEntity(System.Int32 adid)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<AdvertisementEntity> GetEntityAsync(System.Int32 adid)
		{
			string strCondition = string.Empty;
			strCondition += " and ADID = @ADID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual AdvertisementEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<AdvertisementEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<AdvertisementEntity> list = new List<AdvertisementEntity>();
			string strSQL = "select * from Advertisement where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<AdvertisementEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<AdvertisementEntity> list = new List<AdvertisementEntity>();
			string strSQL = "select * from Advertisement where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from Advertisement where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<AdvertisementEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<AdvertisementEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<AdvertisementEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
