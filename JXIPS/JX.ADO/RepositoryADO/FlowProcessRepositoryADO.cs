...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class FlowProcessRepositoryADO : IFlowProcessRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public FlowProcessRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from FlowProcess where 1=1 ";
		...
		{
			return _DB.GetMaxID("FlowProcess", "ProcessID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("FlowProcess", "ProcessID"));
		}
		...
		{
			if(entity.ProcessID <= 0) entity.ProcessID=GetNewID();
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(FlowProcessEntity entity)
		{
			if(entity.ProcessID <= 0) entity.ProcessID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(FlowProcessEntity entity)
		{
			if(entity.ProcessID <= 0) entity.ProcessID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.Int32 processID)
		{
			string strSQL = "delete from FlowProcess where " +
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 processID)
		{
			string strSQL = "delete from FlowProcess where " +
		...
		{
			string strSQL = "delete from FlowProcess where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(FlowProcessEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update FlowProcess SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public FlowProcessEntity GetEntity(System.Int32 processID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<FlowProcessEntity> GetEntityAsync(System.Int32 processID)
		{
			string strCondition = string.Empty;
			strCondition += " and ProcessID = @ProcessID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual FlowProcessEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<FlowProcessEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<FlowProcessEntity> list = new List<FlowProcessEntity>();
			string strSQL = "select * from FlowProcess where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<FlowProcessEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<FlowProcessEntity> list = new List<FlowProcessEntity>();
			string strSQL = "select * from FlowProcess where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from FlowProcess where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<FlowProcessEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<FlowProcessEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<FlowProcessEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
