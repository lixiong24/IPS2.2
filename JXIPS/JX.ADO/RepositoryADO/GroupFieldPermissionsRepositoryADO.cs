...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class GroupFieldPermissionsRepositoryADO : IGroupFieldPermissionsRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public GroupFieldPermissionsRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from GroupFieldPermissions where 1=1 ";
		...
		{
			return _DB.GetMaxID("GroupFieldPermissions", "GroupID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("GroupFieldPermissions", "GroupID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(GroupFieldPermissionsEntity entity)
		{
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into GroupFieldPermissions ("+
							"GroupID,"+
							"OperateCode,"+
							"ModelID,"+
							"FieldName,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(GroupFieldPermissionsEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(GroupFieldPermissionsEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(GroupFieldPermissionsEntity entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(GroupFieldPermissionsEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(GroupFieldPermissionsEntity entity, bool IsSave)
		{
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.Int32 groupID, System.Int32 operateCode, System.Int32 modelID, System.String fieldName, System.Int32 idType)
		{
			string strSQL = "delete from GroupFieldPermissions where " +
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 groupID, System.Int32 operateCode, System.Int32 modelID, System.String fieldName, System.Int32 idType)
		{
			string strSQL = "delete from GroupFieldPermissions where " +
		...
		{
			string strSQL = "delete from GroupFieldPermissions where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(GroupFieldPermissionsEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update GroupFieldPermissions SET "+
			" WHERE "+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(GroupFieldPermissionsEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update GroupFieldPermissions SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update GroupFieldPermissions SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public GroupFieldPermissionsEntity GetEntity(System.Int32 groupID, System.Int32 operateCode, System.Int32 modelID, System.String fieldName, System.Int32 idType)
		{
			string strCondition = string.Empty;
			strCondition += " and GroupID = @GroupID";
			strCondition += " and OperateCode = @OperateCode";
			strCondition += " and ModelID = @ModelID";
			strCondition += " and FieldName = @FieldName";
		...
		/// </summary>
		/// <returns></returns>
		public async Task<GroupFieldPermissionsEntity> GetEntityAsync(System.Int32 groupID, System.Int32 operateCode, System.Int32 modelID, System.String fieldName, System.Int32 idType)
		{
			string strCondition = string.Empty;
			strCondition += " and GroupID = @GroupID";
			strCondition += " and OperateCode = @OperateCode";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual GroupFieldPermissionsEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			GroupFieldPermissionsEntity obj = null;
			string strSQL = "select top 1 * from GroupFieldPermissions where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<GroupFieldPermissionsEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			GroupFieldPermissionsEntity obj = null;
			string strSQL = "select top 1 * from GroupFieldPermissions where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<GroupFieldPermissionsEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<GroupFieldPermissionsEntity> list = new List<GroupFieldPermissionsEntity>();
			string strSQL = "select * from GroupFieldPermissions where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<GroupFieldPermissionsEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<GroupFieldPermissionsEntity> list = new List<GroupFieldPermissionsEntity>();
			string strSQL = "select * from GroupFieldPermissions where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from GroupFieldPermissions where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<GroupFieldPermissionsEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		public virtual IList<GroupFieldPermissionsEntity> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			...
			{
				TableName = "GroupFieldPermissions";
			}
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<GroupFieldPermissionsEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<GroupFieldPermissionsEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(GroupFieldPermissionsEntity entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static GroupFieldPermissionsEntity GetEntityFromrdr(NullableDataReader rdr)
		{
			GroupFieldPermissionsEntity info = new GroupFieldPermissionsEntity();
