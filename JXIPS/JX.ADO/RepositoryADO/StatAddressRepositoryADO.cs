...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class StatAddressRepositoryADO : IStatAddressRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		{
			string strSQL = "select " + statistic + " from StatAddress where 1=1 ";
		...
		{
			return _DB.GetMaxID("StatAddress", "TAddress");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("StatAddress", "TAddress"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(StatAddressEntity entity)
		{
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into StatAddress ("+
							"TAddress,"+
							"TAddNum) "+
							"values("+
							"@TAddress,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(StatAddressEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(StatAddressEntity entity)
		{
			...
			{
				return DataConverter.CLng(entity.TAddress);
			}
			return -1;
		}
		/// <summary>
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(StatAddressEntity entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(StatAddressEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(StatAddressEntity entity, bool IsSave)
		{
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.String tAddress)
		{
			string strSQL = "delete from StatAddress where " +
			
			"TAddress = @TAddress"; 
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			dict.Add("TAddress", tAddress);
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.String tAddress)
		{
			string strSQL = "delete from StatAddress where " +
		...
		{
			string strSQL = "delete from StatAddress where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(StatAddressEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update StatAddress SET "+
			"TAddNum = @TAddNum"+
			" WHERE "+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(StatAddressEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update StatAddress SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update StatAddress SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public StatAddressEntity GetEntity(System.String tAddress)
		{
			string strCondition = string.Empty;
			strCondition += " and TAddress = @TAddress";
		...
		/// </summary>
		/// <returns></returns>
		public async Task<StatAddressEntity> GetEntityAsync(System.String tAddress)
		{
			string strCondition = string.Empty;
			strCondition += " and TAddress = @TAddress";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual StatAddressEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			StatAddressEntity obj = null;
			string strSQL = "select top 1 * from StatAddress where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<StatAddressEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			StatAddressEntity obj = null;
			string strSQL = "select top 1 * from StatAddress where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<StatAddressEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<StatAddressEntity> list = new List<StatAddressEntity>();
			string strSQL = "select * from StatAddress where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<StatAddressEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<StatAddressEntity> list = new List<StatAddressEntity>();
			string strSQL = "select * from StatAddress where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from StatAddress where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<StatAddressEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatAddressEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatAddressEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(StatAddressEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("TAddress", entity.TAddress);
			dict.Add("TAddNum", entity.TAddNum);
		}
		/// <summary>
		/// 通过数据读取器生成实体类
		/// </summary>
