...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class TransferLogRepositoryADO : ITransferLogRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public TransferLogRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from TransferLog where 1=1 ";
		...
		{
			return _DB.GetMaxID("TransferLog", "TransferLogID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("TransferLog", "TransferLogID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(TransferLogEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(TransferLogEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(TransferLogEntity entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(TransferLogEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(TransferLogEntity entity, bool IsSave)
		{
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.Int32 transferLogID)
		{
			string strSQL = "delete from TransferLog where " +
			
			"TransferLogID = @TransferLogID"; 
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			dict.Add("TransferLogID", transferLogID);
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 transferLogID)
		{
			string strSQL = "delete from TransferLog where " +
		...
		{
			string strSQL = "delete from TransferLog where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(TransferLogEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update TransferLog SET "+
			"OrderID = @OrderID,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(TransferLogEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update TransferLog SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update TransferLog SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public TransferLogEntity GetEntity(System.Int32 transferLogID)
		{
			string strCondition = string.Empty;
			strCondition += " and TransferLogID = @TransferLogID";
		...
		/// </summary>
		/// <returns></returns>
		public async Task<TransferLogEntity> GetEntityAsync(System.Int32 transferLogID)
		{
			string strCondition = string.Empty;
			strCondition += " and TransferLogID = @TransferLogID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual TransferLogEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			TransferLogEntity obj = null;
			string strSQL = "select top 1 * from TransferLog where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<TransferLogEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			TransferLogEntity obj = null;
			string strSQL = "select top 1 * from TransferLog where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<TransferLogEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<TransferLogEntity> list = new List<TransferLogEntity>();
			string strSQL = "select * from TransferLog where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<TransferLogEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<TransferLogEntity> list = new List<TransferLogEntity>();
			string strSQL = "select * from TransferLog where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from TransferLog where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<TransferLogEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<TransferLogEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<TransferLogEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(TransferLogEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("TransferLogID", entity.TransferLogID);
			dict.Add("OrderID", entity.OrderID);
			dict.Add("TransferTime", entity.TransferTime);
			dict.Add("OwnerUserName", entity.OwnerUserName);
			dict.Add("PayerUserName", entity.PayerUserName);
			dict.Add("TargetUserName", entity.TargetUserName);
			dict.Add("Poundage", entity.Poundage);
