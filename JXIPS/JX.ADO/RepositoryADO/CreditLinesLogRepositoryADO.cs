...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class CreditLinesLogRepositoryADO : ICreditLinesLogRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public CreditLinesLogRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from CreditLinesLog where 1=1 ";
		...
		{
			return _DB.GetMaxID("CreditLinesLog", "LogID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("CreditLinesLog", "LogID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(CreditLinesLogEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(CreditLinesLogEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(CreditLinesLogEntity entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(CreditLinesLogEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(CreditLinesLogEntity entity, bool IsSave)
		{
		...
		{
			string strSQL = "delete from CreditLinesLog where " +
		...
		{
			string strSQL = "delete from CreditLinesLog where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(CreditLinesLogEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update CreditLinesLog SET "+
			"UserName = @UserName,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(CreditLinesLogEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update CreditLinesLog SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update CreditLinesLog SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public CreditLinesLogEntity GetEntity(System.Int32 logID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<CreditLinesLogEntity> GetEntityAsync(System.Int32 logID)
		{
			string strCondition = string.Empty;
			strCondition += " and LogID = @LogID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual CreditLinesLogEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			CreditLinesLogEntity obj = null;
			string strSQL = "select top 1 * from CreditLinesLog where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<CreditLinesLogEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			CreditLinesLogEntity obj = null;
			string strSQL = "select top 1 * from CreditLinesLog where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<CreditLinesLogEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<CreditLinesLogEntity> list = new List<CreditLinesLogEntity>();
			string strSQL = "select * from CreditLinesLog where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<CreditLinesLogEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<CreditLinesLogEntity> list = new List<CreditLinesLogEntity>();
			string strSQL = "select * from CreditLinesLog where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from CreditLinesLog where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<CreditLinesLogEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CreditLinesLogEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CreditLinesLogEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(CreditLinesLogEntity entity, Dictionary<string, object> dict)
		{
