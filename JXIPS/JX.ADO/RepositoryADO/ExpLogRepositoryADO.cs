...
namespace JX.ADO
{
	...
	/// 数据库表：ExpLog 的仓储实现类.
	/// </summary>
	public partial class ExpLogRepositoryADO : IExpLogRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public ExpLogRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from ExpLog where 1=1 ";
		...
		{
			return _DB.GetMaxID("ExpLog", "LogID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("ExpLog", "LogID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(ExpLogEntity entity)
		{
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into ExpLog ("+
							"UserName,"+
							"ExpNum,"+
							"IncomePayout,"+
							"LogTime,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(ExpLogEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(ExpLogEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(ExpLogEntity entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(ExpLogEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(ExpLogEntity entity, bool IsSave)
		{
		...
		{
			string strSQL = "delete from ExpLog where " +
		...
		{
			string strSQL = "delete from ExpLog where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(ExpLogEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update ExpLog SET "+
			"UserName = @UserName,"+
			"ExpNum = @ExpNum,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(ExpLogEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update ExpLog SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update ExpLog SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public ExpLogEntity GetEntity(System.Int32 logID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<ExpLogEntity> GetEntityAsync(System.Int32 logID)
		{
			string strCondition = string.Empty;
			strCondition += " and LogID = @LogID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual ExpLogEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			ExpLogEntity obj = null;
			string strSQL = "select top 1 * from ExpLog where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<ExpLogEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			ExpLogEntity obj = null;
			string strSQL = "select top 1 * from ExpLog where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<ExpLogEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<ExpLogEntity> list = new List<ExpLogEntity>();
			string strSQL = "select * from ExpLog where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<ExpLogEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<ExpLogEntity> list = new List<ExpLogEntity>();
			string strSQL = "select * from ExpLog where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from ExpLog where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<ExpLogEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ExpLogEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ExpLogEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(ExpLogEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("LogID", entity.LogID);
			dict.Add("UserName", entity.UserName);
			dict.Add("ExpNum", entity.ExpNum);
		...
		/// <returns></returns>
		private static ExpLogEntity GetEntityFromrdr(NullableDataReader rdr)
		{
			ExpLogEntity info = new ExpLogEntity();
			info.LogID = rdr.GetInt32("LogID");
			info.UserName = rdr.GetString("UserName");
			info.ExpNum = rdr.GetInt32("ExpNum");
