...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class CorrelativeInfoRepositoryADO : ICorrelativeInfoRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		{
			string strSQL = "select " + statistic + " from CorrelativeInfo where 1=1 ";
		...
		{
			return _DB.GetMaxID("CorrelativeInfo", "ID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("CorrelativeInfo", "ID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(CorrelativeInfoEntity entity)
		{
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into CorrelativeInfo ("+
							"GeneralId,"+
							"CorrelativeGeneralId,"+
							"ModelId,"+
							"OrderSort) "+
							"values("+
							"@GeneralId,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(CorrelativeInfoEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(CorrelativeInfoEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(CorrelativeInfoEntity entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(CorrelativeInfoEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(CorrelativeInfoEntity entity, bool IsSave)
		{
		...
		{
			string strSQL = "delete from CorrelativeInfo where " +
		...
		{
			string strSQL = "delete from CorrelativeInfo where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(CorrelativeInfoEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update CorrelativeInfo SET "+
			"GeneralId = @GeneralId,"+
			"CorrelativeGeneralId = @CorrelativeGeneralId,"+
			"ModelId = @ModelId,"+
			"OrderSort = @OrderSort"+
			" WHERE "+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(CorrelativeInfoEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update CorrelativeInfo SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update CorrelativeInfo SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public CorrelativeInfoEntity GetEntity(System.Int32 id)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<CorrelativeInfoEntity> GetEntityAsync(System.Int32 id)
		{
			string strCondition = string.Empty;
			strCondition += " and ID = @ID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual CorrelativeInfoEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			CorrelativeInfoEntity obj = null;
			string strSQL = "select top 1 * from CorrelativeInfo where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<CorrelativeInfoEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			CorrelativeInfoEntity obj = null;
			string strSQL = "select top 1 * from CorrelativeInfo where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<CorrelativeInfoEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<CorrelativeInfoEntity> list = new List<CorrelativeInfoEntity>();
			string strSQL = "select * from CorrelativeInfo where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<CorrelativeInfoEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<CorrelativeInfoEntity> list = new List<CorrelativeInfoEntity>();
			string strSQL = "select * from CorrelativeInfo where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from CorrelativeInfo where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<CorrelativeInfoEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CorrelativeInfoEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CorrelativeInfoEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(CorrelativeInfoEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("ID", entity.ID);
			dict.Add("GeneralId", entity.GeneralId);
			dict.Add("CorrelativeGeneralId", entity.CorrelativeGeneralId);
		...
		/// <returns></returns>
		private static CorrelativeInfoEntity GetEntityFromrdr(NullableDataReader rdr)
		{
			CorrelativeInfoEntity info = new CorrelativeInfoEntity();
			info.ID = rdr.GetInt32("ID");
			info.GeneralId = rdr.GetInt32("GeneralId");
			info.CorrelativeGeneralId = rdr.GetInt32("CorrelativeGeneralId");
