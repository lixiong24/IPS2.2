...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class ComplainLogRepositoryADO : IComplainLogRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public ComplainLogRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from ComplainLog where 1=1 ";
		...
		{
			return _DB.GetMaxID("ComplainLog", "ItemID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("ComplainLog", "ItemID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(ComplainLogEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(ComplainLogEntity entity)
		{
			if(entity.ItemID <= 0) entity.ItemID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(ComplainLogEntity entity)
		{
			if(entity.ItemID <= 0) entity.ItemID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		{
			string strSQL = "delete from ComplainLog where " +
		...
		{
			string strSQL = "delete from ComplainLog where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(ComplainLogEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update ComplainLog SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public ComplainLogEntity GetEntity(System.Int32 itemID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<ComplainLogEntity> GetEntityAsync(System.Int32 itemID)
		{
			string strCondition = string.Empty;
			strCondition += " and ItemID = @ItemID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual ComplainLogEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<ComplainLogEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<ComplainLogEntity> list = new List<ComplainLogEntity>();
			string strSQL = "select * from ComplainLog where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<ComplainLogEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<ComplainLogEntity> list = new List<ComplainLogEntity>();
			string strSQL = "select * from ComplainLog where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from ComplainLog where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<ComplainLogEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ComplainLogEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ComplainLogEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
