...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class GroupNodePermissionsRepositoryADO : IGroupNodePermissionsRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public GroupNodePermissionsRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from GroupNodePermissions where 1=1 ";
		...
		{
			return _DB.GetMaxID("GroupNodePermissions", "GroupID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("GroupNodePermissions", "GroupID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(GroupNodePermissionsEntity entity)
		{
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into GroupNodePermissions ("+
							"GroupID,"+
							"OperateCode,"+
							"NodeID,"+
							"IdType) "+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(GroupNodePermissionsEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(GroupNodePermissionsEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(GroupNodePermissionsEntity entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(GroupNodePermissionsEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(GroupNodePermissionsEntity entity, bool IsSave)
		{
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.Int32 groupID, System.Int32 operateCode, System.Int32 nodeID, System.Int32 idType)
		{
			string strSQL = "delete from GroupNodePermissions where " +
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 groupID, System.Int32 operateCode, System.Int32 nodeID, System.Int32 idType)
		{
			string strSQL = "delete from GroupNodePermissions where " +
		...
		{
			string strSQL = "delete from GroupNodePermissions where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(GroupNodePermissionsEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update GroupNodePermissions SET "+
			" WHERE "+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(GroupNodePermissionsEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update GroupNodePermissions SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update GroupNodePermissions SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public GroupNodePermissionsEntity GetEntity(System.Int32 groupID, System.Int32 operateCode, System.Int32 nodeID, System.Int32 idType)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<GroupNodePermissionsEntity> GetEntityAsync(System.Int32 groupID, System.Int32 operateCode, System.Int32 nodeID, System.Int32 idType)
		{
			string strCondition = string.Empty;
			strCondition += " and GroupID = @GroupID";
			strCondition += " and OperateCode = @OperateCode";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual GroupNodePermissionsEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			GroupNodePermissionsEntity obj = null;
			string strSQL = "select top 1 * from GroupNodePermissions where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<GroupNodePermissionsEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			GroupNodePermissionsEntity obj = null;
			string strSQL = "select top 1 * from GroupNodePermissions where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<GroupNodePermissionsEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<GroupNodePermissionsEntity> list = new List<GroupNodePermissionsEntity>();
			string strSQL = "select * from GroupNodePermissions where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<GroupNodePermissionsEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<GroupNodePermissionsEntity> list = new List<GroupNodePermissionsEntity>();
			string strSQL = "select * from GroupNodePermissions where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from GroupNodePermissions where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<GroupNodePermissionsEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		public virtual IList<GroupNodePermissionsEntity> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			...
			{
				TableName = "GroupNodePermissions";
			}
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<GroupNodePermissionsEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<GroupNodePermissionsEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(GroupNodePermissionsEntity entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static GroupNodePermissionsEntity GetEntityFromrdr(NullableDataReader rdr)
		{
			GroupNodePermissionsEntity info = new GroupNodePermissionsEntity();
