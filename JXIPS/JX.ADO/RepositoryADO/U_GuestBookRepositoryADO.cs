...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class U_GuestBookRepositoryADO : IU_GuestBookRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public U_GuestBookRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from U_GuestBook where 1=1 ";
		...
		{
			return _DB.GetMaxID("U_GuestBook", "ID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("U_GuestBook", "ID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(U_GuestBookEntity entity)
		{
			if(entity.ID <= 0) entity.ID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into U_GuestBook ("+
							"ID,"+
							"GuestName,"+
							"GuestOicq,"+
							"GuestMsn,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(U_GuestBookEntity entity)
		{
			if(entity.ID <= 0) entity.ID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(U_GuestBookEntity entity)
		{
			if(entity.ID <= 0) entity.ID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(U_GuestBookEntity entity)
		{
			if(entity.ID <= 0) entity.ID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(U_GuestBookEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(U_GuestBookEntity entity, bool IsSave)
		{
		...
		{
			string strSQL = "delete from U_GuestBook where " +
		...
		{
			string strSQL = "delete from U_GuestBook where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(U_GuestBookEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update U_GuestBook SET "+
			"GuestName = @GuestName,"+
			"GuestOicq = @GuestOicq,"+
			"GuestMsn = @GuestMsn,"+
			"GuestEmail = @GuestEmail,"+
			"GuestContent = @GuestContent,"+
			"GuestIsPrivate = @GuestIsPrivate,"+
			"GuestFace = @GuestFace,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(U_GuestBookEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update U_GuestBook SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update U_GuestBook SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public U_GuestBookEntity GetEntity(System.Int32 id)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<U_GuestBookEntity> GetEntityAsync(System.Int32 id)
		{
			string strCondition = string.Empty;
			strCondition += " and ID = @ID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual U_GuestBookEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			U_GuestBookEntity obj = null;
			string strSQL = "select top 1 * from U_GuestBook where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<U_GuestBookEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			U_GuestBookEntity obj = null;
			string strSQL = "select top 1 * from U_GuestBook where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<U_GuestBookEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<U_GuestBookEntity> list = new List<U_GuestBookEntity>();
			string strSQL = "select * from U_GuestBook where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<U_GuestBookEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<U_GuestBookEntity> list = new List<U_GuestBookEntity>();
			string strSQL = "select * from U_GuestBook where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from U_GuestBook where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<U_GuestBookEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<U_GuestBookEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<U_GuestBookEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(U_GuestBookEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("ID", entity.ID);
			dict.Add("GuestName", entity.GuestName);
			dict.Add("GuestOicq", entity.GuestOicq);
			dict.Add("GuestMsn", entity.GuestMsn);
			dict.Add("GuestEmail", entity.GuestEmail);
			dict.Add("GuestContent", entity.GuestContent);
			dict.Add("GuestIsPrivate", entity.GuestIsPrivate);
			dict.Add("GuestFace", entity.GuestFace);
			dict.Add("GuestHomepage", entity.GuestHomepage);
			dict.Add("GuestImages", entity.GuestImages);
			dict.Add("AdminReply", entity.AdminReply);
		...
		/// <returns></returns>
		private static U_GuestBookEntity GetEntityFromrdr(NullableDataReader rdr)
		{
			U_GuestBookEntity info = new U_GuestBookEntity();
			info.ID = rdr.GetInt32("ID");
			info.GuestName = rdr.GetString("GuestName");
			info.GuestOicq = rdr.GetString("GuestOicq");
			info.GuestMsn = rdr.GetString("GuestMsn");
			info.GuestEmail = rdr.GetString("GuestEmail");
			info.GuestContent = rdr.GetString("GuestContent");
			info.GuestIsPrivate = rdr.GetBoolean("GuestIsPrivate");
			info.GuestFace = rdr.GetString("GuestFace");
			info.GuestHomepage = rdr.GetString("GuestHomepage");
			info.GuestImages = rdr.GetString("GuestImages");
			info.AdminReply = rdr.GetString("AdminReply");
			info.AdminReplyTime = rdr.GetNullableDateTime("AdminReplyTime");
			return info;
		}
		#endregion
	}
