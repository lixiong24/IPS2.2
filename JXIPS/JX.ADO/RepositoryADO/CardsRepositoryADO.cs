...
namespace JX.ADO
{
	...
	/// 数据库表：Cards 的仓储实现类.
	/// </summary>
	public partial class CardsRepositoryADO : ICardsRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public CardsRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from Cards where 1=1 ";
		...
		{
			return _DB.GetMaxID("Cards", "CardID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("Cards", "CardID"));
		}
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(CardsEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(CardsEntity entity)
		{
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.Int32 cardID)
		{
			string strSQL = "delete from Cards where " +
			
			"CardID = @CardID"; 
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			dict.Add("CardID", cardID);
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 cardID)
		{
			string strSQL = "delete from Cards where " +
		...
		{
			string strSQL = "delete from Cards where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(CardsEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update Cards SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public CardsEntity GetEntity(System.Int32 cardID)
		{
			string strCondition = string.Empty;
			strCondition += " and CardID = @CardID";
		...
		/// </summary>
		/// <returns></returns>
		public async Task<CardsEntity> GetEntityAsync(System.Int32 cardID)
		{
			string strCondition = string.Empty;
			strCondition += " and CardID = @CardID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<CardsEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<CardsEntity> list = new List<CardsEntity>();
			string strSQL = "select * from Cards where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<CardsEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<CardsEntity> list = new List<CardsEntity>();
			string strSQL = "select * from Cards where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from Cards where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<CardsEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CardsEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CardsEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
