...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class KeywordRelationRepositoryADO : IKeywordRelationRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public KeywordRelationRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from KeywordRelation where 1=1 ";
		...
		{
			return _DB.GetMaxID("KeywordRelation", "ID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("KeywordRelation", "ID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(KeywordRelationEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(KeywordRelationEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(KeywordRelationEntity entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(KeywordRelationEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(KeywordRelationEntity entity, bool IsSave)
		{
		...
		{
			string strSQL = "delete from KeywordRelation where " +
		...
		{
			string strSQL = "delete from KeywordRelation where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(KeywordRelationEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update KeywordRelation SET "+
			"KeywordID = @KeywordID,"+
			"GeneralID = @GeneralID"+
			" WHERE "+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(KeywordRelationEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update KeywordRelation SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update KeywordRelation SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public KeywordRelationEntity GetEntity(System.Int32 id)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<KeywordRelationEntity> GetEntityAsync(System.Int32 id)
		{
			string strCondition = string.Empty;
			strCondition += " and ID = @ID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual KeywordRelationEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			KeywordRelationEntity obj = null;
			string strSQL = "select top 1 * from KeywordRelation where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<KeywordRelationEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			KeywordRelationEntity obj = null;
			string strSQL = "select top 1 * from KeywordRelation where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<KeywordRelationEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<KeywordRelationEntity> list = new List<KeywordRelationEntity>();
			string strSQL = "select * from KeywordRelation where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<KeywordRelationEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<KeywordRelationEntity> list = new List<KeywordRelationEntity>();
			string strSQL = "select * from KeywordRelation where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from KeywordRelation where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<KeywordRelationEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<KeywordRelationEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<KeywordRelationEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(KeywordRelationEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("ID", entity.ID);
			dict.Add("KeywordID", entity.KeywordID);
		...
		/// <returns></returns>
		private static KeywordRelationEntity GetEntityFromrdr(NullableDataReader rdr)
		{
			KeywordRelationEntity info = new KeywordRelationEntity();
