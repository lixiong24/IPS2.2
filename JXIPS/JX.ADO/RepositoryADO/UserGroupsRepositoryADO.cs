...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class UserGroupsRepositoryADO : IUserGroupsRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public UserGroupsRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from UserGroups where 1=1 ";
		...
		{
			return _DB.GetMaxID("UserGroups", "GroupID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("UserGroups", "GroupID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(UserGroupsEntity entity)
		{
			if(entity.GroupID <= 0) entity.GroupID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into UserGroups ("+
							"GroupID,"+
							"GroupName,"+
							"Description,"+
							"Settings,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(UserGroupsEntity entity)
		{
			if(entity.GroupID <= 0) entity.GroupID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(UserGroupsEntity entity)
		{
			if(entity.GroupID <= 0) entity.GroupID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(UserGroupsEntity entity)
		{
			if(entity.GroupID <= 0) entity.GroupID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(UserGroupsEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(UserGroupsEntity entity, bool IsSave)
		{
		...
		{
			string strSQL = "delete from UserGroups where " +
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 groupID)
		{
			string strSQL = "delete from UserGroups where " +
		...
		{
			string strSQL = "delete from UserGroups where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(UserGroupsEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update UserGroups SET "+
			"GroupName = @GroupName,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(UserGroupsEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update UserGroups SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update UserGroups SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public UserGroupsEntity GetEntity(System.Int32 groupID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<UserGroupsEntity> GetEntityAsync(System.Int32 groupID)
		{
			string strCondition = string.Empty;
			strCondition += " and GroupID = @GroupID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual UserGroupsEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			UserGroupsEntity obj = null;
			string strSQL = "select top 1 * from UserGroups where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<UserGroupsEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			UserGroupsEntity obj = null;
			string strSQL = "select top 1 * from UserGroups where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<UserGroupsEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<UserGroupsEntity> list = new List<UserGroupsEntity>();
			string strSQL = "select * from UserGroups where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<UserGroupsEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<UserGroupsEntity> list = new List<UserGroupsEntity>();
			string strSQL = "select * from UserGroups where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from UserGroups where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<UserGroupsEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<UserGroupsEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<UserGroupsEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(UserGroupsEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("GroupID", entity.GroupID);
			dict.Add("GroupName", entity.GroupName);
			dict.Add("Description", entity.Description);
			dict.Add("Settings", entity.Settings);
			dict.Add("GroupType", entity.GroupType);
			dict.Add("GroupSetting", entity.GroupSetting);
			dict.Add("UpgradeSetting", entity.UpgradeSetting);
		}
		/// <summary>
		/// 通过数据读取器生成实体类
		/// </summary>
		...
		/// <returns></returns>
		private static UserGroupsEntity GetEntityFromrdr(NullableDataReader rdr)
		{
			UserGroupsEntity info = new UserGroupsEntity();
			info.GroupID = rdr.GetInt32("GroupID");
			info.GroupName = rdr.GetString("GroupName");
			info.Description = rdr.GetString("Description");
			info.Settings = rdr.GetString("Settings");
			info.GroupType = rdr.GetInt32("GroupType");
			info.GroupSetting = rdr.GetString("GroupSetting");
			info.UpgradeSetting = rdr.GetString("UpgradeSetting");
			return info;
		}
		#endregion
	}
