...
{
	/// <summary>
	/// 数据库表：FileRelationInfo 的仓储实现类.
	/// </summary>
	public partial class FileRelationInfoRepositoryADO : IFileRelationInfoRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public FileRelationInfoRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from FileRelationInfo where 1=1 ";
		...
		{
			return _DB.GetMaxID("FileRelationInfo", "ID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("FileRelationInfo", "ID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(FileRelationInfoEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(FileRelationInfoEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(FileRelationInfoEntity entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(FileRelationInfoEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(FileRelationInfoEntity entity, bool IsSave)
		{
		...
		{
			string strSQL = "delete from FileRelationInfo where " +
		...
		{
			string strSQL = "delete from FileRelationInfo where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(FileRelationInfoEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update FileRelationInfo SET "+
			"InfoID = @InfoID,"+
			"InfoType = @InfoType,"+
			"Path = @Path"+
			" WHERE "+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(FileRelationInfoEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update FileRelationInfo SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update FileRelationInfo SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public FileRelationInfoEntity GetEntity(System.Int32 id)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<FileRelationInfoEntity> GetEntityAsync(System.Int32 id)
		{
			string strCondition = string.Empty;
			strCondition += " and ID = @ID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual FileRelationInfoEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			FileRelationInfoEntity obj = null;
			string strSQL = "select top 1 * from FileRelationInfo where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<FileRelationInfoEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			FileRelationInfoEntity obj = null;
			string strSQL = "select top 1 * from FileRelationInfo where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<FileRelationInfoEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<FileRelationInfoEntity> list = new List<FileRelationInfoEntity>();
			string strSQL = "select * from FileRelationInfo where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<FileRelationInfoEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<FileRelationInfoEntity> list = new List<FileRelationInfoEntity>();
			string strSQL = "select * from FileRelationInfo where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from FileRelationInfo where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<FileRelationInfoEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<FileRelationInfoEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<FileRelationInfoEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(FileRelationInfoEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("ID", entity.ID);
			dict.Add("InfoID", entity.InfoID);
			dict.Add("InfoType", entity.InfoType);
		...
		/// <returns></returns>
		private static FileRelationInfoEntity GetEntityFromrdr(NullableDataReader rdr)
		{
			FileRelationInfoEntity info = new FileRelationInfoEntity();
			info.ID = rdr.GetInt32("ID");
			info.InfoID = rdr.GetInt32("InfoID");
			info.InfoType = rdr.GetInt32("InfoType");
