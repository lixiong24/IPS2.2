...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class U_ManufactureRepositoryADO : IU_ManufactureRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public U_ManufactureRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from U_Manufacture where 1=1 ";
		...
		{
			return _DB.GetMaxID("U_Manufacture", "ID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("U_Manufacture", "ID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(U_ManufactureEntity entity)
		{
			if(entity.ID <= 0) entity.ID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into U_Manufacture ("+
							"ID,"+
							"PCategory,"+
							"BuyAmount,"+
							"ConsultNumber,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(U_ManufactureEntity entity)
		{
			if(entity.ID <= 0) entity.ID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(U_ManufactureEntity entity)
		{
			if(entity.ID <= 0) entity.ID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(U_ManufactureEntity entity)
		{
			if(entity.ID <= 0) entity.ID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(U_ManufactureEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(U_ManufactureEntity entity, bool IsSave)
		{
		...
		{
			string strSQL = "delete from U_Manufacture where " +
		...
		{
			string strSQL = "delete from U_Manufacture where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(U_ManufactureEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update U_Manufacture SET "+
			"PCategory = @PCategory,"+
			"BuyAmount = @BuyAmount,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(U_ManufactureEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update U_Manufacture SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update U_Manufacture SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public U_ManufactureEntity GetEntity(System.Int32 id)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<U_ManufactureEntity> GetEntityAsync(System.Int32 id)
		{
			string strCondition = string.Empty;
			strCondition += " and ID = @ID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual U_ManufactureEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			U_ManufactureEntity obj = null;
			string strSQL = "select top 1 * from U_Manufacture where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<U_ManufactureEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			U_ManufactureEntity obj = null;
			string strSQL = "select top 1 * from U_Manufacture where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<U_ManufactureEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<U_ManufactureEntity> list = new List<U_ManufactureEntity>();
			string strSQL = "select * from U_Manufacture where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<U_ManufactureEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<U_ManufactureEntity> list = new List<U_ManufactureEntity>();
			string strSQL = "select * from U_Manufacture where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from U_Manufacture where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<U_ManufactureEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<U_ManufactureEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<U_ManufactureEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(U_ManufactureEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("ID", entity.ID);
			dict.Add("PCategory", entity.PCategory);
			dict.Add("BuyAmount", entity.BuyAmount);
			dict.Add("ConsultNumber", entity.ConsultNumber);
			dict.Add("ApplyType", entity.ApplyType);
			dict.Add("OENumber", entity.OENumber);
			dict.Add("AgoraType", entity.AgoraType);
			dict.Add("PeriodOfValidity", entity.PeriodOfValidity);
			dict.Add("SelfParameter", entity.SelfParameter);
			dict.Add("OrderInfo", entity.OrderInfo);
			dict.Add("PackExplain", entity.PackExplain);
		...
		/// <returns></returns>
		private static U_ManufactureEntity GetEntityFromrdr(NullableDataReader rdr)
		{
			U_ManufactureEntity info = new U_ManufactureEntity();
			info.ID = rdr.GetInt32("ID");
			info.PCategory = rdr.GetString("PCategory");
			info.BuyAmount = rdr.GetString("BuyAmount");
			info.ConsultNumber = rdr.GetString("ConsultNumber");
			info.ApplyType = rdr.GetString("ApplyType");
			info.OENumber = rdr.GetString("OENumber");
			info.AgoraType = rdr.GetString("AgoraType");
			info.PeriodOfValidity = rdr.GetString("PeriodOfValidity");
			info.SelfParameter = rdr.GetString("SelfParameter");
			info.OrderInfo = rdr.GetString("OrderInfo");
			info.PackExplain = rdr.GetString("PackExplain");
