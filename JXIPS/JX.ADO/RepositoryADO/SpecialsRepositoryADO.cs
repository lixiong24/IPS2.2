...
{
	/// <summary>
	/// 数据库表：Specials 的仓储实现类.
	/// </summary>
	public partial class SpecialsRepositoryADO : ISpecialsRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public SpecialsRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from Specials where 1=1 ";
		...
		{
			return _DB.GetMaxID("Specials", "SpecialID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("Specials", "SpecialID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(SpecialsEntity entity)
		{
			if(entity.SpecialID <= 0) entity.SpecialID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into Specials ("+
							"SpecialID,"+
							"SpecialName,"+
							"SpecialCategoryID,"+
							"SpecialDir,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(SpecialsEntity entity)
		{
			if(entity.SpecialID <= 0) entity.SpecialID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(SpecialsEntity entity)
		{
			if(entity.SpecialID <= 0) entity.SpecialID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
			...
			{
				return DataConverter.CLng(entity.SpecialID);
			}
			return -1;
		}
		/// <summary>
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(SpecialsEntity entity)
		{
			if(entity.SpecialID <= 0) entity.SpecialID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(SpecialsEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(SpecialsEntity entity, bool IsSave)
		{
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.Int32 specialID)
		{
			string strSQL = "delete from Specials where " +
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 specialID)
		{
			string strSQL = "delete from Specials where " +
		...
		{
			string strSQL = "delete from Specials where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(SpecialsEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update Specials SET "+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(SpecialsEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update Specials SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update Specials SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public SpecialsEntity GetEntity(System.Int32 specialID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<SpecialsEntity> GetEntityAsync(System.Int32 specialID)
		{
			string strCondition = string.Empty;
			strCondition += " and SpecialID = @SpecialID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual SpecialsEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			SpecialsEntity obj = null;
			string strSQL = "select top 1 * from Specials where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<SpecialsEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			SpecialsEntity obj = null;
			string strSQL = "select top 1 * from Specials where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<SpecialsEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<SpecialsEntity> list = new List<SpecialsEntity>();
			string strSQL = "select * from Specials where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<SpecialsEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<SpecialsEntity> list = new List<SpecialsEntity>();
			string strSQL = "select * from Specials where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from Specials where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<SpecialsEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<SpecialsEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<SpecialsEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(SpecialsEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("SpecialID", entity.SpecialID);
			dict.Add("SpecialName", entity.SpecialName);
			dict.Add("SpecialCategoryID", entity.SpecialCategoryID);
			dict.Add("SpecialDir", entity.SpecialDir);
			dict.Add("SpecialIdentifier", entity.SpecialIdentifier);
			dict.Add("SpecialPic", entity.SpecialPic);
			dict.Add("SpecialTips", entity.SpecialTips);
		...
		/// <returns></returns>
		private static SpecialsEntity GetEntityFromrdr(NullableDataReader rdr)
		{
			SpecialsEntity info = new SpecialsEntity();
