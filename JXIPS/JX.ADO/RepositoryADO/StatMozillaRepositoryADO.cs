...
{
	/// <summary>
	/// 数据库表：StatMozilla 的仓储实现类.
	/// </summary>
	public partial class StatMozillaRepositoryADO : IStatMozillaRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public StatMozillaRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from StatMozilla where 1=1 ";
		...
		{
			return _DB.GetMaxID("StatMozilla", "TMozilla");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("StatMozilla", "TMozilla"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(StatMozillaEntity entity)
		{
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into StatMozilla ("+
							"TMozilla,"+
							"TMozNum) "+
							"values("+
							"@TMozilla,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(StatMozillaEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(StatMozillaEntity entity)
		{
			...
			{
				return DataConverter.CLng(entity.TMozilla);
			}
			return -1;
		}
		/// <summary>
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(StatMozillaEntity entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(StatMozillaEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(StatMozillaEntity entity, bool IsSave)
		{
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.String tMozilla)
		{
			string strSQL = "delete from StatMozilla where " +
			
			"TMozilla = @TMozilla"; 
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			dict.Add("TMozilla", tMozilla);
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.String tMozilla)
		{
			string strSQL = "delete from StatMozilla where " +
		...
		{
			string strSQL = "delete from StatMozilla where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(StatMozillaEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update StatMozilla SET "+
			"TMozNum = @TMozNum"+
			" WHERE "+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(StatMozillaEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update StatMozilla SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update StatMozilla SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public StatMozillaEntity GetEntity(System.String tMozilla)
		{
			string strCondition = string.Empty;
			strCondition += " and TMozilla = @TMozilla";
		...
		/// </summary>
		/// <returns></returns>
		public async Task<StatMozillaEntity> GetEntityAsync(System.String tMozilla)
		{
			string strCondition = string.Empty;
			strCondition += " and TMozilla = @TMozilla";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual StatMozillaEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			StatMozillaEntity obj = null;
			string strSQL = "select top 1 * from StatMozilla where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<StatMozillaEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			StatMozillaEntity obj = null;
			string strSQL = "select top 1 * from StatMozilla where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<StatMozillaEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<StatMozillaEntity> list = new List<StatMozillaEntity>();
			string strSQL = "select * from StatMozilla where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<StatMozillaEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<StatMozillaEntity> list = new List<StatMozillaEntity>();
			string strSQL = "select * from StatMozilla where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from StatMozilla where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<StatMozillaEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatMozillaEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatMozillaEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(StatMozillaEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("TMozilla", entity.TMozilla);
			dict.Add("TMozNum", entity.TMozNum);
		}
		/// <summary>
		/// 通过数据读取器生成实体类
		/// </summary>
