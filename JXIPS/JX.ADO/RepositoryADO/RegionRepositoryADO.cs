...
namespace JX.ADO
{
	...
	/// 数据库表：Region 的仓储实现类.
	/// </summary>
	public partial class RegionRepositoryADO : IRegionRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public RegionRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from Region where 1=1 ";
		...
		{
			return _DB.GetMaxID("Region", "RegionID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("Region", "RegionID"));
		}
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(RegionEntity entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(RegionEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(RegionEntity entity, bool IsSave)
		{
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.Int32 regionID)
		{
			string strSQL = "delete from Region where " +
			
			"RegionID = @RegionID"; 
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			dict.Add("RegionID", regionID);
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 regionID)
		{
			string strSQL = "delete from Region where " +
		...
		{
			string strSQL = "delete from Region where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(RegionEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update Region SET "+
			"Country = @Country,"+
			"Province = @Province,"+
			"City = @City,"+
			"Area = @Area,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(RegionEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update Region SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update Region SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public RegionEntity GetEntity(System.Int32 regionID)
		{
			string strCondition = string.Empty;
			strCondition += " and RegionID = @RegionID";
		...
		/// </summary>
		/// <returns></returns>
		public async Task<RegionEntity> GetEntityAsync(System.Int32 regionID)
		{
			string strCondition = string.Empty;
			strCondition += " and RegionID = @RegionID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual RegionEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			RegionEntity obj = null;
			string strSQL = "select top 1 * from Region where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<RegionEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			RegionEntity obj = null;
			string strSQL = "select top 1 * from Region where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<RegionEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<RegionEntity> list = new List<RegionEntity>();
			string strSQL = "select * from Region where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<RegionEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<RegionEntity> list = new List<RegionEntity>();
			string strSQL = "select * from Region where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from Region where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<RegionEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<RegionEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<RegionEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <returns></returns>
		private static RegionEntity GetEntityFromrdr(NullableDataReader rdr)
		{
			RegionEntity info = new RegionEntity();
