...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class U_FriendSiteRepositoryADO : IU_FriendSiteRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public U_FriendSiteRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from U_FriendSite where 1=1 ";
		...
		{
			return _DB.GetMaxID("U_FriendSite", "ID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("U_FriendSite", "ID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(U_FriendSiteEntity entity)
		{
			if(entity.ID <= 0) entity.ID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into U_FriendSite ("+
							"ID,"+
							"SiteUrl,"+
							"SiteIntro,"+
							"SiteAdmin,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(U_FriendSiteEntity entity)
		{
			if(entity.ID <= 0) entity.ID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(U_FriendSiteEntity entity)
		{
			if(entity.ID <= 0) entity.ID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(U_FriendSiteEntity entity)
		{
			if(entity.ID <= 0) entity.ID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(U_FriendSiteEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(U_FriendSiteEntity entity, bool IsSave)
		{
		...
		{
			string strSQL = "delete from U_FriendSite where " +
		...
		{
			string strSQL = "delete from U_FriendSite where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(U_FriendSiteEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update U_FriendSite SET "+
			"SiteUrl = @SiteUrl,"+
			"SiteIntro = @SiteIntro,"+
			"SiteAdmin = @SiteAdmin,"+
			"SiteEmail = @SiteEmail,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(U_FriendSiteEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update U_FriendSite SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update U_FriendSite SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public U_FriendSiteEntity GetEntity(System.Int32 id)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<U_FriendSiteEntity> GetEntityAsync(System.Int32 id)
		{
			string strCondition = string.Empty;
			strCondition += " and ID = @ID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual U_FriendSiteEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			U_FriendSiteEntity obj = null;
			string strSQL = "select top 1 * from U_FriendSite where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<U_FriendSiteEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			U_FriendSiteEntity obj = null;
			string strSQL = "select top 1 * from U_FriendSite where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<U_FriendSiteEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<U_FriendSiteEntity> list = new List<U_FriendSiteEntity>();
			string strSQL = "select * from U_FriendSite where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<U_FriendSiteEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<U_FriendSiteEntity> list = new List<U_FriendSiteEntity>();
			string strSQL = "select * from U_FriendSite where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from U_FriendSite where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<U_FriendSiteEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<U_FriendSiteEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<U_FriendSiteEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(U_FriendSiteEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("ID", entity.ID);
			dict.Add("SiteUrl", entity.SiteUrl);
			dict.Add("SiteIntro", entity.SiteIntro);
			dict.Add("SiteAdmin", entity.SiteAdmin);
			dict.Add("SiteEmail", entity.SiteEmail);
			dict.Add("SitePassword", entity.SitePassword);
			dict.Add("ConfirmPassword", entity.ConfirmPassword);
		}
		/// <summary>
		/// 通过数据读取器生成实体类
		/// </summary>
		...
		/// <returns></returns>
		private static U_FriendSiteEntity GetEntityFromrdr(NullableDataReader rdr)
		{
			U_FriendSiteEntity info = new U_FriendSiteEntity();
			info.ID = rdr.GetInt32("ID");
			info.SiteUrl = rdr.GetString("SiteUrl");
			info.SiteIntro = rdr.GetString("SiteIntro");
			info.SiteAdmin = rdr.GetString("SiteAdmin");
			info.SiteEmail = rdr.GetString("SiteEmail");
			info.SitePassword = rdr.GetString("SitePassword");
			info.ConfirmPassword = rdr.GetString("ConfirmPassword");
			return info;
		}
		#endregion
	}
