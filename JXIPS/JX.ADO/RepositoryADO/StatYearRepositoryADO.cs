...
{
	/// <summary>
	/// 数据库表：StatYear 的仓储实现类.
	/// </summary>
	public partial class StatYearRepositoryADO : IStatYearRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public StatYearRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from StatYear where 1=1 ";
		...
		{
			return _DB.GetMaxID("StatYear", "TYear");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("StatYear", "TYear"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(StatYearEntity entity)
		{
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into StatYear ("+
							"D1,"+
							"D2,"+
							"D3,"+
							"D4,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(StatYearEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(StatYearEntity entity)
		{
			...
			{
				return DataConverter.CLng(entity.TYear);
			}
			return -1;
		}
		/// <summary>
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(StatYearEntity entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(StatYearEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(StatYearEntity entity, bool IsSave)
		{
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.String tYear)
		{
			string strSQL = "delete from StatYear where " +
			
			"TYear = @TYear"; 
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			dict.Add("TYear", tYear);
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.String tYear)
		{
			string strSQL = "delete from StatYear where " +
		...
		{
			string strSQL = "delete from StatYear where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(StatYearEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update StatYear SET "+
			"D1 = @D1,"+
			"D2 = @D2,"+
			"D3 = @D3,"+
			"D4 = @D4,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(StatYearEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update StatYear SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update StatYear SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public StatYearEntity GetEntity(System.String tYear)
		{
			string strCondition = string.Empty;
			strCondition += " and TYear = @TYear";
		...
		/// </summary>
		/// <returns></returns>
		public async Task<StatYearEntity> GetEntityAsync(System.String tYear)
		{
			string strCondition = string.Empty;
			strCondition += " and TYear = @TYear";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual StatYearEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			StatYearEntity obj = null;
			string strSQL = "select top 1 * from StatYear where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<StatYearEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			StatYearEntity obj = null;
			string strSQL = "select top 1 * from StatYear where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<StatYearEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<StatYearEntity> list = new List<StatYearEntity>();
			string strSQL = "select * from StatYear where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<StatYearEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<StatYearEntity> list = new List<StatYearEntity>();
			string strSQL = "select * from StatYear where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from StatYear where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<StatYearEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatYearEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatYearEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(StatYearEntity entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static StatYearEntity GetEntityFromrdr(NullableDataReader rdr)
		{
			StatYearEntity info = new StatYearEntity();
			...
			info.TYear = rdr.GetString("TYear");
			return info;
		}
		#endregion
	}
