...
namespace JX.ADO
{
	...
	/// 数据库表：AdZone 的仓储实现类.
	/// </summary>
	public partial class AdZoneRepositoryADO : IAdZoneRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public AdZoneRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from AdZone where 1=1 ";
		...
		{
			return _DB.GetMaxID("AdZone", "ZoneID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("AdZone", "ZoneID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(AdZoneEntity entity)
		{
			if(entity.ZoneID <= 0) entity.ZoneID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into AdZone ("+
							"ZoneID,"+
							"ZoneName,"+
							"ZoneJSName,"+
							"ZoneIntro,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(AdZoneEntity entity)
		{
			if(entity.ZoneID <= 0) entity.ZoneID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(AdZoneEntity entity)
		{
			if(entity.ZoneID <= 0) entity.ZoneID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(AdZoneEntity entity)
		{
			if(entity.ZoneID <= 0) entity.ZoneID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(AdZoneEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(AdZoneEntity entity, bool IsSave)
		{
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.Int32 zoneID)
		{
			string strSQL = "delete from AdZone where " +
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 zoneID)
		{
			string strSQL = "delete from AdZone where " +
		...
		{
			string strSQL = "delete from AdZone where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(AdZoneEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update AdZone SET "+
			"ZoneName = @ZoneName,"+
			"ZoneJSName = @ZoneJSName,"+
			"ZoneIntro = @ZoneIntro,"+
			"ZoneType = @ZoneType,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(AdZoneEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update AdZone SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update AdZone SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public AdZoneEntity GetEntity(System.Int32 zoneID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<AdZoneEntity> GetEntityAsync(System.Int32 zoneID)
		{
			string strCondition = string.Empty;
			strCondition += " and ZoneID = @ZoneID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual AdZoneEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			AdZoneEntity obj = null;
			string strSQL = "select top 1 * from AdZone where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<AdZoneEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			AdZoneEntity obj = null;
			string strSQL = "select top 1 * from AdZone where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<AdZoneEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<AdZoneEntity> list = new List<AdZoneEntity>();
			string strSQL = "select * from AdZone where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<AdZoneEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<AdZoneEntity> list = new List<AdZoneEntity>();
			string strSQL = "select * from AdZone where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from AdZone where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<AdZoneEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<AdZoneEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<AdZoneEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(AdZoneEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("ZoneID", entity.ZoneID);
			dict.Add("ZoneName", entity.ZoneName);
			dict.Add("ZoneJSName", entity.ZoneJSName);
			dict.Add("ZoneIntro", entity.ZoneIntro);
			dict.Add("ZoneType", entity.ZoneType);
			dict.Add("IsDefaultSetting", entity.IsDefaultSetting);
			dict.Add("ZoneSetting", entity.ZoneSetting);
			dict.Add("ZoneWidth", entity.ZoneWidth);
			dict.Add("ZoneHeight", entity.ZoneHeight);
			dict.Add("IsActive", entity.IsActive);
