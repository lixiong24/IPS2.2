...
namespace JX.ADO
{
	...
	/// 数据库表：Present 的仓储实现类.
	/// </summary>
	public partial class PresentRepositoryADO : IPresentRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public PresentRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from Present where 1=1 ";
		...
		{
			return _DB.GetMaxID("Present", "PresentID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("Present", "PresentID"));
		}
		...
		{
			if(entity.PresentID <= 0) entity.PresentID=GetNewID();
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(PresentEntity entity)
		{
			if(entity.PresentID <= 0) entity.PresentID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(PresentEntity entity)
		{
			if(entity.PresentID <= 0) entity.PresentID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.Int32 presentID)
		{
			string strSQL = "delete from Present where " +
			
			"PresentID = @PresentID"; 
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			dict.Add("PresentID", presentID);
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 presentID)
		{
			string strSQL = "delete from Present where " +
		...
		{
			string strSQL = "delete from Present where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(PresentEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update Present SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public PresentEntity GetEntity(System.Int32 presentID)
		{
			string strCondition = string.Empty;
			strCondition += " and PresentID = @PresentID";
		...
		/// </summary>
		/// <returns></returns>
		public async Task<PresentEntity> GetEntityAsync(System.Int32 presentID)
		{
			string strCondition = string.Empty;
			strCondition += " and PresentID = @PresentID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<PresentEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<PresentEntity> list = new List<PresentEntity>();
			string strSQL = "select * from Present where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<PresentEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<PresentEntity> list = new List<PresentEntity>();
			string strSQL = "select * from Present where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from Present where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<PresentEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<PresentEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<PresentEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
