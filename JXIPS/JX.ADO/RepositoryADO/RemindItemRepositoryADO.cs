...
{
	/// <summary>
	/// 数据库表：RemindItem 的仓储实现类.
	/// </summary>
	public partial class RemindItemRepositoryADO : IRemindItemRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public RemindItemRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from RemindItem where 1=1 ";
		...
		{
			return _DB.GetMaxID("RemindItem", "RemindID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("RemindItem", "RemindID"));
		}
		...
		{
			if(entity.RemindID <= 0) entity.RemindID=GetNewID();
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(RemindItemEntity entity)
		{
			if(entity.RemindID <= 0) entity.RemindID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(RemindItemEntity entity)
		{
			if(entity.RemindID <= 0) entity.RemindID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.Int32 remindID)
		{
			string strSQL = "delete from RemindItem where " +
			
			"RemindID = @RemindID"; 
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			dict.Add("RemindID", remindID);
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 remindID)
		{
			string strSQL = "delete from RemindItem where " +
		...
		{
			string strSQL = "delete from RemindItem where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(RemindItemEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update RemindItem SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public RemindItemEntity GetEntity(System.Int32 remindID)
		{
			string strCondition = string.Empty;
			strCondition += " and RemindID = @RemindID";
		...
		/// </summary>
		/// <returns></returns>
		public async Task<RemindItemEntity> GetEntityAsync(System.Int32 remindID)
		{
			string strCondition = string.Empty;
			strCondition += " and RemindID = @RemindID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual RemindItemEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<RemindItemEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<RemindItemEntity> list = new List<RemindItemEntity>();
			string strSQL = "select * from RemindItem where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<RemindItemEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<RemindItemEntity> list = new List<RemindItemEntity>();
			string strSQL = "select * from RemindItem where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from RemindItem where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<RemindItemEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<RemindItemEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<RemindItemEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
