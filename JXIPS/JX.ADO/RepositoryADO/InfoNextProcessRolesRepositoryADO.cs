...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class InfoNextProcessRolesRepositoryADO : IInfoNextProcessRolesRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public InfoNextProcessRolesRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from InfoNextProcessRoles where 1=1 ";
		...
		{
			return _DB.GetMaxID("InfoNextProcessRoles", "GeneralID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("InfoNextProcessRoles", "GeneralID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(InfoNextProcessRolesEntity entity)
		{
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into InfoNextProcessRoles ("+
							"GeneralID,"+
							"RoleID) "+
							"values("+
							"@GeneralID,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(InfoNextProcessRolesEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(InfoNextProcessRolesEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(InfoNextProcessRolesEntity entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(InfoNextProcessRolesEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(InfoNextProcessRolesEntity entity, bool IsSave)
		{
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.Int32 generalID, System.Int32 roleID)
		{
			string strSQL = "delete from InfoNextProcessRoles where " +
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 generalID, System.Int32 roleID)
		{
			string strSQL = "delete from InfoNextProcessRoles where " +
		...
		{
			string strSQL = "delete from InfoNextProcessRoles where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(InfoNextProcessRolesEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update InfoNextProcessRoles SET "+
			" WHERE "+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(InfoNextProcessRolesEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update InfoNextProcessRoles SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update InfoNextProcessRoles SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public InfoNextProcessRolesEntity GetEntity(System.Int32 generalID, System.Int32 roleID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<InfoNextProcessRolesEntity> GetEntityAsync(System.Int32 generalID, System.Int32 roleID)
		{
			string strCondition = string.Empty;
			strCondition += " and GeneralID = @GeneralID";
			strCondition += " and RoleID = @RoleID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual InfoNextProcessRolesEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			InfoNextProcessRolesEntity obj = null;
			string strSQL = "select top 1 * from InfoNextProcessRoles where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<InfoNextProcessRolesEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			InfoNextProcessRolesEntity obj = null;
			string strSQL = "select top 1 * from InfoNextProcessRoles where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<InfoNextProcessRolesEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<InfoNextProcessRolesEntity> list = new List<InfoNextProcessRolesEntity>();
			string strSQL = "select * from InfoNextProcessRoles where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<InfoNextProcessRolesEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<InfoNextProcessRolesEntity> list = new List<InfoNextProcessRolesEntity>();
			string strSQL = "select * from InfoNextProcessRoles where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from InfoNextProcessRoles where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<InfoNextProcessRolesEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		public virtual IList<InfoNextProcessRolesEntity> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			...
			{
				TableName = "InfoNextProcessRoles";
			}
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<InfoNextProcessRolesEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<InfoNextProcessRolesEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(InfoNextProcessRolesEntity entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static InfoNextProcessRolesEntity GetEntityFromrdr(NullableDataReader rdr)
		{
			InfoNextProcessRolesEntity info = new InfoNextProcessRolesEntity();
