...
namespace JX.ADO
{
	...
	/// 数据库表：Coupon 的仓储实现类.
	/// </summary>
	public partial class CouponRepositoryADO : ICouponRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public CouponRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from Coupon where 1=1 ";
		...
		{
			return _DB.GetMaxID("Coupon", "CouponID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("Coupon", "CouponID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(CouponEntity entity)
		{
			if(entity.CouponID <= 0) entity.CouponID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into Coupon ("+
							"CouponID,"+
							"CouponName,"+
							"CouponNumPattern,"+
							"Money,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(CouponEntity entity)
		{
			if(entity.CouponID <= 0) entity.CouponID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(CouponEntity entity)
		{
			if(entity.CouponID <= 0) entity.CouponID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
			...
			{
				return DataConverter.CLng(entity.CouponID);
			}
			return -1;
		}
		/// <summary>
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(CouponEntity entity)
		{
			if(entity.CouponID <= 0) entity.CouponID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(CouponEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(CouponEntity entity, bool IsSave)
		{
		...
		{
			string strSQL = "delete from Coupon where " +
			
			"CouponID = @CouponID"; 
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			dict.Add("CouponID", couponID);
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 couponID)
		{
			string strSQL = "delete from Coupon where " +
		...
		{
			string strSQL = "delete from Coupon where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(CouponEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update Coupon SET "+
			"CouponName = @CouponName,"+
			"CouponNumPattern = @CouponNumPattern,"+
			"Money = @Money,"+
			"State = @State,"+
			"UserGroup = @UserGroup,"+
			"BeginDate = @BeginDate,"+
			...
			"ProductLimitContent = @ProductLimitContent,"+
			"CouponCreateType = @CouponCreateType,"+
			"CouponCreateContent = @CouponCreateContent,"+
			"OrderTotalMoney = @OrderTotalMoney,"+
			"UseBeginDate = @UseBeginDate,"+
			"UseEndDate = @UseEndDate,"+
			"CouponItemNum = @CouponItemNum"+
			" WHERE "+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(CouponEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update Coupon SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update Coupon SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public CouponEntity GetEntity(System.Int32 couponID)
		{
			string strCondition = string.Empty;
			strCondition += " and CouponID = @CouponID";
		...
		/// </summary>
		/// <returns></returns>
		public async Task<CouponEntity> GetEntityAsync(System.Int32 couponID)
		{
			string strCondition = string.Empty;
			strCondition += " and CouponID = @CouponID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual CouponEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			CouponEntity obj = null;
			string strSQL = "select top 1 * from Coupon where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<CouponEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			CouponEntity obj = null;
			string strSQL = "select top 1 * from Coupon where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<CouponEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<CouponEntity> list = new List<CouponEntity>();
			string strSQL = "select * from Coupon where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<CouponEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<CouponEntity> list = new List<CouponEntity>();
			string strSQL = "select * from Coupon where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from Coupon where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<CouponEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CouponEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CouponEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(CouponEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("CouponID", entity.CouponID);
			dict.Add("CouponName", entity.CouponName);
			dict.Add("CouponNumPattern", entity.CouponNumPattern);
			dict.Add("Money", entity.Money);
			dict.Add("State", entity.State);
			dict.Add("UserGroup", entity.UserGroup);
			dict.Add("BeginDate", entity.BeginDate);
			dict.Add("EndDate", entity.EndDate);
			dict.Add("LimitNum", entity.LimitNum);
			dict.Add("ProductLimitType", entity.ProductLimitType);
			dict.Add("ProductLimitContent", entity.ProductLimitContent);
			dict.Add("CouponCreateType", entity.CouponCreateType);
			dict.Add("CouponCreateContent", entity.CouponCreateContent);
			dict.Add("OrderTotalMoney", entity.OrderTotalMoney);
			dict.Add("UseBeginDate", entity.UseBeginDate);
			dict.Add("UseEndDate", entity.UseEndDate);
			dict.Add("CouponItemNum", entity.CouponItemNum);
		}
		/// <summary>
		/// 通过数据读取器生成实体类
		/// </summary>
