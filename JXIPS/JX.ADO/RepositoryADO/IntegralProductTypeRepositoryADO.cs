...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class IntegralProductTypeRepositoryADO : IIntegralProductTypeRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public IntegralProductTypeRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from IntegralProductType where 1=1 ";
		...
		{
			return _DB.GetMaxID("IntegralProductType", "TypeID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("IntegralProductType", "TypeID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(IntegralProductTypeEntity entity)
		{
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into IntegralProductType ("+
							"TypeName,"+
							"Keyword,"+
							"Description,"+
							"EliteLevel,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(IntegralProductTypeEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(IntegralProductTypeEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(IntegralProductTypeEntity entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(IntegralProductTypeEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(IntegralProductTypeEntity entity, bool IsSave)
		{
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.Int32 typeID)
		{
			string strSQL = "delete from IntegralProductType where " +
			
			"TypeID = @TypeID"; 
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			dict.Add("TypeID", typeID);
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 typeID)
		{
			string strSQL = "delete from IntegralProductType where " +
		...
		{
			string strSQL = "delete from IntegralProductType where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(IntegralProductTypeEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update IntegralProductType SET "+
			"TypeName = @TypeName,"+
			"Keyword = @Keyword,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(IntegralProductTypeEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update IntegralProductType SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update IntegralProductType SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public IntegralProductTypeEntity GetEntity(System.Int32 typeID)
		{
			string strCondition = string.Empty;
			strCondition += " and TypeID = @TypeID";
		...
		/// </summary>
		/// <returns></returns>
		public async Task<IntegralProductTypeEntity> GetEntityAsync(System.Int32 typeID)
		{
			string strCondition = string.Empty;
			strCondition += " and TypeID = @TypeID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IntegralProductTypeEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			IntegralProductTypeEntity obj = null;
			string strSQL = "select top 1 * from IntegralProductType where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IntegralProductTypeEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			IntegralProductTypeEntity obj = null;
			string strSQL = "select top 1 * from IntegralProductType where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<IntegralProductTypeEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<IntegralProductTypeEntity> list = new List<IntegralProductTypeEntity>();
			string strSQL = "select * from IntegralProductType where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<IntegralProductTypeEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<IntegralProductTypeEntity> list = new List<IntegralProductTypeEntity>();
			string strSQL = "select * from IntegralProductType where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from IntegralProductType where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<IntegralProductTypeEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<IntegralProductTypeEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<IntegralProductTypeEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(IntegralProductTypeEntity entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static IntegralProductTypeEntity GetEntityFromrdr(NullableDataReader rdr)
		{
			IntegralProductTypeEntity info = new IntegralProductTypeEntity();
