...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class StatWeekRepositoryADO : IStatWeekRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public StatWeekRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from StatWeek where 1=1 ";
		...
		{
			return _DB.GetMaxID("StatWeek", "TWeek");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("StatWeek", "TWeek"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(StatWeekEntity entity)
		{
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into StatWeek ("+
							"D1,"+
							"D2,"+
							"D3,"+
							"D4,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(StatWeekEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(StatWeekEntity entity)
		{
			...
			{
				return DataConverter.CLng(entity.TWeek);
			}
			return -1;
		}
		/// <summary>
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(StatWeekEntity entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(StatWeekEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(StatWeekEntity entity, bool IsSave)
		{
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.String tWeek)
		{
			string strSQL = "delete from StatWeek where " +
			
			"TWeek = @TWeek"; 
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			dict.Add("TWeek", tWeek);
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.String tWeek)
		{
			string strSQL = "delete from StatWeek where " +
		...
		{
			string strSQL = "delete from StatWeek where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(StatWeekEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update StatWeek SET "+
			"D1 = @D1,"+
			"D2 = @D2,"+
			"D3 = @D3,"+
			"D4 = @D4,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(StatWeekEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update StatWeek SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update StatWeek SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public StatWeekEntity GetEntity(System.String tWeek)
		{
			string strCondition = string.Empty;
			strCondition += " and TWeek = @TWeek";
		...
		/// </summary>
		/// <returns></returns>
		public async Task<StatWeekEntity> GetEntityAsync(System.String tWeek)
		{
			string strCondition = string.Empty;
			strCondition += " and TWeek = @TWeek";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual StatWeekEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			StatWeekEntity obj = null;
			string strSQL = "select top 1 * from StatWeek where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<StatWeekEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			StatWeekEntity obj = null;
			string strSQL = "select top 1 * from StatWeek where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<StatWeekEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<StatWeekEntity> list = new List<StatWeekEntity>();
			string strSQL = "select * from StatWeek where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<StatWeekEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<StatWeekEntity> list = new List<StatWeekEntity>();
			string strSQL = "select * from StatWeek where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from StatWeek where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<StatWeekEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatWeekEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatWeekEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(StatWeekEntity entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static StatWeekEntity GetEntityFromrdr(NullableDataReader rdr)
		{
			StatWeekEntity info = new StatWeekEntity();
			...
			info.TWeek = rdr.GetString("TWeek");
			return info;
		}
		#endregion
	}
