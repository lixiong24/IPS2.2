...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class SigninContentRepositoryADO : ISigninContentRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public SigninContentRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from SigninContent where 1=1 ";
		...
		{
			return _DB.GetMaxID("SigninContent", "GeneralID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("SigninContent", "GeneralID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(SigninContentEntity entity)
		{
			if(entity.GeneralID <= 0) entity.GeneralID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into SigninContent ("+
							"GeneralID,"+
							"Title,"+
							"SigninType,"+
							"Priority,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(SigninContentEntity entity)
		{
			if(entity.GeneralID <= 0) entity.GeneralID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(SigninContentEntity entity)
		{
			if(entity.GeneralID <= 0) entity.GeneralID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(SigninContentEntity entity)
		{
			if(entity.GeneralID <= 0) entity.GeneralID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(SigninContentEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(SigninContentEntity entity, bool IsSave)
		{
		...
		{
			string strSQL = "delete from SigninContent where " +
		...
		{
			string strSQL = "delete from SigninContent where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(SigninContentEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update SigninContent SET "+
			"Title = @Title,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(SigninContentEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update SigninContent SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update SigninContent SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public SigninContentEntity GetEntity(System.Int32 generalID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<SigninContentEntity> GetEntityAsync(System.Int32 generalID)
		{
			string strCondition = string.Empty;
			strCondition += " and GeneralID = @GeneralID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual SigninContentEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			SigninContentEntity obj = null;
			string strSQL = "select top 1 * from SigninContent where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<SigninContentEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			SigninContentEntity obj = null;
			string strSQL = "select top 1 * from SigninContent where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<SigninContentEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<SigninContentEntity> list = new List<SigninContentEntity>();
			string strSQL = "select * from SigninContent where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<SigninContentEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<SigninContentEntity> list = new List<SigninContentEntity>();
			string strSQL = "select * from SigninContent where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from SigninContent where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<SigninContentEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<SigninContentEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<SigninContentEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(SigninContentEntity entity, Dictionary<string, object> dict)
		{
