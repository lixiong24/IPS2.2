...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class SiteLinkRepositoryADO : ISiteLinkRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		{
			string strSQL = "select " + statistic + " from SiteLink where 1=1 ";
		...
		{
			return _DB.GetMaxID("SiteLink", "InsideLinkID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("SiteLink", "InsideLinkID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(SiteLinkEntity entity)
		{
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into SiteLink ("+
							"Source,"+
							"ReplaceUrl,"+
							"Priority,"+
							"ReplaceTimes,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(SiteLinkEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(SiteLinkEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(SiteLinkEntity entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(SiteLinkEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(SiteLinkEntity entity, bool IsSave)
		{
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.Int32 insideLinkID)
		{
			string strSQL = "delete from SiteLink where " +
			
			"InsideLinkID = @InsideLinkID"; 
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			dict.Add("InsideLinkID", insideLinkID);
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 insideLinkID)
		{
			string strSQL = "delete from SiteLink where " +
		...
		{
			string strSQL = "delete from SiteLink where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(SiteLinkEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update SiteLink SET "+
			"Source = @Source,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(SiteLinkEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update SiteLink SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update SiteLink SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public SiteLinkEntity GetEntity(System.Int32 insideLinkID)
		{
			string strCondition = string.Empty;
			strCondition += " and InsideLinkID = @InsideLinkID";
		...
		/// </summary>
		/// <returns></returns>
		public async Task<SiteLinkEntity> GetEntityAsync(System.Int32 insideLinkID)
		{
			string strCondition = string.Empty;
			strCondition += " and InsideLinkID = @InsideLinkID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual SiteLinkEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			SiteLinkEntity obj = null;
			string strSQL = "select top 1 * from SiteLink where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<SiteLinkEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			SiteLinkEntity obj = null;
			string strSQL = "select top 1 * from SiteLink where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<SiteLinkEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<SiteLinkEntity> list = new List<SiteLinkEntity>();
			string strSQL = "select * from SiteLink where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<SiteLinkEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<SiteLinkEntity> list = new List<SiteLinkEntity>();
			string strSQL = "select * from SiteLink where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from SiteLink where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<SiteLinkEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<SiteLinkEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<SiteLinkEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(SiteLinkEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("InsideLinkID", entity.InsideLinkID);
			dict.Add("Source", entity.Source);
			dict.Add("ReplaceUrl", entity.ReplaceUrl);
