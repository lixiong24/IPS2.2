...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class ClientLogRepositoryADO : IClientLogRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		{
			string strSQL = "select " + statistic + " from ClientLog where 1=1 ";
		...
		{
			return _DB.GetMaxID("ClientLog", "ClientLogID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("ClientLog", "ClientLogID"));
		}
		...
		{
			if(entity.ClientLogID <= 0) entity.ClientLogID=GetNewID();
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(ClientLogEntity entity)
		{
			if(entity.ClientLogID <= 0) entity.ClientLogID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(ClientLogEntity entity)
		{
			if(entity.ClientLogID <= 0) entity.ClientLogID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.Int32 clientLogID)
		{
			string strSQL = "delete from ClientLog where " +
			
			"ClientLogID = @ClientLogID"; 
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			dict.Add("ClientLogID", clientLogID);
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 clientLogID)
		{
			string strSQL = "delete from ClientLog where " +
		...
		{
			string strSQL = "delete from ClientLog where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(ClientLogEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update ClientLog SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public ClientLogEntity GetEntity(System.Int32 clientLogID)
		{
			string strCondition = string.Empty;
			strCondition += " and ClientLogID = @ClientLogID";
		...
		/// </summary>
		/// <returns></returns>
		public async Task<ClientLogEntity> GetEntityAsync(System.Int32 clientLogID)
		{
			string strCondition = string.Empty;
			strCondition += " and ClientLogID = @ClientLogID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual ClientLogEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<ClientLogEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<ClientLogEntity> list = new List<ClientLogEntity>();
			string strSQL = "select * from ClientLog where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<ClientLogEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<ClientLogEntity> list = new List<ClientLogEntity>();
			string strSQL = "select * from ClientLog where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from ClientLog where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<ClientLogEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ClientLogEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ClientLogEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
