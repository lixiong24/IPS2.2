...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class DownloadErrorLogRepositoryADO : IDownloadErrorLogRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		{
			string strSQL = "select " + statistic + " from DownloadErrorLog where 1=1 ";
		...
		{
			return _DB.GetMaxID("DownloadErrorLog", "ErrorID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("DownloadErrorLog", "ErrorID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(DownloadErrorLogEntity entity)
		{
			if(entity.ErrorID <= 0) entity.ErrorID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into DownloadErrorLog ("+
							"ErrorID,"+
							"InfoID,"+
							"ErrorUrl,"+
							"ErrorTimes,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(DownloadErrorLogEntity entity)
		{
			if(entity.ErrorID <= 0) entity.ErrorID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(DownloadErrorLogEntity entity)
		{
			if(entity.ErrorID <= 0) entity.ErrorID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
			...
			{
				return DataConverter.CLng(entity.ErrorID);
			}
			return -1;
		}
		/// <summary>
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(DownloadErrorLogEntity entity)
		{
			if(entity.ErrorID <= 0) entity.ErrorID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(DownloadErrorLogEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(DownloadErrorLogEntity entity, bool IsSave)
		{
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.Int32 errorID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 errorID)
		{
			string strSQL = "delete from DownloadErrorLog where " +
		...
		{
			string strSQL = "delete from DownloadErrorLog where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(DownloadErrorLogEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update DownloadErrorLog SET "+
			"InfoID = @InfoID,"+
			"ErrorUrl = @ErrorUrl,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(DownloadErrorLogEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update DownloadErrorLog SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update DownloadErrorLog SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public DownloadErrorLogEntity GetEntity(System.Int32 errorID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<DownloadErrorLogEntity> GetEntityAsync(System.Int32 errorID)
		{
			string strCondition = string.Empty;
			strCondition += " and ErrorID = @ErrorID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual DownloadErrorLogEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			DownloadErrorLogEntity obj = null;
			string strSQL = "select top 1 * from DownloadErrorLog where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<DownloadErrorLogEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			DownloadErrorLogEntity obj = null;
			string strSQL = "select top 1 * from DownloadErrorLog where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<DownloadErrorLogEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<DownloadErrorLogEntity> list = new List<DownloadErrorLogEntity>();
			string strSQL = "select * from DownloadErrorLog where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<DownloadErrorLogEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<DownloadErrorLogEntity> list = new List<DownloadErrorLogEntity>();
			string strSQL = "select * from DownloadErrorLog where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from DownloadErrorLog where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<DownloadErrorLogEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<DownloadErrorLogEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<DownloadErrorLogEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(DownloadErrorLogEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("ErrorID", entity.ErrorID);
			dict.Add("InfoID", entity.InfoID);
			dict.Add("ErrorUrl", entity.ErrorUrl);
			dict.Add("ErrorTimes", entity.ErrorTimes);
			dict.Add("ErrorDate", entity.ErrorDate);
		}
		/// <summary>
		/// 通过数据读取器生成实体类
		/// </summary>
		...
		/// <returns></returns>
		private static DownloadErrorLogEntity GetEntityFromrdr(NullableDataReader rdr)
		{
			DownloadErrorLogEntity info = new DownloadErrorLogEntity();
			...
			info.ErrorDate = rdr.GetNullableDateTime("ErrorDate");
			return info;
		}
		#endregion
	}
