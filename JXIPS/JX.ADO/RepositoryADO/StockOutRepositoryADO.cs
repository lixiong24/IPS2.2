...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class StockOutRepositoryADO : IStockOutRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public StockOutRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from StockOut where 1=1 ";
		...
		{
			return _DB.GetMaxID("StockOut", "ID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("StockOut", "ID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(StockOutEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(StockOutEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(StockOutEntity entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(StockOutEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(StockOutEntity entity, bool IsSave)
		{
		...
		{
			string strSQL = "delete from StockOut where " +
		...
		{
			string strSQL = "delete from StockOut where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(StockOutEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update StockOut SET "+
			"Email = @Email,"+
			"UserId = @UserId,"+
			"Mobile = @Mobile,"+
			"ProductId = @ProductId,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(StockOutEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update StockOut SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update StockOut SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public StockOutEntity GetEntity(System.Int32 id)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<StockOutEntity> GetEntityAsync(System.Int32 id)
		{
			string strCondition = string.Empty;
			strCondition += " and ID = @ID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual StockOutEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			StockOutEntity obj = null;
			string strSQL = "select top 1 * from StockOut where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<StockOutEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			StockOutEntity obj = null;
			string strSQL = "select top 1 * from StockOut where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<StockOutEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<StockOutEntity> list = new List<StockOutEntity>();
			string strSQL = "select * from StockOut where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<StockOutEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<StockOutEntity> list = new List<StockOutEntity>();
			string strSQL = "select * from StockOut where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from StockOut where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<StockOutEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StockOutEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StockOutEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(StockOutEntity entity, Dictionary<string, object> dict)
		{
			...
			dict.Add("EmailStatus", entity.EmailStatus);
			dict.Add("MobileStatus", entity.MobileStatus);
