...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class FavoriteRepositoryADO : IFavoriteRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public FavoriteRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from Favorite where 1=1 ";
		...
		{
			return _DB.GetMaxID("Favorite", "FavoriteID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("Favorite", "FavoriteID"));
		}
		...
		{
			if(entity.FavoriteID <= 0) entity.FavoriteID=GetNewID();
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(FavoriteEntity entity)
		{
			if(entity.FavoriteID <= 0) entity.FavoriteID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(FavoriteEntity entity)
		{
			if(entity.FavoriteID <= 0) entity.FavoriteID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.Int32 favoriteID)
		{
			string strSQL = "delete from Favorite where " +
			
			"FavoriteID = @FavoriteID"; 
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			dict.Add("FavoriteID", favoriteID);
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 favoriteID)
		{
			string strSQL = "delete from Favorite where " +
		...
		{
			string strSQL = "delete from Favorite where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update Favorite SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public FavoriteEntity GetEntity(System.Int32 favoriteID)
		{
			string strCondition = string.Empty;
			strCondition += " and FavoriteID = @FavoriteID";
		...
		/// </summary>
		/// <returns></returns>
		public async Task<FavoriteEntity> GetEntityAsync(System.Int32 favoriteID)
		{
			string strCondition = string.Empty;
			strCondition += " and FavoriteID = @FavoriteID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual FavoriteEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<FavoriteEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<FavoriteEntity> list = new List<FavoriteEntity>();
			string strSQL = "select * from Favorite where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<FavoriteEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<FavoriteEntity> list = new List<FavoriteEntity>();
			string strSQL = "select * from Favorite where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from Favorite where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<FavoriteEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<FavoriteEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<FavoriteEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
