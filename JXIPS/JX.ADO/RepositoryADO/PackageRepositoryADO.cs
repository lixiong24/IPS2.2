...
namespace JX.ADO
{
	...
	/// 数据库表：Package 的仓储实现类.
	/// </summary>
	public partial class PackageRepositoryADO : IPackageRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public PackageRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from Package where 1=1 ";
		...
		{
			return _DB.GetMaxID("Package", "PackageID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("Package", "PackageID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(PackageEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(PackageEntity entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(PackageEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(PackageEntity entity, bool IsSave)
		{
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.Int32 packageID)
		{
			string strSQL = "delete from Package where " +
			
			"PackageID = @PackageID"; 
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			dict.Add("PackageID", packageID);
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 packageID)
		{
			string strSQL = "delete from Package where " +
		...
		{
			string strSQL = "delete from Package where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(PackageEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update Package SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public PackageEntity GetEntity(System.Int32 packageID)
		{
			string strCondition = string.Empty;
			strCondition += " and PackageID = @PackageID";
		...
		/// </summary>
		/// <returns></returns>
		public async Task<PackageEntity> GetEntityAsync(System.Int32 packageID)
		{
			string strCondition = string.Empty;
			strCondition += " and PackageID = @PackageID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual PackageEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<PackageEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<PackageEntity> list = new List<PackageEntity>();
			string strSQL = "select * from Package where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<PackageEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<PackageEntity> list = new List<PackageEntity>();
			string strSQL = "select * from Package where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from Package where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<PackageEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<PackageEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<PackageEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(PackageEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("PackageID", entity.PackageID);
			dict.Add("PackageName", entity.PackageName);
			dict.Add("PackageWeight", entity.PackageWeight);
			dict.Add("GoodsWeightMin", entity.GoodsWeightMin);
			dict.Add("GoodsWeightMax", entity.GoodsWeightMax);
		}
		/// <summary>
		/// 通过数据读取器生成实体类
		/// </summary>
		...
		/// <returns></returns>
		private static PackageEntity GetEntityFromrdr(NullableDataReader rdr)
		{
			PackageEntity info = new PackageEntity();
