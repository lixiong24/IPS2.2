...
namespace JX.ADO
{
	...
	/// 数据库表：Clerk 的仓储实现类.
	/// </summary>
	public partial class ClerkRepositoryADO : IClerkRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		{
			string strSQL = "select " + statistic + " from Clerk where 1=1 ";
		...
		{
			return await Task.Run(() => _DB.GetMaxID("Clerk", "ID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(ClerkEntity entity)
		{
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into Clerk ("+
							"ClerkType,"+
							"ClerkName,"+
							"EntryTime,"+
							"ClerkEmail,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(ClerkEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(ClerkEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(ClerkEntity entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(ClerkEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(ClerkEntity entity, bool IsSave)
		{
		...
		{
			string strSQL = "delete from Clerk where " +
		...
		{
			string strSQL = "delete from Clerk where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(ClerkEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update Clerk SET "+
			"ClerkType = @ClerkType,"+
			"ClerkName = @ClerkName,"+
			"EntryTime = @EntryTime,"+
			...
			"ClerkWX = @ClerkWX,"+
			"ClerkQQ = @ClerkQQ,"+
			"ClerkIDCard = @ClerkIDCard,"+
			"ClerkIDCardPic = @ClerkIDCardPic,"+
			"ClerkPic = @ClerkPic,"+
			"ClerkBankBranch = @ClerkBankBranch,"+
			"ClerkAccountName = @ClerkAccountName,"+
			"ClerkBankAccount = @ClerkBankAccount,"+
			"ClerkBankPic = @ClerkBankPic,"+
			"ClerkStatus = @ClerkStatus,"+
			"Linkman = @Linkman,"+
			"LinkmanTel = @LinkmanTel,"+
			"LinkmanClose = @LinkmanClose,"+
			"StoreID = @StoreID,"+
			"LoginPwd = @LoginPwd,"+
			"LoginTime = @LoginTime,"+
			"LoginIP = @LoginIP,"+
			...
			"RemarkPic1 = @RemarkPic1,"+
			"RemarkPic2 = @RemarkPic2,"+
			"RemarkPic3 = @RemarkPic3"+
			" WHERE "+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(ClerkEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update Clerk SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update Clerk SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public ClerkEntity GetEntity(System.Int32 id)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<ClerkEntity> GetEntityAsync(System.Int32 id)
		{
			string strCondition = string.Empty;
			strCondition += " and ID = @ID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual ClerkEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			ClerkEntity obj = null;
			string strSQL = "select top 1 * from Clerk where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<ClerkEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			ClerkEntity obj = null;
			string strSQL = "select top 1 * from Clerk where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<ClerkEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<ClerkEntity> list = new List<ClerkEntity>();
			string strSQL = "select * from Clerk where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<ClerkEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<ClerkEntity> list = new List<ClerkEntity>();
			string strSQL = "select * from Clerk where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from Clerk where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<ClerkEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ClerkEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ClerkEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(ClerkEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("ID", entity.ID);
			dict.Add("ClerkType", entity.ClerkType);
			dict.Add("ClerkName", entity.ClerkName);
			dict.Add("EntryTime", entity.EntryTime);
			dict.Add("ClerkEmail", entity.ClerkEmail);
			dict.Add("ClerkMobile", entity.ClerkMobile);
			dict.Add("ClerkWX", entity.ClerkWX);
			dict.Add("ClerkQQ", entity.ClerkQQ);
			dict.Add("ClerkIDCard", entity.ClerkIDCard);
			dict.Add("ClerkIDCardPic", entity.ClerkIDCardPic);
			dict.Add("ClerkPic", entity.ClerkPic);
			dict.Add("ClerkBankBranch", entity.ClerkBankBranch);
			dict.Add("ClerkAccountName", entity.ClerkAccountName);
			dict.Add("ClerkBankAccount", entity.ClerkBankAccount);
			dict.Add("ClerkBankPic", entity.ClerkBankPic);
			dict.Add("ClerkStatus", entity.ClerkStatus);
			dict.Add("Linkman", entity.Linkman);
			dict.Add("LinkmanTel", entity.LinkmanTel);
			dict.Add("LinkmanClose", entity.LinkmanClose);
			...
			dict.Add("LoginStatus", entity.LoginStatus);
			dict.Add("ClerkRemark", entity.ClerkRemark);
			dict.Add("RemarkPic1", entity.RemarkPic1);
			dict.Add("RemarkPic2", entity.RemarkPic2);
			dict.Add("RemarkPic3", entity.RemarkPic3);
		}
		/// <summary>
		/// 通过数据读取器生成实体类
		/// </summary>
		...
		/// <returns></returns>
		private static ClerkEntity GetEntityFromrdr(NullableDataReader rdr)
		{
			ClerkEntity info = new ClerkEntity();
			info.ID = rdr.GetInt32("ID");
			info.ClerkType = rdr.GetString("ClerkType");
			info.ClerkName = rdr.GetString("ClerkName");
			info.EntryTime = rdr.GetNullableDateTime("EntryTime");
			info.ClerkEmail = rdr.GetString("ClerkEmail");
			info.ClerkMobile = rdr.GetString("ClerkMobile");
			info.ClerkWX = rdr.GetString("ClerkWX");
			info.ClerkQQ = rdr.GetString("ClerkQQ");
			info.ClerkIDCard = rdr.GetString("ClerkIDCard");
			info.ClerkIDCardPic = rdr.GetString("ClerkIDCardPic");
			info.ClerkPic = rdr.GetString("ClerkPic");
			info.ClerkBankBranch = rdr.GetString("ClerkBankBranch");
			info.ClerkAccountName = rdr.GetString("ClerkAccountName");
			info.ClerkBankAccount = rdr.GetString("ClerkBankAccount");
			info.ClerkBankPic = rdr.GetString("ClerkBankPic");
			info.ClerkStatus = rdr.GetInt32("ClerkStatus");
			info.Linkman = rdr.GetString("Linkman");
			info.LinkmanTel = rdr.GetString("LinkmanTel");
			info.LinkmanClose = rdr.GetString("LinkmanClose");
			...
			info.LoginStatus = rdr.GetInt32("LoginStatus");
			info.ClerkRemark = rdr.GetString("ClerkRemark");
			info.RemarkPic1 = rdr.GetString("RemarkPic1");
			info.RemarkPic2 = rdr.GetString("RemarkPic2");
			info.RemarkPic3 = rdr.GetString("RemarkPic3");
			return info;
		}
		#endregion
	}
