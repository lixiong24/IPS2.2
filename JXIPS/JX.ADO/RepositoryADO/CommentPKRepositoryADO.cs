...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class CommentPKRepositoryADO : ICommentPKRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public CommentPKRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from CommentPK where 1=1 ";
		...
		{
			return _DB.GetMaxID("CommentPK", "PKID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("CommentPK", "PKID"));
		}
		...
		{
			if(entity.PKID <= 0) entity.PKID=GetNewID();
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(CommentPKEntity entity)
		{
			if(entity.PKID <= 0) entity.PKID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(CommentPKEntity entity)
		{
			if(entity.PKID <= 0) entity.PKID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		{
			string strSQL = "delete from CommentPK where " +
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 pkid)
		{
			string strSQL = "delete from CommentPK where " +
		...
		{
			string strSQL = "delete from CommentPK where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(CommentPKEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update CommentPK SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public CommentPKEntity GetEntity(System.Int32 pkid)
		{
			string strCondition = string.Empty;
			strCondition += " and PKID = @PKID";
		...
		/// </summary>
		/// <returns></returns>
		public async Task<CommentPKEntity> GetEntityAsync(System.Int32 pkid)
		{
			string strCondition = string.Empty;
			strCondition += " and PKID = @PKID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual CommentPKEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<CommentPKEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<CommentPKEntity> list = new List<CommentPKEntity>();
			string strSQL = "select * from CommentPK where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<CommentPKEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<CommentPKEntity> list = new List<CommentPKEntity>();
			string strSQL = "select * from CommentPK where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from CommentPK where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<CommentPKEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CommentPKEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CommentPKEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
