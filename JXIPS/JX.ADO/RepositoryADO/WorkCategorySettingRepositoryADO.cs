...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class WorkCategorySettingRepositoryADO : IWorkCategorySettingRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public WorkCategorySettingRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from WorkCategorySetting where 1=1 ";
		...
		{
			return _DB.GetMaxID("WorkCategorySetting", "ID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("WorkCategorySetting", "ID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(WorkCategorySettingEntity entity)
		{
			if(entity.ID <= 0) entity.ID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into WorkCategorySetting ("+
							"ID,"+
							"WorkCategoryID,"+
							"CustomFormID,"+
							"TemplateOfAdmin,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(WorkCategorySettingEntity entity)
		{
			if(entity.ID <= 0) entity.ID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(WorkCategorySettingEntity entity)
		{
			if(entity.ID <= 0) entity.ID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(WorkCategorySettingEntity entity)
		{
			if(entity.ID <= 0) entity.ID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(WorkCategorySettingEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(WorkCategorySettingEntity entity, bool IsSave)
		{
		...
		{
			string strSQL = "delete from WorkCategorySetting where " +
		...
		{
			string strSQL = "delete from WorkCategorySetting where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(WorkCategorySettingEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update WorkCategorySetting SET "+
			"WorkCategoryID = @WorkCategoryID,"+
			"CustomFormID = @CustomFormID,"+
			"TemplateOfAdmin = @TemplateOfAdmin,"+
			"TemplateOfUser = @TemplateOfUser"+
			" WHERE "+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(WorkCategorySettingEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update WorkCategorySetting SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update WorkCategorySetting SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public WorkCategorySettingEntity GetEntity(System.Int32 id)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<WorkCategorySettingEntity> GetEntityAsync(System.Int32 id)
		{
			string strCondition = string.Empty;
			strCondition += " and ID = @ID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual WorkCategorySettingEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			WorkCategorySettingEntity obj = null;
			string strSQL = "select top 1 * from WorkCategorySetting where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<WorkCategorySettingEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			WorkCategorySettingEntity obj = null;
			string strSQL = "select top 1 * from WorkCategorySetting where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<WorkCategorySettingEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<WorkCategorySettingEntity> list = new List<WorkCategorySettingEntity>();
			string strSQL = "select * from WorkCategorySetting where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<WorkCategorySettingEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<WorkCategorySettingEntity> list = new List<WorkCategorySettingEntity>();
			string strSQL = "select * from WorkCategorySetting where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from WorkCategorySetting where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<WorkCategorySettingEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<WorkCategorySettingEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<WorkCategorySettingEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(WorkCategorySettingEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("ID", entity.ID);
			dict.Add("WorkCategoryID", entity.WorkCategoryID);
			dict.Add("CustomFormID", entity.CustomFormID);
			dict.Add("TemplateOfAdmin", entity.TemplateOfAdmin);
			dict.Add("TemplateOfUser", entity.TemplateOfUser);
		}
		/// <summary>
		/// 通过数据读取器生成实体类
		/// </summary>
		...
		/// <returns></returns>
		private static WorkCategorySettingEntity GetEntityFromrdr(NullableDataReader rdr)
		{
			WorkCategorySettingEntity info = new WorkCategorySettingEntity();
			info.ID = rdr.GetInt32("ID");
			info.WorkCategoryID = rdr.GetInt32("WorkCategoryID");
			info.CustomFormID = rdr.GetInt32("CustomFormID");
			info.TemplateOfAdmin = rdr.GetString("TemplateOfAdmin");
			info.TemplateOfUser = rdr.GetString("TemplateOfUser");
			return info;
		}
		#endregion
	}
