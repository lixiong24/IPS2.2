...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class RolesProcessRepositoryADO : IRolesProcessRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public RolesProcessRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from RolesProcess where 1=1 ";
		...
		{
			return _DB.GetMaxID("RolesProcess", "FlowID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("RolesProcess", "FlowID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(RolesProcessEntity entity)
		{
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into RolesProcess ("+
							"FlowID,"+
							"ProcessID,"+
							"RoleID) "+
							"values("+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(RolesProcessEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(RolesProcessEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(RolesProcessEntity entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(RolesProcessEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(RolesProcessEntity entity, bool IsSave)
		{
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.Int32 flowID, System.Int32 processID, System.Int32 roleID)
		{
			string strSQL = "delete from RolesProcess where " +
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 flowID, System.Int32 processID, System.Int32 roleID)
		{
			string strSQL = "delete from RolesProcess where " +
		...
		{
			string strSQL = "delete from RolesProcess where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(RolesProcessEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update RolesProcess SET "+
			" WHERE "+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(RolesProcessEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update RolesProcess SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update RolesProcess SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public RolesProcessEntity GetEntity(System.Int32 flowID, System.Int32 processID, System.Int32 roleID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<RolesProcessEntity> GetEntityAsync(System.Int32 flowID, System.Int32 processID, System.Int32 roleID)
		{
			string strCondition = string.Empty;
			strCondition += " and FlowID = @FlowID";
			strCondition += " and ProcessID = @ProcessID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual RolesProcessEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			RolesProcessEntity obj = null;
			string strSQL = "select top 1 * from RolesProcess where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<RolesProcessEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			RolesProcessEntity obj = null;
			string strSQL = "select top 1 * from RolesProcess where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<RolesProcessEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<RolesProcessEntity> list = new List<RolesProcessEntity>();
			string strSQL = "select * from RolesProcess where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<RolesProcessEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<RolesProcessEntity> list = new List<RolesProcessEntity>();
			string strSQL = "select * from RolesProcess where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from RolesProcess where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<RolesProcessEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<RolesProcessEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<RolesProcessEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(RolesProcessEntity entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static RolesProcessEntity GetEntityFromrdr(NullableDataReader rdr)
		{
			RolesProcessEntity info = new RolesProcessEntity();
