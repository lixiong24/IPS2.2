...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class PaymentLogRepositoryADO : IPaymentLogRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public PaymentLogRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from PaymentLog where 1=1 ";
		...
		{
			return _DB.GetMaxID("PaymentLog", "PaymentLogID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("PaymentLog", "PaymentLogID"));
		}
		...
		{
			if(entity.PaymentLogID <= 0) entity.PaymentLogID=GetNewID();
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(PaymentLogEntity entity)
		{
			if(entity.PaymentLogID <= 0) entity.PaymentLogID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(PaymentLogEntity entity)
		{
			if(entity.PaymentLogID <= 0) entity.PaymentLogID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.Int32 paymentLogID)
		{
			string strSQL = "delete from PaymentLog where " +
			
			"PaymentLogID = @PaymentLogID"; 
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			dict.Add("PaymentLogID", paymentLogID);
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 paymentLogID)
		{
			string strSQL = "delete from PaymentLog where " +
		...
		{
			string strSQL = "delete from PaymentLog where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(PaymentLogEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update PaymentLog SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public PaymentLogEntity GetEntity(System.Int32 paymentLogID)
		{
			string strCondition = string.Empty;
			strCondition += " and PaymentLogID = @PaymentLogID";
		...
		/// </summary>
		/// <returns></returns>
		public async Task<PaymentLogEntity> GetEntityAsync(System.Int32 paymentLogID)
		{
			string strCondition = string.Empty;
			strCondition += " and PaymentLogID = @PaymentLogID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual PaymentLogEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<PaymentLogEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<PaymentLogEntity> list = new List<PaymentLogEntity>();
			string strSQL = "select * from PaymentLog where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<PaymentLogEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<PaymentLogEntity> list = new List<PaymentLogEntity>();
			string strSQL = "select * from PaymentLog where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from PaymentLog where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<PaymentLogEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<PaymentLogEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<PaymentLogEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
