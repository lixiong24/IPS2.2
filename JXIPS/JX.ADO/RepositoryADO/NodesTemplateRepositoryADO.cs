...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class NodesTemplateRepositoryADO : INodesTemplateRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public NodesTemplateRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from NodesTemplate where 1=1 ";
		...
		{
			return _DB.GetMaxID("NodesTemplate", "NodeID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("NodesTemplate", "NodeID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(NodesTemplateEntity entity)
		{
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into NodesTemplate ("+
							"NodeID,"+
							"TemplateID,"+
							"IsDefault) "+
							"values("+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(NodesTemplateEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(NodesTemplateEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(NodesTemplateEntity entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(NodesTemplateEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(NodesTemplateEntity entity, bool IsSave)
		{
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.Int32 nodeID, System.Int32 templateID)
		{
			string strSQL = "delete from NodesTemplate where " +
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 nodeID, System.Int32 templateID)
		{
			string strSQL = "delete from NodesTemplate where " +
		...
		{
			string strSQL = "delete from NodesTemplate where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(NodesTemplateEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update NodesTemplate SET "+
			"IsDefault = @IsDefault"+
			" WHERE "+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(NodesTemplateEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update NodesTemplate SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update NodesTemplate SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public NodesTemplateEntity GetEntity(System.Int32 nodeID, System.Int32 templateID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<NodesTemplateEntity> GetEntityAsync(System.Int32 nodeID, System.Int32 templateID)
		{
			string strCondition = string.Empty;
			strCondition += " and NodeID = @NodeID";
			strCondition += " and TemplateID = @TemplateID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual NodesTemplateEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			NodesTemplateEntity obj = null;
			string strSQL = "select top 1 * from NodesTemplate where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<NodesTemplateEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			NodesTemplateEntity obj = null;
			string strSQL = "select top 1 * from NodesTemplate where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<NodesTemplateEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<NodesTemplateEntity> list = new List<NodesTemplateEntity>();
			string strSQL = "select * from NodesTemplate where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<NodesTemplateEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<NodesTemplateEntity> list = new List<NodesTemplateEntity>();
			string strSQL = "select * from NodesTemplate where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from NodesTemplate where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<NodesTemplateEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<NodesTemplateEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<NodesTemplateEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(NodesTemplateEntity entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static NodesTemplateEntity GetEntityFromrdr(NullableDataReader rdr)
		{
			NodesTemplateEntity info = new NodesTemplateEntity();
