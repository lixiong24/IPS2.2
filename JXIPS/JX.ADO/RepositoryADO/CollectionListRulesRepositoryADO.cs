...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class CollectionListRulesRepositoryADO : ICollectionListRulesRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		{
			string strSQL = "select " + statistic + " from CollectionListRules where 1=1 ";
		...
		{
			return _DB.GetMaxID("CollectionListRules", "ItemID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("CollectionListRules", "ItemID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(CollectionListRulesEntity entity)
		{
			if(entity.ItemID <= 0) entity.ItemID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into CollectionListRules ("+
							"ItemID,"+
							"ListBeginCode,"+
							"ListEndCode,"+
							"LinkBeginCode,"+
							"LinkEndCode,"+
							"IsLinkSpecialSolution,"+
							"RedirectUrl,"+
							"IsUsePaging) "+
							"values("+
							"@ItemID,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(CollectionListRulesEntity entity)
		{
			if(entity.ItemID <= 0) entity.ItemID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(CollectionListRulesEntity entity)
		{
			if(entity.ItemID <= 0) entity.ItemID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(CollectionListRulesEntity entity)
		{
			if(entity.ItemID <= 0) entity.ItemID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(CollectionListRulesEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(CollectionListRulesEntity entity, bool IsSave)
		{
		...
		{
			string strSQL = "delete from CollectionListRules where " +
		...
		{
			string strSQL = "delete from CollectionListRules where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(CollectionListRulesEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update CollectionListRules SET "+
			"ListBeginCode = @ListBeginCode,"+
			"ListEndCode = @ListEndCode,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(CollectionListRulesEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update CollectionListRules SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update CollectionListRules SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public CollectionListRulesEntity GetEntity(System.Int32 itemID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<CollectionListRulesEntity> GetEntityAsync(System.Int32 itemID)
		{
			string strCondition = string.Empty;
			strCondition += " and ItemID = @ItemID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual CollectionListRulesEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			CollectionListRulesEntity obj = null;
			string strSQL = "select top 1 * from CollectionListRules where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<CollectionListRulesEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			CollectionListRulesEntity obj = null;
			string strSQL = "select top 1 * from CollectionListRules where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<CollectionListRulesEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<CollectionListRulesEntity> list = new List<CollectionListRulesEntity>();
			string strSQL = "select * from CollectionListRules where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<CollectionListRulesEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<CollectionListRulesEntity> list = new List<CollectionListRulesEntity>();
			string strSQL = "select * from CollectionListRules where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from CollectionListRules where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<CollectionListRulesEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CollectionListRulesEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CollectionListRulesEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(CollectionListRulesEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("ItemID", entity.ItemID);
			dict.Add("ListBeginCode", entity.ListBeginCode);
			dict.Add("ListEndCode", entity.ListEndCode);
			dict.Add("LinkBeginCode", entity.LinkBeginCode);
			dict.Add("LinkEndCode", entity.LinkEndCode);
			dict.Add("IsLinkSpecialSolution", entity.IsLinkSpecialSolution);
			dict.Add("RedirectUrl", entity.RedirectUrl);
