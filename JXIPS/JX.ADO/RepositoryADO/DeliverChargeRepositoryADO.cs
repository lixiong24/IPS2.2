...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class DeliverChargeRepositoryADO : IDeliverChargeRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public DeliverChargeRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from DeliverCharge where 1=1 ";
		...
		{
			return _DB.GetMaxID("DeliverCharge", "ID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("DeliverCharge", "ID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(DeliverChargeEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(DeliverChargeEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(DeliverChargeEntity entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(DeliverChargeEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(DeliverChargeEntity entity, bool IsSave)
		{
		...
		{
			string strSQL = "delete from DeliverCharge where " +
		...
		{
			string strSQL = "delete from DeliverCharge where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(DeliverChargeEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update DeliverCharge SET "+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(DeliverChargeEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update DeliverCharge SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update DeliverCharge SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public DeliverChargeEntity GetEntity(System.Int32 id)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<DeliverChargeEntity> GetEntityAsync(System.Int32 id)
		{
			string strCondition = string.Empty;
			strCondition += " and ID = @ID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual DeliverChargeEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			DeliverChargeEntity obj = null;
			string strSQL = "select top 1 * from DeliverCharge where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<DeliverChargeEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			DeliverChargeEntity obj = null;
			string strSQL = "select top 1 * from DeliverCharge where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<DeliverChargeEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<DeliverChargeEntity> list = new List<DeliverChargeEntity>();
			string strSQL = "select * from DeliverCharge where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<DeliverChargeEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<DeliverChargeEntity> list = new List<DeliverChargeEntity>();
			string strSQL = "select * from DeliverCharge where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from DeliverCharge where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<DeliverChargeEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<DeliverChargeEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<DeliverChargeEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(DeliverChargeEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("ID", entity.ID);
			dict.Add("DeliverTypeID", entity.DeliverTypeID);
			dict.Add("AreaType", entity.AreaType);
			dict.Add("arrArea", entity.ArrArea);
			dict.Add("Charge_Min", entity.Charge_Min);
			dict.Add("Weight_Min", entity.Weight_Min);
			dict.Add("ChargePerUnit", entity.ChargePerUnit);
			dict.Add("WeightPerUnit", entity.WeightPerUnit);
