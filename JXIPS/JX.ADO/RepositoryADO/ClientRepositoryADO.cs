...
namespace JX.ADO
{
	...
	/// 数据库表：Client 的仓储实现类.
	/// </summary>
	public partial class ClientRepositoryADO : IClientRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public ClientRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from Client where 1=1 ";
		...
		{
			return _DB.GetMaxID("Client", "ClientID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("Client", "ClientID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(ClientEntity entity)
		{
			if(entity.ClientID <= 0) entity.ClientID=GetNewID();
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(ClientEntity entity)
		{
			if(entity.ClientID <= 0) entity.ClientID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(ClientEntity entity)
		{
			if(entity.ClientID <= 0) entity.ClientID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
			...
			{
				return DataConverter.CLng(entity.ClientID);
			}
			return -1;
		}
		/// <summary>
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(ClientEntity entity)
		{
			if(entity.ClientID <= 0) entity.ClientID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(ClientEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(ClientEntity entity, bool IsSave)
		{
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.Int32 clientID)
		{
			string strSQL = "delete from Client where " +
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 clientID)
		{
			string strSQL = "delete from Client where " +
		...
		{
			string strSQL = "delete from Client where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(ClientEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update Client SET "+
			"ParentID = @ParentID,"+
			"ClientNum = @ClientNum,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(ClientEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update Client SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update Client SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public ClientEntity GetEntity(System.Int32 clientID)
		{
			string strCondition = string.Empty;
			strCondition += " and ClientID = @ClientID";
		...
		/// </summary>
		/// <returns></returns>
		public async Task<ClientEntity> GetEntityAsync(System.Int32 clientID)
		{
			string strCondition = string.Empty;
			strCondition += " and ClientID = @ClientID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual ClientEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			ClientEntity obj = null;
			string strSQL = "select top 1 * from Client where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<ClientEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			ClientEntity obj = null;
			string strSQL = "select top 1 * from Client where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<ClientEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<ClientEntity> list = new List<ClientEntity>();
			string strSQL = "select * from Client where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<ClientEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<ClientEntity> list = new List<ClientEntity>();
			string strSQL = "select * from Client where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from Client where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<ClientEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ClientEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ClientEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(ClientEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("ClientID", entity.ClientID);
			dict.Add("ParentID", entity.ParentID);
			dict.Add("ClientNum", entity.ClientNum);
			dict.Add("ClientType", entity.ClientType);
			dict.Add("ClientName", entity.ClientName);
			dict.Add("ShortedForm", entity.ShortedForm);
			dict.Add("Area", entity.Area);
			dict.Add("ClientField", entity.ClientField);
			dict.Add("ValueLevel", entity.ValueLevel);
			dict.Add("CreditLevel", entity.CreditLevel);
			dict.Add("Importance", entity.Importance);
			dict.Add("ConnectionLevel", entity.ConnectionLevel);
			dict.Add("GroupID", entity.GroupID);
			dict.Add("SourceType", entity.SourceType);
			dict.Add("PhaseType", entity.PhaseType);
			dict.Add("Description", entity.Description);
			dict.Add("VisitTimes", entity.VisitTimes);
			dict.Add("ServiceTimes", entity.ServiceTimes);
			dict.Add("ComplainTimes", entity.ComplainTimes);
			dict.Add("LastVisitTime", entity.LastVisitTime);
			dict.Add("LastServiceTime", entity.LastServiceTime);
			dict.Add("LastComplainTime", entity.LastComplainTime);
			...
			dict.Add("LastContactedTime", entity.LastContactedTime);
