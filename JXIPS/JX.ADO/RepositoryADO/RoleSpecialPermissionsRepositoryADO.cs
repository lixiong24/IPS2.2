...
namespace JX.ADO
{
	...
	public partial class RoleSpecialPermissionsRepositoryADO : IRoleSpecialPermissionsRepositoryADO
	{
		...
		/// </summary>
		/// <param name="DB"></param>
		public RoleSpecialPermissionsRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from RoleSpecialPermissions where 1=1 ";
		...
		{
			return _DB.GetMaxID("RoleSpecialPermissions", "RoleID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("RoleSpecialPermissions", "RoleID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(RoleSpecialPermissionsEntity entity)
		{
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into RoleSpecialPermissions ("+
							"RoleID,"+
							"SpecialID,"+
							"OperateCode) "+
							"values("+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(RoleSpecialPermissionsEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(RoleSpecialPermissionsEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(RoleSpecialPermissionsEntity entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(RoleSpecialPermissionsEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(RoleSpecialPermissionsEntity entity, bool IsSave)
		{
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.Int32 roleID, System.Int32 specialID, System.String operateCode)
		{
			string strSQL = "delete from RoleSpecialPermissions where " +
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 roleID, System.Int32 specialID, System.String operateCode)
		{
			string strSQL = "delete from RoleSpecialPermissions where " +
		...
		{
			string strSQL = "delete from RoleSpecialPermissions where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(RoleSpecialPermissionsEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update RoleSpecialPermissions SET "+
			" WHERE "+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(RoleSpecialPermissionsEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update RoleSpecialPermissions SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update RoleSpecialPermissions SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public RoleSpecialPermissionsEntity GetEntity(System.Int32 roleID, System.Int32 specialID, System.String operateCode)
		{
			string strCondition = string.Empty;
			strCondition += " and RoleID = @RoleID";
		...
		/// </summary>
		/// <returns></returns>
		public async Task<RoleSpecialPermissionsEntity> GetEntityAsync(System.Int32 roleID, System.Int32 specialID, System.String operateCode)
		{
			string strCondition = string.Empty;
			strCondition += " and RoleID = @RoleID";
			strCondition += " and SpecialID = @SpecialID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual RoleSpecialPermissionsEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			RoleSpecialPermissionsEntity obj = null;
			string strSQL = "select top 1 * from RoleSpecialPermissions where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<RoleSpecialPermissionsEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			RoleSpecialPermissionsEntity obj = null;
			string strSQL = "select top 1 * from RoleSpecialPermissions where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<RoleSpecialPermissionsEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<RoleSpecialPermissionsEntity> list = new List<RoleSpecialPermissionsEntity>();
			string strSQL = "select * from RoleSpecialPermissions where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<RoleSpecialPermissionsEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<RoleSpecialPermissionsEntity> list = new List<RoleSpecialPermissionsEntity>();
			string strSQL = "select * from RoleSpecialPermissions where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from RoleSpecialPermissions where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<RoleSpecialPermissionsEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		public virtual IList<RoleSpecialPermissionsEntity> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			...
			{
				TableName = "RoleSpecialPermissions";
			}
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<RoleSpecialPermissionsEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<RoleSpecialPermissionsEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(RoleSpecialPermissionsEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("RoleID", entity.RoleID);
		...
		/// <returns></returns>
		private static RoleSpecialPermissionsEntity GetEntityFromrdr(NullableDataReader rdr)
		{
			RoleSpecialPermissionsEntity info = new RoleSpecialPermissionsEntity();
