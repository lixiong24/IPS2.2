...
namespace JX.ADO
{
	...
	/// 数据库表：Roles 的仓储实现类.
	/// </summary>
	public partial class RolesRepositoryADO : IRolesRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public RolesRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from Roles where 1=1 ";
		...
		{
			return _DB.GetMaxID("Roles", "RoleID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("Roles", "RoleID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(RolesEntity entity)
		{
			if(entity.RoleID <= 0) entity.RoleID=GetNewID();
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(RolesEntity entity)
		{
			if(entity.RoleID <= 0) entity.RoleID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(RolesEntity entity)
		{
			if(entity.RoleID <= 0) entity.RoleID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(RolesEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(RolesEntity entity, bool IsSave)
		{
		...
		{
			string strSQL = "delete from Roles where " +
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 roleID)
		{
			string strSQL = "delete from Roles where " +
		...
		{
			string strSQL = "delete from Roles where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update Roles SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public RolesEntity GetEntity(System.Int32 roleID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<RolesEntity> GetEntityAsync(System.Int32 roleID)
		{
			string strCondition = string.Empty;
			strCondition += " and RoleID = @RoleID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<RolesEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<RolesEntity> list = new List<RolesEntity>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<RolesEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<RolesEntity> list = new List<RolesEntity>();
			string strSQL = "select * from Roles where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from Roles where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<RolesEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<RolesEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<RolesEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(RolesEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("RoleID", entity.RoleID);
			dict.Add("RoleName", entity.RoleName);
