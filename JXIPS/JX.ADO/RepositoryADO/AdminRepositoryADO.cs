...
namespace JX.ADO
{
	...
	public partial class AdminRepositoryADO : IAdminRepositoryADO
	{
		...
		/// </summary>
		/// <param name="DB"></param>
		public AdminRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from Admin where 1=1 ";
		...
		{
			return _DB.GetMaxID("Admin", "AdminID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("Admin", "AdminID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(AdminEntity entity)
		{
			if(entity.AdminID <= 0) entity.AdminID=GetNewID();
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(AdminEntity entity)
		{
			if(entity.AdminID <= 0) entity.AdminID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(AdminEntity entity)
		{
			if(entity.AdminID <= 0) entity.AdminID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(AdminEntity entity)
		{
			if(entity.AdminID <= 0) entity.AdminID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(AdminEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(AdminEntity entity, bool IsSave)
		{
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.Int32 adminID)
		{
			string strSQL = "delete from Admin where " +
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 adminID)
		{
			string strSQL = "delete from Admin where " +
		...
		{
			string strSQL = "delete from Admin where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(AdminEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update Admin SET "+
			"AdminName = @AdminName,"+
			"AdminPassword = @AdminPassword,"+
			"UserName = @UserName,"+
			"IsMultiLogin = @IsMultiLogin,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(AdminEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update Admin SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update Admin SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public AdminEntity GetEntity(System.Int32 adminID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<AdminEntity> GetEntityAsync(System.Int32 adminID)
		{
			string strCondition = string.Empty;
			strCondition += " and AdminID = @AdminID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual AdminEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<AdminEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			AdminEntity obj = null;
			string strSQL = "select top 1 * from Admin where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<AdminEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<AdminEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<AdminEntity> list = new List<AdminEntity>();
			string strSQL = "select * from Admin where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from Admin where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<AdminEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<AdminEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<AdminEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(AdminEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("AdminID", entity.AdminID);
			dict.Add("AdminName", entity.AdminName);
			dict.Add("AdminPassword", entity.AdminPassword);
			dict.Add("UserName", entity.UserName);
			dict.Add("IsMultiLogin", entity.IsMultiLogin);
			dict.Add("RndPassword", entity.RndPassword);
			dict.Add("LoginTimes", entity.LoginTimes);
			dict.Add("LoginIP", entity.LoginIP);
			dict.Add("LoginTime", entity.LoginTime);
			dict.Add("LogoutTime", entity.LogoutTime);
			dict.Add("ModifyPasswordTime", entity.ModifyPasswordTime);
			dict.Add("IsLock", entity.IsLock);
			dict.Add("IsModifyPassword", entity.IsModifyPassword);
			dict.Add("Hash", entity.Hash);
			dict.Add("LoginErrorTimes", entity.LoginErrorTimes);
		}
		/// <summary>
		/// 通过数据读取器生成实体类
		/// </summary>
