...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class PaymentTypeRepositoryADO : IPaymentTypeRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public PaymentTypeRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from PaymentType where 1=1 ";
		...
		{
			return _DB.GetMaxID("PaymentType", "TypeID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("PaymentType", "TypeID"));
		}
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(PaymentTypeEntity entity)
		{
			if(entity.TypeID <= 0) entity.TypeID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(PaymentTypeEntity entity)
		{
			if(entity.TypeID <= 0) entity.TypeID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		{
			string strSQL = "delete from PaymentType where " +
		...
		{
			string strSQL = "delete from PaymentType where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(PaymentTypeEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update PaymentType SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public PaymentTypeEntity GetEntity(System.Int32 typeID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<PaymentTypeEntity> GetEntityAsync(System.Int32 typeID)
		{
			string strCondition = string.Empty;
			strCondition += " and TypeID = @TypeID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual PaymentTypeEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<PaymentTypeEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<PaymentTypeEntity> list = new List<PaymentTypeEntity>();
			string strSQL = "select * from PaymentType where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<PaymentTypeEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<PaymentTypeEntity> list = new List<PaymentTypeEntity>();
			string strSQL = "select * from PaymentType where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from PaymentType where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<PaymentTypeEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<PaymentTypeEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<PaymentTypeEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
