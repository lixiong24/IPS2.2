...
{
	/// <summary>
	/// 数据库表：StatTimezone 的仓储实现类.
	/// </summary>
	public partial class StatTimezoneRepositoryADO : IStatTimezoneRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public StatTimezoneRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from StatTimezone where 1=1 ";
		...
		{
			return _DB.GetMaxID("StatTimezone", "TTimezone");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("StatTimezone", "TTimezone"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(StatTimezoneEntity entity)
		{
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into StatTimezone ("+
							"TTimezone,"+
							"TTimNum) "+
							"values("+
							"@TTimezone,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(StatTimezoneEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(StatTimezoneEntity entity)
		{
			...
			{
				return DataConverter.CLng(entity.TTimezone);
			}
			return -1;
		}
		/// <summary>
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(StatTimezoneEntity entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(StatTimezoneEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(StatTimezoneEntity entity, bool IsSave)
		{
		...
		{
			string strSQL = "delete from StatTimezone where " +
			
			"TTimezone = @TTimezone"; 
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			dict.Add("TTimezone", tTimezone);
		...
		{
			string strSQL = "delete from StatTimezone where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(StatTimezoneEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update StatTimezone SET "+
			"TTimNum = @TTimNum"+
			" WHERE "+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(StatTimezoneEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update StatTimezone SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update StatTimezone SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public StatTimezoneEntity GetEntity(System.String tTimezone)
		{
			string strCondition = string.Empty;
			strCondition += " and TTimezone = @TTimezone";
		...
		/// </summary>
		/// <returns></returns>
		public async Task<StatTimezoneEntity> GetEntityAsync(System.String tTimezone)
		{
			string strCondition = string.Empty;
			strCondition += " and TTimezone = @TTimezone";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual StatTimezoneEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			StatTimezoneEntity obj = null;
			string strSQL = "select top 1 * from StatTimezone where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<StatTimezoneEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			StatTimezoneEntity obj = null;
			string strSQL = "select top 1 * from StatTimezone where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<StatTimezoneEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<StatTimezoneEntity> list = new List<StatTimezoneEntity>();
			string strSQL = "select * from StatTimezone where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<StatTimezoneEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<StatTimezoneEntity> list = new List<StatTimezoneEntity>();
			string strSQL = "select * from StatTimezone where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from StatTimezone where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<StatTimezoneEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatTimezoneEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatTimezoneEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(StatTimezoneEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("TTimezone", entity.TTimezone);
			dict.Add("TTimNum", entity.TTimNum);
		}
		/// <summary>
		/// 通过数据读取器生成实体类
		/// </summary>
