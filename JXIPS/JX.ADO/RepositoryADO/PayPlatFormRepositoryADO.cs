...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class PayPlatFormRepositoryADO : IPayPlatFormRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public PayPlatFormRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from PayPlatForm where 1=1 ";
		...
		{
			return _DB.GetMaxID("PayPlatForm", "PayPlatformID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("PayPlatForm", "PayPlatformID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(PayPlatFormEntity entity)
		{
			if(entity.PayPlatformID <= 0) entity.PayPlatformID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into PayPlatForm ("+
							"PayPlatformID,"+
							"PayPlatformName,"+
							"AccountsID,"+
							"MD5,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(PayPlatFormEntity entity)
		{
			if(entity.PayPlatformID <= 0) entity.PayPlatformID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(PayPlatFormEntity entity)
		{
			if(entity.PayPlatformID <= 0) entity.PayPlatformID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
			...
			{
				return DataConverter.CLng(entity.PayPlatformID);
			}
			return -1;
		}
		/// <summary>
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(PayPlatFormEntity entity)
		{
			if(entity.PayPlatformID <= 0) entity.PayPlatformID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(PayPlatFormEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(PayPlatFormEntity entity, bool IsSave)
		{
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.Int32 payPlatformID)
		{
			string strSQL = "delete from PayPlatForm where " +
			
			"PayPlatformID = @PayPlatformID"; 
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			dict.Add("PayPlatformID", payPlatformID);
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 payPlatformID)
		{
			string strSQL = "delete from PayPlatForm where " +
		...
		{
			string strSQL = "delete from PayPlatForm where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(PayPlatFormEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update PayPlatForm SET "+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(PayPlatFormEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update PayPlatForm SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update PayPlatForm SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public PayPlatFormEntity GetEntity(System.Int32 payPlatformID)
		{
			string strCondition = string.Empty;
			strCondition += " and PayPlatformID = @PayPlatformID";
		...
		/// </summary>
		/// <returns></returns>
		public async Task<PayPlatFormEntity> GetEntityAsync(System.Int32 payPlatformID)
		{
			string strCondition = string.Empty;
			strCondition += " and PayPlatformID = @PayPlatformID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual PayPlatFormEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			PayPlatFormEntity obj = null;
			string strSQL = "select top 1 * from PayPlatForm where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<PayPlatFormEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			PayPlatFormEntity obj = null;
			string strSQL = "select top 1 * from PayPlatForm where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<PayPlatFormEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<PayPlatFormEntity> list = new List<PayPlatFormEntity>();
			string strSQL = "select * from PayPlatForm where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<PayPlatFormEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<PayPlatFormEntity> list = new List<PayPlatFormEntity>();
			string strSQL = "select * from PayPlatForm where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from PayPlatForm where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<PayPlatFormEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<PayPlatFormEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<PayPlatFormEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(PayPlatFormEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("PayPlatformID", entity.PayPlatformID);
			dict.Add("PayPlatformName", entity.PayPlatformName);
			dict.Add("AccountsID", entity.AccountsID);
			dict.Add("MD5", entity.MD5);
			dict.Add("Rate", entity.Rate);
