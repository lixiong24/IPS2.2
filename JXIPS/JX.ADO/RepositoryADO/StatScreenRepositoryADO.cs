...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class StatScreenRepositoryADO : IStatScreenRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		{
			string strSQL = "select " + statistic + " from StatScreen where 1=1 ";
		...
		{
			return _DB.GetMaxID("StatScreen", "TScreen");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("StatScreen", "TScreen"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(StatScreenEntity entity)
		{
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into StatScreen ("+
							"TScreen,"+
							"TScrNum) "+
							"values("+
							"@TScreen,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(StatScreenEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(StatScreenEntity entity)
		{
			...
			{
				return DataConverter.CLng(entity.TScreen);
			}
			return -1;
		}
		/// <summary>
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(StatScreenEntity entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(StatScreenEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(StatScreenEntity entity, bool IsSave)
		{
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.String tScreen)
		{
			string strSQL = "delete from StatScreen where " +
			
			"TScreen = @TScreen"; 
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			dict.Add("TScreen", tScreen);
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.String tScreen)
		{
			string strSQL = "delete from StatScreen where " +
		...
		{
			string strSQL = "delete from StatScreen where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(StatScreenEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update StatScreen SET "+
			"TScrNum = @TScrNum"+
			" WHERE "+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(StatScreenEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update StatScreen SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update StatScreen SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public StatScreenEntity GetEntity(System.String tScreen)
		{
			string strCondition = string.Empty;
			strCondition += " and TScreen = @TScreen";
		...
		/// </summary>
		/// <returns></returns>
		public async Task<StatScreenEntity> GetEntityAsync(System.String tScreen)
		{
			string strCondition = string.Empty;
			strCondition += " and TScreen = @TScreen";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual StatScreenEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			StatScreenEntity obj = null;
			string strSQL = "select top 1 * from StatScreen where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<StatScreenEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			StatScreenEntity obj = null;
			string strSQL = "select top 1 * from StatScreen where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<StatScreenEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<StatScreenEntity> list = new List<StatScreenEntity>();
			string strSQL = "select * from StatScreen where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<StatScreenEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<StatScreenEntity> list = new List<StatScreenEntity>();
			string strSQL = "select * from StatScreen where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from StatScreen where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<StatScreenEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatScreenEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatScreenEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(StatScreenEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("TScreen", entity.TScreen);
			dict.Add("TScrNum", entity.TScrNum);
		}
		/// <summary>
		/// 通过数据读取器生成实体类
		/// </summary>
