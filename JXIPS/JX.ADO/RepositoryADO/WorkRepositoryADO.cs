...
namespace JX.ADO
{
	...
	/// 数据库表：Work 的仓储实现类.
	/// </summary>
	public partial class WorkRepositoryADO : IWorkRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public WorkRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from Work where 1=1 ";
		...
		{
			return _DB.GetMaxID("Work", "WorkID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("Work", "WorkID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(WorkEntity entity)
		{
			if(entity.WorkID <= 0) entity.WorkID=GetNewID();
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(WorkEntity entity)
		{
			if(entity.WorkID <= 0) entity.WorkID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(WorkEntity entity)
		{
			if(entity.WorkID <= 0) entity.WorkID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.Int32 workID)
		{
			string strSQL = "delete from Work where " +
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 workID)
		{
			string strSQL = "delete from Work where " +
		...
		{
			string strSQL = "delete from Work where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(WorkEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update Work SET "+
			"WorkName = @WorkName,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(WorkEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update Work SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update Work SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public WorkEntity GetEntity(System.Int32 workID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<WorkEntity> GetEntityAsync(System.Int32 workID)
		{
			string strCondition = string.Empty;
			strCondition += " and WorkID = @WorkID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual WorkEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			WorkEntity obj = null;
			string strSQL = "select top 1 * from Work where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<WorkEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			WorkEntity obj = null;
			string strSQL = "select top 1 * from Work where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<WorkEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<WorkEntity> list = new List<WorkEntity>();
			string strSQL = "select * from Work where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<WorkEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<WorkEntity> list = new List<WorkEntity>();
			string strSQL = "select * from Work where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from Work where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<WorkEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<WorkEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<WorkEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(WorkEntity entity, Dictionary<string, object> dict)
		{
			...
			dict.Add("FormID", entity.FormID);
			dict.Add("FormTable", entity.FormTable);
