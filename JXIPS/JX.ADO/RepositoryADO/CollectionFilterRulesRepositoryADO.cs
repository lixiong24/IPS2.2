...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class CollectionFilterRulesRepositoryADO : ICollectionFilterRulesRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public CollectionFilterRulesRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from CollectionFilterRules where 1=1 ";
		...
		{
			return _DB.GetMaxID("CollectionFilterRules", "FilterRuleID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("CollectionFilterRules", "FilterRuleID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(CollectionFilterRulesEntity entity)
		{
			if(entity.FilterRuleID <= 0) entity.FilterRuleID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into CollectionFilterRules ("+
							"FilterRuleID,"+
							"FilterName,"+
							"FilterType,"+
							"BeginCode,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(CollectionFilterRulesEntity entity)
		{
			if(entity.FilterRuleID <= 0) entity.FilterRuleID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(CollectionFilterRulesEntity entity)
		{
			if(entity.FilterRuleID <= 0) entity.FilterRuleID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
			...
			{
				return DataConverter.CLng(entity.FilterRuleID);
			}
			return -1;
		}
		/// <summary>
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(CollectionFilterRulesEntity entity)
		{
			if(entity.FilterRuleID <= 0) entity.FilterRuleID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(CollectionFilterRulesEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(CollectionFilterRulesEntity entity, bool IsSave)
		{
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.Int32 filterRuleID)
		{
			string strSQL = "delete from CollectionFilterRules where " +
			
			"FilterRuleID = @FilterRuleID"; 
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			dict.Add("FilterRuleID", filterRuleID);
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 filterRuleID)
		{
			string strSQL = "delete from CollectionFilterRules where " +
		...
		{
			string strSQL = "delete from CollectionFilterRules where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(CollectionFilterRulesEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update CollectionFilterRules SET "+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(CollectionFilterRulesEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update CollectionFilterRules SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update CollectionFilterRules SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public CollectionFilterRulesEntity GetEntity(System.Int32 filterRuleID)
		{
			string strCondition = string.Empty;
			strCondition += " and FilterRuleID = @FilterRuleID";
		...
		/// </summary>
		/// <returns></returns>
		public async Task<CollectionFilterRulesEntity> GetEntityAsync(System.Int32 filterRuleID)
		{
			string strCondition = string.Empty;
			strCondition += " and FilterRuleID = @FilterRuleID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual CollectionFilterRulesEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			CollectionFilterRulesEntity obj = null;
			string strSQL = "select top 1 * from CollectionFilterRules where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<CollectionFilterRulesEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			CollectionFilterRulesEntity obj = null;
			string strSQL = "select top 1 * from CollectionFilterRules where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<CollectionFilterRulesEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<CollectionFilterRulesEntity> list = new List<CollectionFilterRulesEntity>();
			string strSQL = "select * from CollectionFilterRules where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<CollectionFilterRulesEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<CollectionFilterRulesEntity> list = new List<CollectionFilterRulesEntity>();
			string strSQL = "select * from CollectionFilterRules where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from CollectionFilterRules where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<CollectionFilterRulesEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		public virtual IList<CollectionFilterRulesEntity> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			...
			{
				TableName = "CollectionFilterRules";
			}
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CollectionFilterRulesEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CollectionFilterRulesEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(CollectionFilterRulesEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("FilterRuleID", entity.FilterRuleID);
			dict.Add("FilterName", entity.FilterName);
			dict.Add("FilterType", entity.FilterType);
			dict.Add("BeginCode", entity.BeginCode);
			dict.Add("EndCode", entity.EndCode);
			dict.Add("Replace", entity.Replace);
		}
		/// <summary>
		/// 通过数据读取器生成实体类
		/// </summary>
		...
		/// <returns></returns>
		private static CollectionFilterRulesEntity GetEntityFromrdr(NullableDataReader rdr)
		{
			CollectionFilterRulesEntity info = new CollectionFilterRulesEntity();
