...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class CollectionFieldRulesRepositoryADO : ICollectionFieldRulesRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public CollectionFieldRulesRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from CollectionFieldRules where 1=1 ";
		...
		{
			return _DB.GetMaxID("CollectionFieldRules", "FieldRuleID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("CollectionFieldRules", "FieldRuleID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(CollectionFieldRulesEntity entity)
		{
			if(entity.FieldRuleID <= 0) entity.FieldRuleID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into CollectionFieldRules ("+
							"FieldRuleID,"+
							"ItemID,"+
							"FieldName,"+
							"FieldType,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(CollectionFieldRulesEntity entity)
		{
			if(entity.FieldRuleID <= 0) entity.FieldRuleID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(CollectionFieldRulesEntity entity)
		{
			if(entity.FieldRuleID <= 0) entity.FieldRuleID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
			...
			{
				return DataConverter.CLng(entity.FieldRuleID);
			}
			return -1;
		}
		/// <summary>
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(CollectionFieldRulesEntity entity)
		{
			if(entity.FieldRuleID <= 0) entity.FieldRuleID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(CollectionFieldRulesEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(CollectionFieldRulesEntity entity, bool IsSave)
		{
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.Int32 fieldRuleID)
		{
			string strSQL = "delete from CollectionFieldRules where " +
			
			"FieldRuleID = @FieldRuleID"; 
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			dict.Add("FieldRuleID", fieldRuleID);
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 fieldRuleID)
		{
			string strSQL = "delete from CollectionFieldRules where " +
		...
		{
			string strSQL = "delete from CollectionFieldRules where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(CollectionFieldRulesEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update CollectionFieldRules SET "+
			"ItemID = @ItemID,"+
			"FieldName = @FieldName,"+
			"FieldType = @FieldType,"+
			"RuleType = @RuleType,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(CollectionFieldRulesEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update CollectionFieldRules SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update CollectionFieldRules SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public CollectionFieldRulesEntity GetEntity(System.Int32 fieldRuleID)
		{
			string strCondition = string.Empty;
			strCondition += " and FieldRuleID = @FieldRuleID";
		...
		/// </summary>
		/// <returns></returns>
		public async Task<CollectionFieldRulesEntity> GetEntityAsync(System.Int32 fieldRuleID)
		{
			string strCondition = string.Empty;
			strCondition += " and FieldRuleID = @FieldRuleID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual CollectionFieldRulesEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			CollectionFieldRulesEntity obj = null;
			string strSQL = "select top 1 * from CollectionFieldRules where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<CollectionFieldRulesEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			CollectionFieldRulesEntity obj = null;
			string strSQL = "select top 1 * from CollectionFieldRules where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<CollectionFieldRulesEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<CollectionFieldRulesEntity> list = new List<CollectionFieldRulesEntity>();
			string strSQL = "select * from CollectionFieldRules where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<CollectionFieldRulesEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<CollectionFieldRulesEntity> list = new List<CollectionFieldRulesEntity>();
			string strSQL = "select * from CollectionFieldRules where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from CollectionFieldRules where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<CollectionFieldRulesEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		public virtual IList<CollectionFieldRulesEntity> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			...
			{
				TableName = "CollectionFieldRules";
			}
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CollectionFieldRulesEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CollectionFieldRulesEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(CollectionFieldRulesEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("FieldRuleID", entity.FieldRuleID);
			dict.Add("ItemID", entity.ItemID);
			dict.Add("FieldName", entity.FieldName);
			dict.Add("FieldType", entity.FieldType);
			dict.Add("RuleType", entity.RuleType);
			dict.Add("BeginCode", entity.BeginCode);
			dict.Add("EndCode", entity.EndCode);
			dict.Add("PrivateFilter", entity.PrivateFilter);
			dict.Add("FilterRuleID", entity.FilterRuleID);
			dict.Add("IsUsePaging", entity.IsUsePaging);
			dict.Add("SpecialSetting", entity.SpecialSetting);
		...
		/// <returns></returns>
		private static CollectionFieldRulesEntity GetEntityFromrdr(NullableDataReader rdr)
		{
			CollectionFieldRulesEntity info = new CollectionFieldRulesEntity();
