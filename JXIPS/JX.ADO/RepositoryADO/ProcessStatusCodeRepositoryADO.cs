...
{
	/// <summary>
	/// 数据库表：ProcessStatusCode 的仓储实现类.
	/// </summary>
	public partial class ProcessStatusCodeRepositoryADO : IProcessStatusCodeRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		{
			string strSQL = "select " + statistic + " from ProcessStatusCode where 1=1 ";
		...
		{
			return _DB.GetMaxID("ProcessStatusCode", "FlowID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("ProcessStatusCode", "FlowID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(ProcessStatusCodeEntity entity)
		{
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into ProcessStatusCode ("+
							"FlowID,"+
							"ProcessID,"+
							"StatusCode) "+
							"values("+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(ProcessStatusCodeEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(ProcessStatusCodeEntity entity)
		{
			...
			{
				return DataConverter.CLng(entity.FlowID);
			}
			return -1;
		}
		/// <summary>
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(ProcessStatusCodeEntity entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(ProcessStatusCodeEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(ProcessStatusCodeEntity entity, bool IsSave)
		{
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.Int32 flowID, System.Int32 processID, System.Int32 statusCode)
		{
			string strSQL = "delete from ProcessStatusCode where " +
			...
			Dictionary<string, object> dict = new Dictionary<string, object>();
			dict.Add("FlowID", flowID);
			dict.Add("ProcessID", processID);
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 flowID, System.Int32 processID, System.Int32 statusCode)
		{
			string strSQL = "delete from ProcessStatusCode where " +
		...
		{
			string strSQL = "delete from ProcessStatusCode where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(ProcessStatusCodeEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update ProcessStatusCode SET "+
			" WHERE "+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(ProcessStatusCodeEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update ProcessStatusCode SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update ProcessStatusCode SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public ProcessStatusCodeEntity GetEntity(System.Int32 flowID, System.Int32 processID, System.Int32 statusCode)
		{
			string strCondition = string.Empty;
			strCondition += " and FlowID = @FlowID";
			strCondition += " and ProcessID = @ProcessID";
			strCondition += " and StatusCode = @StatusCode";
		...
		/// </summary>
		/// <returns></returns>
		public async Task<ProcessStatusCodeEntity> GetEntityAsync(System.Int32 flowID, System.Int32 processID, System.Int32 statusCode)
		{
			string strCondition = string.Empty;
			strCondition += " and FlowID = @FlowID";
			strCondition += " and ProcessID = @ProcessID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual ProcessStatusCodeEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			ProcessStatusCodeEntity obj = null;
			string strSQL = "select top 1 * from ProcessStatusCode where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<ProcessStatusCodeEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			ProcessStatusCodeEntity obj = null;
			string strSQL = "select top 1 * from ProcessStatusCode where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<ProcessStatusCodeEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<ProcessStatusCodeEntity> list = new List<ProcessStatusCodeEntity>();
			string strSQL = "select * from ProcessStatusCode where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<ProcessStatusCodeEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<ProcessStatusCodeEntity> list = new List<ProcessStatusCodeEntity>();
			string strSQL = "select * from ProcessStatusCode where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from ProcessStatusCode where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<ProcessStatusCodeEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ProcessStatusCodeEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ProcessStatusCodeEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(ProcessStatusCodeEntity entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static ProcessStatusCodeEntity GetEntityFromrdr(NullableDataReader rdr)
		{
			ProcessStatusCodeEntity info = new ProcessStatusCodeEntity();
