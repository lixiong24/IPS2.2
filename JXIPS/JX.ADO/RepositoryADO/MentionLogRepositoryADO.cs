...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class MentionLogRepositoryADO : IMentionLogRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public MentionLogRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from MentionLog where 1=1 ";
		...
		{
			return _DB.GetMaxID("MentionLog", "ID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("MentionLog", "ID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(MentionLogEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(MentionLogEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(MentionLogEntity entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(MentionLogEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(MentionLogEntity entity, bool IsSave)
		{
		...
		{
			string strSQL = "delete from MentionLog where " +
		...
		{
			string strSQL = "delete from MentionLog where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(MentionLogEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update MentionLog SET "+
			"Applicant = @Applicant,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(MentionLogEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update MentionLog SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update MentionLog SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public MentionLogEntity GetEntity(System.Int32 id)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<MentionLogEntity> GetEntityAsync(System.Int32 id)
		{
			string strCondition = string.Empty;
			strCondition += " and ID = @ID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual MentionLogEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			MentionLogEntity obj = null;
			string strSQL = "select top 1 * from MentionLog where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<MentionLogEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			MentionLogEntity obj = null;
			string strSQL = "select top 1 * from MentionLog where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<MentionLogEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<MentionLogEntity> list = new List<MentionLogEntity>();
			string strSQL = "select * from MentionLog where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<MentionLogEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<MentionLogEntity> list = new List<MentionLogEntity>();
			string strSQL = "select * from MentionLog where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from MentionLog where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<MentionLogEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<MentionLogEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<MentionLogEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(MentionLogEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("ID", entity.ID);
			dict.Add("Applicant", entity.Applicant);
			dict.Add("ApplicationTime", entity.ApplicationTime);
			dict.Add("ApplicationAmount", entity.ApplicationAmount);
			dict.Add("HandlingCharge", entity.HandlingCharge);
			dict.Add("BankAccount", entity.BankAccount);
			dict.Add("MentionStatus", entity.MentionStatus);
			dict.Add("Operator", entity.Operator);
			dict.Add("OperatingTime", entity.OperatingTime);
