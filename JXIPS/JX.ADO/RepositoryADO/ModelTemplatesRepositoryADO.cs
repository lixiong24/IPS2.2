...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class ModelTemplatesRepositoryADO : IModelTemplatesRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public ModelTemplatesRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from ModelTemplates where 1=1 ";
		...
		{
			return _DB.GetMaxID("ModelTemplates", "TemplateID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("ModelTemplates", "TemplateID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(ModelTemplatesEntity entity)
		{
			if(entity.TemplateID <= 0) entity.TemplateID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into ModelTemplates ("+
							"TemplateID,"+
							"TemplateName,"+
							"TemplateDescription,"+
							"Field,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(ModelTemplatesEntity entity)
		{
			if(entity.TemplateID <= 0) entity.TemplateID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(ModelTemplatesEntity entity)
		{
			if(entity.TemplateID <= 0) entity.TemplateID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
			...
			{
				return DataConverter.CLng(entity.TemplateID);
			}
			return -1;
		}
		/// <summary>
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(ModelTemplatesEntity entity)
		{
			if(entity.TemplateID <= 0) entity.TemplateID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(ModelTemplatesEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(ModelTemplatesEntity entity, bool IsSave)
		{
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.Int32 templateID)
		{
			string strSQL = "delete from ModelTemplates where " +
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 templateID)
		{
			string strSQL = "delete from ModelTemplates where " +
		...
		{
			string strSQL = "delete from ModelTemplates where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(ModelTemplatesEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update ModelTemplates SET "+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(ModelTemplatesEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update ModelTemplates SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update ModelTemplates SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public ModelTemplatesEntity GetEntity(System.Int32 templateID)
		{
			string strCondition = string.Empty;
			strCondition += " and TemplateID = @TemplateID";
		...
		/// </summary>
		/// <returns></returns>
		public async Task<ModelTemplatesEntity> GetEntityAsync(System.Int32 templateID)
		{
			string strCondition = string.Empty;
			strCondition += " and TemplateID = @TemplateID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual ModelTemplatesEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			ModelTemplatesEntity obj = null;
			string strSQL = "select top 1 * from ModelTemplates where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<ModelTemplatesEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			ModelTemplatesEntity obj = null;
			string strSQL = "select top 1 * from ModelTemplates where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<ModelTemplatesEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<ModelTemplatesEntity> list = new List<ModelTemplatesEntity>();
			string strSQL = "select * from ModelTemplates where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<ModelTemplatesEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<ModelTemplatesEntity> list = new List<ModelTemplatesEntity>();
			string strSQL = "select * from ModelTemplates where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from ModelTemplates where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<ModelTemplatesEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ModelTemplatesEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ModelTemplatesEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(ModelTemplatesEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("TemplateID", entity.TemplateID);
			dict.Add("TemplateName", entity.TemplateName);
			dict.Add("TemplateDescription", entity.TemplateDescription);
			dict.Add("Field", entity.Field);
			dict.Add("IsEshop", entity.IsEshop);
		}
		/// <summary>
		/// 通过数据读取器生成实体类
		/// </summary>
		...
		/// <returns></returns>
		private static ModelTemplatesEntity GetEntityFromrdr(NullableDataReader rdr)
		{
			ModelTemplatesEntity info = new ModelTemplatesEntity();
