...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class U_QuestionRepositoryADO : IU_QuestionRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public U_QuestionRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from U_Question where 1=1 ";
		...
		{
			return _DB.GetMaxID("U_Question", "ID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("U_Question", "ID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(U_QuestionEntity entity)
		{
			if(entity.ID <= 0) entity.ID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into U_Question ("+
							"ID,"+
							"ProblemState,"+
							"SolveProblemTime,"+
							"ProblemDesc) "+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(U_QuestionEntity entity)
		{
			if(entity.ID <= 0) entity.ID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(U_QuestionEntity entity)
		{
			if(entity.ID <= 0) entity.ID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(U_QuestionEntity entity)
		{
			if(entity.ID <= 0) entity.ID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(U_QuestionEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(U_QuestionEntity entity, bool IsSave)
		{
		...
		{
			string strSQL = "delete from U_Question where " +
		...
		{
			string strSQL = "delete from U_Question where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(U_QuestionEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update U_Question SET "+
			"ProblemState = @ProblemState,"+
			"SolveProblemTime = @SolveProblemTime,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(U_QuestionEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update U_Question SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update U_Question SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public U_QuestionEntity GetEntity(System.Int32 id)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<U_QuestionEntity> GetEntityAsync(System.Int32 id)
		{
			string strCondition = string.Empty;
			strCondition += " and ID = @ID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual U_QuestionEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			U_QuestionEntity obj = null;
			string strSQL = "select top 1 * from U_Question where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<U_QuestionEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			U_QuestionEntity obj = null;
			string strSQL = "select top 1 * from U_Question where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<U_QuestionEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<U_QuestionEntity> list = new List<U_QuestionEntity>();
			string strSQL = "select * from U_Question where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<U_QuestionEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<U_QuestionEntity> list = new List<U_QuestionEntity>();
			string strSQL = "select * from U_Question where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from U_Question where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<U_QuestionEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<U_QuestionEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<U_QuestionEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(U_QuestionEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("ID", entity.ID);
			dict.Add("ProblemState", entity.ProblemState);
			dict.Add("SolveProblemTime", entity.SolveProblemTime);
			dict.Add("ProblemDesc", entity.ProblemDesc);
		}
		/// <summary>
		/// 通过数据读取器生成实体类
		/// </summary>
		...
		/// <returns></returns>
		private static U_QuestionEntity GetEntityFromrdr(NullableDataReader rdr)
		{
			U_QuestionEntity info = new U_QuestionEntity();
			info.ID = rdr.GetInt32("ID");
			info.ProblemState = rdr.GetString("ProblemState");
			info.SolveProblemTime = rdr.GetNullableDateTime("SolveProblemTime");
			info.ProblemDesc = rdr.GetString("ProblemDesc");
			return info;
		}
		#endregion
	}
