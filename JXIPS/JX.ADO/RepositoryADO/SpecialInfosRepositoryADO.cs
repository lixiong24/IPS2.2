...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class SpecialInfosRepositoryADO : ISpecialInfosRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public SpecialInfosRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from SpecialInfos where 1=1 ";
		...
		{
			return _DB.GetMaxID("SpecialInfos", "SpecialInfoID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("SpecialInfos", "SpecialInfoID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(SpecialInfosEntity entity)
		{
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into SpecialInfos ("+
							"SpecialInfoID,"+
							"SpecialID,"+
							"GeneralID) "+
							"values("+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(SpecialInfosEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(SpecialInfosEntity entity)
		{
			...
			{
				return DataConverter.CLng(entity.SpecialInfoID);
			}
			return -1;
		}
		/// <summary>
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(SpecialInfosEntity entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(SpecialInfosEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(SpecialInfosEntity entity, bool IsSave)
		{
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.Int32 specialInfoID, System.Int32 specialID, System.Int32 generalID)
		{
			string strSQL = "delete from SpecialInfos where " +
			
			"SpecialInfoID = @SpecialInfoID"+
			" AND "+
			"SpecialID = @SpecialID"+
			" AND "+
			"GeneralID = @GeneralID"; 
			...
			Dictionary<string, object> dict = new Dictionary<string, object>();
			dict.Add("SpecialInfoID", specialInfoID);
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 specialInfoID, System.Int32 specialID, System.Int32 generalID)
		{
			string strSQL = "delete from SpecialInfos where " +
		...
		{
			string strSQL = "delete from SpecialInfos where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(SpecialInfosEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update SpecialInfos SET "+
			" WHERE "+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(SpecialInfosEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update SpecialInfos SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update SpecialInfos SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public SpecialInfosEntity GetEntity(System.Int32 specialInfoID, System.Int32 specialID, System.Int32 generalID)
		{
			string strCondition = string.Empty;
			strCondition += " and SpecialInfoID = @SpecialInfoID";
		...
		/// </summary>
		/// <returns></returns>
		public async Task<SpecialInfosEntity> GetEntityAsync(System.Int32 specialInfoID, System.Int32 specialID, System.Int32 generalID)
		{
			string strCondition = string.Empty;
			strCondition += " and SpecialInfoID = @SpecialInfoID";
			strCondition += " and SpecialID = @SpecialID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual SpecialInfosEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			SpecialInfosEntity obj = null;
			string strSQL = "select top 1 * from SpecialInfos where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<SpecialInfosEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			SpecialInfosEntity obj = null;
			string strSQL = "select top 1 * from SpecialInfos where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<SpecialInfosEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<SpecialInfosEntity> list = new List<SpecialInfosEntity>();
			string strSQL = "select * from SpecialInfos where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<SpecialInfosEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<SpecialInfosEntity> list = new List<SpecialInfosEntity>();
			string strSQL = "select * from SpecialInfos where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from SpecialInfos where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<SpecialInfosEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<SpecialInfosEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<SpecialInfosEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(SpecialInfosEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("SpecialInfoID", entity.SpecialInfoID);
		...
		/// <returns></returns>
		private static SpecialInfosEntity GetEntityFromrdr(NullableDataReader rdr)
		{
			SpecialInfosEntity info = new SpecialInfosEntity();
