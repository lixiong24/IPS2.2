...
namespace JX.ADO
{
	...
	/// 数据库表：StatIp 的仓储实现类.
	/// </summary>
	public partial class StatIpRepositoryADO : IStatIpRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public StatIpRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from StatIp where 1=1 ";
		...
		{
			return _DB.GetMaxID("StatIp", "TIp");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("StatIp", "TIp"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(StatIpEntity entity)
		{
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into StatIp ("+
							"TIp,"+
							"TIpNum) "+
							"values("+
							"@TIp,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(StatIpEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(StatIpEntity entity)
		{
			...
			{
				return DataConverter.CLng(entity.TIp);
			}
			return -1;
		}
		/// <summary>
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(StatIpEntity entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(StatIpEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(StatIpEntity entity, bool IsSave)
		{
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.String tIp)
		{
			string strSQL = "delete from StatIp where " +
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.String tIp)
		{
			string strSQL = "delete from StatIp where " +
		...
		{
			string strSQL = "delete from StatIp where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(StatIpEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update StatIp SET "+
			"TIpNum = @TIpNum"+
			" WHERE "+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(StatIpEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update StatIp SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update StatIp SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public StatIpEntity GetEntity(System.String tIp)
		{
			string strCondition = string.Empty;
			strCondition += " and TIp = @TIp";
		...
		/// </summary>
		/// <returns></returns>
		public async Task<StatIpEntity> GetEntityAsync(System.String tIp)
		{
			string strCondition = string.Empty;
			strCondition += " and TIp = @TIp";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual StatIpEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			StatIpEntity obj = null;
			string strSQL = "select top 1 * from StatIp where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<StatIpEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			StatIpEntity obj = null;
			string strSQL = "select top 1 * from StatIp where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<StatIpEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<StatIpEntity> list = new List<StatIpEntity>();
			string strSQL = "select * from StatIp where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<StatIpEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<StatIpEntity> list = new List<StatIpEntity>();
			string strSQL = "select * from StatIp where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from StatIp where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<StatIpEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatIpEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatIpEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(StatIpEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("TIp", entity.TIp);
			dict.Add("TIpNum", entity.TIpNum);
		}
		/// <summary>
		/// 通过数据读取器生成实体类
		/// </summary>
