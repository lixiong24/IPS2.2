...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class StatSystemRepositoryADO : IStatSystemRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public StatSystemRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from StatSystem where 1=1 ";
		...
		{
			return _DB.GetMaxID("StatSystem", "TSystem");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("StatSystem", "TSystem"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(StatSystemEntity entity)
		{
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into StatSystem ("+
							"TSystem,"+
							"TSysNum) "+
							"values("+
							"@TSystem,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(StatSystemEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(StatSystemEntity entity)
		{
			...
			{
				return DataConverter.CLng(entity.TSystem);
			}
			return -1;
		}
		/// <summary>
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(StatSystemEntity entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(StatSystemEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(StatSystemEntity entity, bool IsSave)
		{
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.String tSystem)
		{
			string strSQL = "delete from StatSystem where " +
			
			"TSystem = @TSystem"; 
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			dict.Add("TSystem", tSystem);
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.String tSystem)
		{
			string strSQL = "delete from StatSystem where " +
		...
		{
			string strSQL = "delete from StatSystem where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(StatSystemEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update StatSystem SET "+
			"TSysNum = @TSysNum"+
			" WHERE "+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(StatSystemEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update StatSystem SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update StatSystem SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public StatSystemEntity GetEntity(System.String tSystem)
		{
			string strCondition = string.Empty;
			strCondition += " and TSystem = @TSystem";
		...
		/// </summary>
		/// <returns></returns>
		public async Task<StatSystemEntity> GetEntityAsync(System.String tSystem)
		{
			string strCondition = string.Empty;
			strCondition += " and TSystem = @TSystem";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual StatSystemEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			StatSystemEntity obj = null;
			string strSQL = "select top 1 * from StatSystem where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<StatSystemEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			StatSystemEntity obj = null;
			string strSQL = "select top 1 * from StatSystem where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<StatSystemEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<StatSystemEntity> list = new List<StatSystemEntity>();
			string strSQL = "select * from StatSystem where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<StatSystemEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<StatSystemEntity> list = new List<StatSystemEntity>();
			string strSQL = "select * from StatSystem where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from StatSystem where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<StatSystemEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatSystemEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatSystemEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(StatSystemEntity entity, Dictionary<string, object> dict)
		{
			dict.Add("TSystem", entity.TSystem);
			dict.Add("TSysNum", entity.TSysNum);
		}
		/// <summary>
		/// 通过数据读取器生成实体类
		/// </summary>
		...
		/// <returns></returns>
		private static StatSystemEntity GetEntityFromrdr(NullableDataReader rdr)
		{
			StatSystemEntity info = new StatSystemEntity();
			info.TSystem = rdr.GetString("TSystem");
			info.TSysNum = rdr.GetInt32("TSysNum");
			return info;
		}
		#endregion
	}
