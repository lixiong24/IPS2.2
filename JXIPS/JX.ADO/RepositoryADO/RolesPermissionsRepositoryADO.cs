...
namespace JX.ADO
{
	...
	public partial class RolesPermissionsRepositoryADO : IRolesPermissionsRepositoryADO
	{
		...
		/// </summary>
		/// <param name="DB"></param>
		public RolesPermissionsRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from RolesPermissions where 1=1 ";
		...
		{
			return _DB.GetMaxID("RolesPermissions", "RoleID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("RolesPermissions", "RoleID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(RolesPermissionsEntity entity)
		{
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);

			string strSQL = "insert into RolesPermissions ("+
							"RoleID,"+
							"OperateCode) "+
							"values("+
							"@RoleID,"+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(RolesPermissionsEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(RolesPermissionsEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(RolesPermissionsEntity entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(RolesPermissionsEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(RolesPermissionsEntity entity, bool IsSave)
		{
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.Int32 roleID, System.String operateCode)
		{
			string strSQL = "delete from RolesPermissions where " +
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 roleID, System.String operateCode)
		{
			string strSQL = "delete from RolesPermissions where " +
		...
		{
			string strSQL = "delete from RolesPermissions where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(RolesPermissionsEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update RolesPermissions SET "+
			" WHERE "+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(RolesPermissionsEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update RolesPermissions SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update RolesPermissions SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public RolesPermissionsEntity GetEntity(System.Int32 roleID, System.String operateCode)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<RolesPermissionsEntity> GetEntityAsync(System.Int32 roleID, System.String operateCode)
		{
			string strCondition = string.Empty;
			strCondition += " and RoleID = @RoleID";
			strCondition += " and OperateCode = @OperateCode";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual RolesPermissionsEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			RolesPermissionsEntity obj = null;
			string strSQL = "select top 1 * from RolesPermissions where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<RolesPermissionsEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			RolesPermissionsEntity obj = null;
			string strSQL = "select top 1 * from RolesPermissions where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<RolesPermissionsEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<RolesPermissionsEntity> list = new List<RolesPermissionsEntity>();
			string strSQL = "select * from RolesPermissions where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<RolesPermissionsEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<RolesPermissionsEntity> list = new List<RolesPermissionsEntity>();
			string strSQL = "select * from RolesPermissions where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from RolesPermissions where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<RolesPermissionsEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<RolesPermissionsEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<RolesPermissionsEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(RolesPermissionsEntity entity, Dictionary<string, object> dict)
		{
