...
namespace JX.ADO
{
	...
	public partial class CollectionPagingRulesRepositoryADO : ICollectionPagingRulesRepositoryADO
	{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(CollectionPagingRulesEntity entity)
		{
			if(entity.PagingRuleID <= 0) entity.PagingRuleID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(CollectionPagingRulesEntity entity)
		{
			if(entity.PagingRuleID <= 0) entity.PagingRuleID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(CollectionPagingRulesEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// </summary>
		/// <returns></returns>
		public CollectionPagingRulesEntity GetEntity(System.Int32 pagingRuleID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<CollectionPagingRulesEntity> GetEntityAsync(System.Int32 pagingRuleID)
		{
			string strCondition = string.Empty;
			strCondition += " and PagingRuleID = @PagingRuleID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual CollectionPagingRulesEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<CollectionPagingRulesEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<CollectionPagingRulesEntity> list = new List<CollectionPagingRulesEntity>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<CollectionPagingRulesEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<CollectionPagingRulesEntity> list = new List<CollectionPagingRulesEntity>();
			string strSQL = "select * from CollectionPagingRules where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<CollectionPagingRulesEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CollectionPagingRulesEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CollectionPagingRulesEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
