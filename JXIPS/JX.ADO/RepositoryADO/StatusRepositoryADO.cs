...
namespace JX.ADO
{
	...
	/// 数据库表：Status 的仓储实现类.
	/// </summary>
	public partial class StatusRepositoryADO : IStatusRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public StatusRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from Status where 1=1 ";
		...
		{
			return _DB.GetMaxID("Status", "StatusID");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("Status", "StatusID"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(StatusEntity entity)
		{
			if(entity.StatusID <= 0) entity.StatusID=GetNewID();
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(StatusEntity entity)
		{
			if(entity.StatusID <= 0) entity.StatusID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(StatusEntity entity)
		{
			if(entity.StatusID <= 0) entity.StatusID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(StatusEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(StatusEntity entity, bool IsSave)
		{
		...
		/// </summary>
		/// <returns></returns>
		public bool Delete(System.Int32 statusID)
		{
			string strSQL = "delete from Status where " +
			
			"StatusID = @StatusID"; 
			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			dict.Add("StatusID", statusID);
		...
		/// </summary>
		/// <returns></returns>
		public async Task<bool> DeleteAsync(System.Int32 statusID)
		{
			string strSQL = "delete from Status where " +
		...
		{
			string strSQL = "delete from Status where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update Status SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public StatusEntity GetEntity(System.Int32 statusID)
		{
			string strCondition = string.Empty;
			strCondition += " and StatusID = @StatusID";
		...
		/// </summary>
		/// <returns></returns>
		public async Task<StatusEntity> GetEntityAsync(System.Int32 statusID)
		{
			string strCondition = string.Empty;
			strCondition += " and StatusID = @StatusID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<StatusEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<StatusEntity> list = new List<StatusEntity>();
			string strSQL = "select * from Status where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<StatusEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<StatusEntity> list = new List<StatusEntity>();
			string strSQL = "select * from Status where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from Status where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<StatusEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatusEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatusEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
