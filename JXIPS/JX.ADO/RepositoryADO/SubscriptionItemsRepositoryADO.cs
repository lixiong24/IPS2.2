...
namespace JX.ADO
{
	...
	/// </summary>
	public partial class SubscriptionItemsRepositoryADO : ISubscriptionItemsRepositoryADO
	{
		#region 数据上下文
		/// <summary>
		/// 数据上下文
		...
		/// </summary>
		/// <param name="DB"></param>
		public SubscriptionItemsRepositoryADO(IDBOperator DB)
		{
			_DB = DB;
		}
		#endregion
		...
		{
			string strSQL = "select " + statistic + " from SubscriptionItems where 1=1 ";
		...
		{
			return _DB.GetMaxID("SubscriptionItems", "Id");
		}
		/// <summary>
		...
		{
			return await Task.Run(() => _DB.GetMaxID("SubscriptionItems", "Id"));
		}
		...
		/// <returns></returns>
		public virtual bool Add(SubscriptionItemsEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(SubscriptionItemsEntity entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(SubscriptionItemsEntity entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(SubscriptionItemsEntity entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(SubscriptionItemsEntity entity, bool IsSave)
		{
		...
		{
			string strSQL = "delete from SubscriptionItems where " +
		...
		{
			string strSQL = "delete from SubscriptionItems where 1=1 " + strWhere;
			return _DB.ExeSQLResult(strSQL, dict);
		}
		/// <summary>
		/// 删除一条或多条记录（异步方式）
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(SubscriptionItemsEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update SubscriptionItems SET "+
			"Name = @Name"+
			" WHERE "+
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(SubscriptionItemsEntity entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update SubscriptionItems SET "+
		...
		public virtual bool Update(string strColumns, Dictionary<string, object> dictColumns = null, string strWhere = "", Dictionary<string, object> dictWhere = null)
		{
			...
			string strSQL = "Update SubscriptionItems SET " + strColumns + " where 1=1 " + strWhere;
		...
		/// </summary>
		/// <returns></returns>
		public SubscriptionItemsEntity GetEntity(System.Int32 id)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<SubscriptionItemsEntity> GetEntityAsync(System.Int32 id)
		{
			string strCondition = string.Empty;
			strCondition += " and Id = @Id";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual SubscriptionItemsEntity GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			SubscriptionItemsEntity obj = null;
			string strSQL = "select top 1 * from SubscriptionItems where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<SubscriptionItemsEntity> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			SubscriptionItemsEntity obj = null;
			string strSQL = "select top 1 * from SubscriptionItems where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<SubscriptionItemsEntity> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<SubscriptionItemsEntity> list = new List<SubscriptionItemsEntity>();
			string strSQL = "select * from SubscriptionItems where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<SubscriptionItemsEntity>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<SubscriptionItemsEntity> list = new List<SubscriptionItemsEntity>();
			string strSQL = "select * from SubscriptionItems where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		{
			string strSQL = "select " + strExtended + " from SubscriptionItems where 1=1 ";
			if(!string.IsNullOrEmpty(strWhere))
			{
				strSQL += strWhere;
			}
		...
		/// <returns></returns>
		public IList<SubscriptionItemsEntity> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<SubscriptionItemsEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<SubscriptionItemsEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		private static void GetParameters(SubscriptionItemsEntity entity, Dictionary<string, object> dict)
		{
