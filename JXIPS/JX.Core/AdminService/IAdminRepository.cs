...
namespace JX.Core
{
	...
	/// 数据库表：Admin 的仓储接口.
	/// </summary>
	public partial interface IAdminRepository : IRepository<AdminEntity>
	{
		#region 是否存在
		/// <summary>
		/// 检查用户名是否存在
		...
		/// <returns></returns>
		AdminEntity GetEntityFull(Expression<Func<AdminEntity, bool>> predicate);
		/// <summary>
		/// 获取实体，包括扩展属性（异步方式）
		/// </summary>
		/// <param name="predicate"></param>
		/// <returns></returns>
		Task<AdminEntity> GetEntityFullAsync(Expression<Func<AdminEntity, bool>> predicate);
		/// <summary>
		...
		/// <param name="predicate"></param>
		/// <returns></returns>
		IList<AdminEntity> GetEntityFullList(Expression<Func<AdminEntity, bool>> predicate);
		/// <summary>
		/// 得到实体列表，包括扩展属性（异步方式）
		/// </summary>
		/// <param name="predicate"></param>
		/// <returns></returns>
		Task<IList<AdminEntity>> GetEntityFullListAsync(Expression<Func<AdminEntity, bool>> predicate);
		#endregion
