...
namespace JX.Core
{
	...
	public partial interface IRoleSpecialPermissionsRepositoryADO : IRepositoryADO<RoleSpecialPermissionsEntity>
	{
		...
		/// </summary>
		/// <returns></returns>
		RoleSpecialPermissionsEntity GetEntity(System.Int32 roleID, System.Int32 specialID, System.String operateCode);
		/// <summary>
		/// 通过主键返回第一条信息的实体类。
		/// </summary>
		/// <returns></returns>
		Task<RoleSpecialPermissionsEntity> GetEntityAsync(System.Int32 roleID, System.Int32 specialID, System.String operateCode);
	}
}