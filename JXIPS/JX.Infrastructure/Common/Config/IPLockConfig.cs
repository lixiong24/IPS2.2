...
namespace JX.Infrastructure.Common
{
	...
	public class IPLockConfig
    {
		...
		public string AdminLockIPType { get; set; } = string.Empty;
		
		/// <summary>
		/// 后台IP黑名单
		/// </summary>
		[DisplayFormat(ConvertEmptyStringToNull = false)]
		public string AdminLockIPBlack { get; set; } = string.Empty;

		/// <summary>
		/// 后台IP白名单
		/// </summary>
		[DisplayFormat(ConvertEmptyStringToNull = false)]
		public string AdminLockIPWhite { get; set; } = string.Empty;
		...
		/// </summary>
		[DisplayFormat(ConvertEmptyStringToNull = false)]
		public string LockIPType { get; set; } = string.Empty;

		/// <summary>
		/// 全站IP黑名单
		/// </summary>
		[DisplayFormat(ConvertEmptyStringToNull = false)]
		public string LockIPBlack { get; set; } = string.Empty;

		/// <summary>
		/// 全站IP白名单
		/// </summary>
		[DisplayFormat(ConvertEmptyStringToNull = false)]
		public string LockIPWhite { get; set; } = string.Empty;
	}
}
