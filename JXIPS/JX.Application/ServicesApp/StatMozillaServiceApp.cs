...
namespace JX.Application
{
	...
	public partial class StatMozillaServiceApp : IStatMozillaServiceApp
	{
		...
		/// <param name="para"></param>
		/// <returns></returns>
		public virtual TResult GetBySQL<TResult>(string sql, Expression<Func<StatMozillaEntity, TResult>> scalar, params DbParameter[] para)
		{
		...
		/// <param name="para"></param>
		/// <returns></returns>
		public virtual async Task<TResult> GetBySQLAsync<TResult>(string sql, Expression<Func<StatMozillaEntity, TResult>> scalar, params DbParameter[] para)
		{
