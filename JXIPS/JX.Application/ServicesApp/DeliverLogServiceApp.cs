...
{
	/// <summary>
	/// 数据库表：DeliverLog 的应用层服务接口实现类.
	/// </summary>
	public partial class DeliverLogServiceApp : IDeliverLogServiceApp
	{
		#region 仓储接口
		private readonly IDeliverLogRepository _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public DeliverLogServiceApp(IDeliverLogRepository repository)
		{
		...
		/// <returns></returns>
		public virtual TResult GetScalar<TResult, TOrderBy>(Expression<Func<DeliverLogEntity, TResult>> scalar, Expression<Func<DeliverLogEntity, bool>> predicate = null, Expression<Func<DeliverLogEntity, TOrderBy>> orderby = null, bool IsAsc = true)
		{
		...
		/// <param name="IsAsc">排序方向，true为正序false为倒序</param>
		/// <returns></returns>
		public virtual async Task<TResult> GetScalarAsync<TResult, TOrderBy>(Expression<Func<DeliverLogEntity, TResult>> scalar, Expression<Func<DeliverLogEntity, bool>> predicate = null, Expression<Func<DeliverLogEntity, TOrderBy>> orderby = null, bool IsAsc = true)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual TResult GetMax<TResult>(Expression<Func<DeliverLogEntity, TResult>> max, Expression<Func<DeliverLogEntity, bool>> predicate = null)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual async Task<TResult> GetMaxAsync<TResult>(Expression<Func<DeliverLogEntity, TResult>> max, Expression<Func<DeliverLogEntity, bool>> predicate = null)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual TResult GetMin<TResult>(Expression<Func<DeliverLogEntity, TResult>> min, Expression<Func<DeliverLogEntity, bool>> predicate = null)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual async Task<TResult> GetMinAsync<TResult>(Expression<Func<DeliverLogEntity, TResult>> min, Expression<Func<DeliverLogEntity, bool>> predicate = null)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual decimal GetAvg(Expression<Func<DeliverLogEntity, decimal>> avg, Expression<Func<DeliverLogEntity, bool>> predicate = null)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual async Task<decimal> GetAvgAsync(Expression<Func<DeliverLogEntity, decimal>> avg, Expression<Func<DeliverLogEntity, bool>> predicate = null)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual decimal GetSum(Expression<Func<DeliverLogEntity, decimal>> sum, Expression<Func<DeliverLogEntity, bool>> predicate = null)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual async Task<decimal> GetSumAsync(Expression<Func<DeliverLogEntity, decimal>> sum, Expression<Func<DeliverLogEntity, bool>> predicate = null)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual int GetCount(Expression<Func<DeliverLogEntity, bool>> predicate = null)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual async Task<int> GetCountAsync(Expression<Func<DeliverLogEntity, bool>> predicate = null)
		{
		...
		/// 验证当前条件是否存在相同项
		/// </summary>
		public virtual bool IsExist(Expression<Func<DeliverLogEntity, bool>> predicate)
		{
		...
		/// 验证当前条件是否存在相同项（异步方式）
		/// </summary>
		public virtual async Task<bool> IsExistAsync(Expression<Func<DeliverLogEntity, bool>> predicate)
		{
		...
		/// <returns></returns>
		public virtual bool Add(DeliverLogEntity entity, bool IsCommit = true)
		{
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(DeliverLogEntity entity, bool IsCommit = true)
		{
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual bool AddList(IList<DeliverLogEntity> entityList, bool IsCommit = true)
		{
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual async Task<bool> AddListAsync(IList<DeliverLogEntity> entityList, bool IsCommit = true)
		{
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual bool AddOrUpdate(DeliverLogEntity entity, bool IsSave, bool IsCommit = true)
		{
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(DeliverLogEntity entity, bool IsSave, bool IsCommit = true)
		{
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual bool Delete(DeliverLogEntity entity, bool IsCommit = true)
		{
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual async Task<bool> DeleteAsync(DeliverLogEntity entity, bool IsCommit = true)
		{
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual bool DeleteList(IList<DeliverLogEntity> entityList, bool IsCommit = true)
		{
			if (entityList == null || entityList.Count == 0) return false;
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual async Task<bool> DeleteListAsync(IList<DeliverLogEntity> entityList, bool IsCommit = true)
		{
			if (entityList == null || entityList.Count == 0) return await Task.Run(() => false);
		...
		/// <returns></returns>
		public virtual bool Delete(Expression<Func<DeliverLogEntity, bool>> predicate, bool IsCommit = true)
		{
		...
		/// <param name="IsCommit"></param>
		/// <returns></returns>
		public virtual async Task<bool> DeleteAsync(Expression<Func<DeliverLogEntity, bool>> predicate, bool IsCommit = true)
		{
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual bool Update(DeliverLogEntity entity, bool IsCommit = true)
		{
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(DeliverLogEntity entity, bool IsCommit = true)
		{
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual bool UpdateList(IList<DeliverLogEntity> entityList, bool IsCommit = true)
		{
			if (entityList == null || entityList.Count == 0) return false;
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateListAsync(IList<DeliverLogEntity> entityList, bool IsCommit = true)
		{
			if (entityList == null || entityList.Count == 0) return await Task.Run(() => false);
		...
		/// <returns></returns>
		public virtual DeliverLogEntity Get(Expression<Func<DeliverLogEntity, bool>> predicate)
		{
		...
		/// <param name="predicate">Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual async Task<DeliverLogEntity> GetAsync(Expression<Func<DeliverLogEntity, bool>> predicate)
		{
		...
		/// <returns></returns>
		public virtual IQueryable<DeliverLogEntity> LoadAll(Expression<Func<DeliverLogEntity, bool>> predicate, params SortModelField[] orderByExpression)
		{
		...
		/// <param name="orderByExpression">多字段排序</param>
		/// <returns></returns>
		public virtual async Task<IQueryable<DeliverLogEntity>> LoadAllAsync(Expression<Func<DeliverLogEntity, bool>> predicate, params SortModelField[] orderByExpression)
		{
		...
		/// <param name="orderByExpression">多字段排序</param>
		/// <returns></returns>
		public virtual List<DeliverLogEntity> LoadListAll(Expression<Func<DeliverLogEntity, bool>> predicate, params SortModelField[] orderByExpression)
		{
		...
		/// <param name="orderByExpression">多字段排序</param>
		/// <returns></returns>
		public virtual async Task<List<DeliverLogEntity>> LoadListAllAsync(Expression<Func<DeliverLogEntity, bool>> predicate, params SortModelField[] orderByExpression)
		{
		...
		/// <returns></returns>
		public virtual IQueryable<DeliverLogEntity> LoadAllBySql(string sql, params DbParameter[] para)
		{
		...
		/// <param name="para">Parameters参数</param>
		/// <returns></returns>
		public virtual async Task<IQueryable<DeliverLogEntity>> LoadAllBySqlAsync(string sql, params DbParameter[] para)
		{
		...
		/// <param name="para">Parameters参数</param>
		/// <returns></returns>
		public virtual List<DeliverLogEntity> LoadListAllBySql(string sql, params DbParameter[] para)
		{
		...
		/// <param name="para">Parameters参数</param>
		/// <returns></returns>
		public virtual async Task<List<DeliverLogEntity>> LoadListAllBySqlAsync(string sql, params DbParameter[] para)
		{
		...
		/// <returns></returns>
		public virtual IList<DeliverLogEntity> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			Total=0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<DeliverLogEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			Total=0;
		...
		/// <param name="para"></param>
		/// <returns></returns>
		public virtual TResult GetBySQL<TResult>(string sql, Expression<Func<DeliverLogEntity, TResult>> scalar, params IDataParameter[] para)
		{
		...
		/// <param name="para"></param>
		/// <returns></returns>
		public virtual async Task<TResult> GetBySQLAsync<TResult>(string sql, Expression<Func<DeliverLogEntity, TResult>> scalar, params IDataParameter[] para)
		{
		...
		/// <param name="paraValue"></param>
		/// <returns></returns>
		public virtual TResult GetBySQL<TResult>(string sql, Expression<Func<DeliverLogEntity, TResult>> scalar, string[] paraName, object[] paraValue)
		{
		...
		/// <param name="paraValue"></param>
		/// <returns></returns>
		public virtual async Task<TResult> GetBySQLAsync<TResult>(string sql, Expression<Func<DeliverLogEntity, TResult>> scalar, string[] paraName, object[] paraValue)
		{
		...
		/// <param name="dict"></param>
		/// <returns></returns>
		public virtual TResult GetBySQL<TResult>(string sql, Expression<Func<DeliverLogEntity, TResult>> scalar, Dictionary<string, object> dict)
		{
		...
		/// <param name="dict"></param>
		/// <returns></returns>
		public virtual async Task<TResult> GetBySQLAsync<TResult>(string sql, Expression<Func<DeliverLogEntity, TResult>> scalar, Dictionary<string, object> dict)
		{
