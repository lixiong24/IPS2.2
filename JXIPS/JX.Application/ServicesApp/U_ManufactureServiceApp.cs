...
namespace JX.Application
{
	...
	public partial class U_ManufactureServiceApp : IU_ManufactureServiceApp
	{
		...
		/// <param name="para"></param>
		/// <returns></returns>
		public virtual TResult GetBySQL<TResult>(string sql, Expression<Func<U_ManufactureEntity, TResult>> scalar, params DbParameter[] para)
		{
		...
		/// <param name="para"></param>
		/// <returns></returns>
		public virtual async Task<TResult> GetBySQLAsync<TResult>(string sql, Expression<Func<U_ManufactureEntity, TResult>> scalar, params DbParameter[] para)
		{
