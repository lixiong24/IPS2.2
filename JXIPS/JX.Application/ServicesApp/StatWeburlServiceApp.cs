...
{
	/// <summary>
	/// 数据库表：StatWeburl 的应用层服务接口实现类.
	/// </summary>
	public partial class StatWeburlServiceApp : IStatWeburlServiceApp
	{
		#region 仓储接口
		private readonly IStatWeburlRepository _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public StatWeburlServiceApp(IStatWeburlRepository repository)
		{
		...
		/// <returns></returns>
		public virtual TResult GetScalar<TResult, TOrderBy>(Expression<Func<StatWeburlEntity, TResult>> scalar, Expression<Func<StatWeburlEntity, bool>> predicate = null, Expression<Func<StatWeburlEntity, TOrderBy>> orderby = null, bool IsAsc = true)
		{
		...
		/// <param name="IsAsc">排序方向，true为正序false为倒序</param>
		/// <returns></returns>
		public virtual async Task<TResult> GetScalarAsync<TResult, TOrderBy>(Expression<Func<StatWeburlEntity, TResult>> scalar, Expression<Func<StatWeburlEntity, bool>> predicate = null, Expression<Func<StatWeburlEntity, TOrderBy>> orderby = null, bool IsAsc = true)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual TResult GetMax<TResult>(Expression<Func<StatWeburlEntity, TResult>> max, Expression<Func<StatWeburlEntity, bool>> predicate = null)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual async Task<TResult> GetMaxAsync<TResult>(Expression<Func<StatWeburlEntity, TResult>> max, Expression<Func<StatWeburlEntity, bool>> predicate = null)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual TResult GetMin<TResult>(Expression<Func<StatWeburlEntity, TResult>> min, Expression<Func<StatWeburlEntity, bool>> predicate = null)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual async Task<TResult> GetMinAsync<TResult>(Expression<Func<StatWeburlEntity, TResult>> min, Expression<Func<StatWeburlEntity, bool>> predicate = null)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual decimal GetAvg(Expression<Func<StatWeburlEntity, decimal>> avg, Expression<Func<StatWeburlEntity, bool>> predicate = null)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual async Task<decimal> GetAvgAsync(Expression<Func<StatWeburlEntity, decimal>> avg, Expression<Func<StatWeburlEntity, bool>> predicate = null)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual decimal GetSum(Expression<Func<StatWeburlEntity, decimal>> sum, Expression<Func<StatWeburlEntity, bool>> predicate = null)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual async Task<decimal> GetSumAsync(Expression<Func<StatWeburlEntity, decimal>> sum, Expression<Func<StatWeburlEntity, bool>> predicate = null)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual int GetCount(Expression<Func<StatWeburlEntity, bool>> predicate = null)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual async Task<int> GetCountAsync(Expression<Func<StatWeburlEntity, bool>> predicate = null)
		{
		...
		/// 验证当前条件是否存在相同项
		/// </summary>
		public virtual bool IsExist(Expression<Func<StatWeburlEntity, bool>> predicate)
		{
		...
		/// 验证当前条件是否存在相同项（异步方式）
		/// </summary>
		public virtual async Task<bool> IsExistAsync(Expression<Func<StatWeburlEntity, bool>> predicate)
		{
		...
		/// <returns></returns>
		public virtual bool Add(StatWeburlEntity entity, bool IsCommit = true)
		{
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(StatWeburlEntity entity, bool IsCommit = true)
		{
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual bool AddList(IList<StatWeburlEntity> entityList, bool IsCommit = true)
		{
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual async Task<bool> AddListAsync(IList<StatWeburlEntity> entityList, bool IsCommit = true)
		{
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual bool AddOrUpdate(StatWeburlEntity entity, bool IsSave, bool IsCommit = true)
		{
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(StatWeburlEntity entity, bool IsSave, bool IsCommit = true)
		{
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual bool Delete(StatWeburlEntity entity, bool IsCommit = true)
		{
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual async Task<bool> DeleteAsync(StatWeburlEntity entity, bool IsCommit = true)
		{
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual bool DeleteList(IList<StatWeburlEntity> entityList, bool IsCommit = true)
		{
			if (entityList == null || entityList.Count == 0) return false;
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual async Task<bool> DeleteListAsync(IList<StatWeburlEntity> entityList, bool IsCommit = true)
		{
			if (entityList == null || entityList.Count == 0) return await Task.Run(() => false);
		...
		/// <returns></returns>
		public virtual bool Delete(Expression<Func<StatWeburlEntity, bool>> predicate, bool IsCommit = true)
		{
		...
		/// <param name="IsCommit"></param>
		/// <returns></returns>
		public virtual async Task<bool> DeleteAsync(Expression<Func<StatWeburlEntity, bool>> predicate, bool IsCommit = true)
		{
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual bool Update(StatWeburlEntity entity, bool IsCommit = true)
		{
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(StatWeburlEntity entity, bool IsCommit = true)
		{
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual bool UpdateList(IList<StatWeburlEntity> entityList, bool IsCommit = true)
		{
			if (entityList == null || entityList.Count == 0) return false;
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateListAsync(IList<StatWeburlEntity> entityList, bool IsCommit = true)
		{
			if (entityList == null || entityList.Count == 0) return await Task.Run(() => false);
		...
		/// <returns></returns>
		public virtual StatWeburlEntity Get(Expression<Func<StatWeburlEntity, bool>> predicate)
		{
		...
		/// <param name="predicate">Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual async Task<StatWeburlEntity> GetAsync(Expression<Func<StatWeburlEntity, bool>> predicate)
		{
		...
		/// <returns></returns>
		public virtual IQueryable<StatWeburlEntity> LoadAll(Expression<Func<StatWeburlEntity, bool>> predicate, params SortModelField[] orderByExpression)
		{
		...
		/// <param name="orderByExpression">多字段排序</param>
		/// <returns></returns>
		public virtual async Task<IQueryable<StatWeburlEntity>> LoadAllAsync(Expression<Func<StatWeburlEntity, bool>> predicate, params SortModelField[] orderByExpression)
		{
		...
		/// <param name="orderByExpression">多字段排序</param>
		/// <returns></returns>
		public virtual List<StatWeburlEntity> LoadListAll(Expression<Func<StatWeburlEntity, bool>> predicate, params SortModelField[] orderByExpression)
		{
		...
		/// <param name="orderByExpression">多字段排序</param>
		/// <returns></returns>
		public virtual async Task<List<StatWeburlEntity>> LoadListAllAsync(Expression<Func<StatWeburlEntity, bool>> predicate, params SortModelField[] orderByExpression)
		{
		...
		/// <returns></returns>
		public virtual IQueryable<StatWeburlEntity> LoadAllBySql(string sql, params DbParameter[] para)
		{
		...
		/// <param name="para">Parameters参数</param>
		/// <returns></returns>
		public virtual async Task<IQueryable<StatWeburlEntity>> LoadAllBySqlAsync(string sql, params DbParameter[] para)
		{
		...
		/// <param name="para">Parameters参数</param>
		/// <returns></returns>
		public virtual List<StatWeburlEntity> LoadListAllBySql(string sql, params DbParameter[] para)
		{
		...
		/// <param name="para">Parameters参数</param>
		/// <returns></returns>
		public virtual async Task<List<StatWeburlEntity>> LoadListAllBySqlAsync(string sql, params DbParameter[] para)
		{
		...
		/// <returns></returns>
		public virtual IList<StatWeburlEntity> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			Total=0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<StatWeburlEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			Total=0;
		...
		/// <param name="para"></param>
		/// <returns></returns>
		public virtual TResult GetBySQL<TResult>(string sql, Expression<Func<StatWeburlEntity, TResult>> scalar, params IDataParameter[] para)
		{
		...
		/// <param name="para"></param>
		/// <returns></returns>
		public virtual async Task<TResult> GetBySQLAsync<TResult>(string sql, Expression<Func<StatWeburlEntity, TResult>> scalar, params IDataParameter[] para)
		{
		...
		/// <param name="paraValue"></param>
		/// <returns></returns>
		public virtual TResult GetBySQL<TResult>(string sql, Expression<Func<StatWeburlEntity, TResult>> scalar, string[] paraName, object[] paraValue)
		{
		...
		/// <param name="paraValue"></param>
		/// <returns></returns>
		public virtual async Task<TResult> GetBySQLAsync<TResult>(string sql, Expression<Func<StatWeburlEntity, TResult>> scalar, string[] paraName, object[] paraValue)
		{
		...
		/// <param name="dict"></param>
		/// <returns></returns>
		public virtual TResult GetBySQL<TResult>(string sql, Expression<Func<StatWeburlEntity, TResult>> scalar, Dictionary<string, object> dict)
		{
		...
		/// <param name="dict"></param>
		/// <returns></returns>
		public virtual async Task<TResult> GetBySQLAsync<TResult>(string sql, Expression<Func<StatWeburlEntity, TResult>> scalar, Dictionary<string, object> dict)
		{
