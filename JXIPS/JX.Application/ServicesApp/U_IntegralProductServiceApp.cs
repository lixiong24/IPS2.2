...
namespace JX.Application
{
	...
	public partial class U_IntegralProductServiceApp : IU_IntegralProductServiceApp
	{
		...
		/// <param name="para"></param>
		/// <returns></returns>
		public virtual TResult GetBySQL<TResult>(string sql, Expression<Func<U_IntegralProductEntity, TResult>> scalar, params DbParameter[] para)
		{
		...
		/// <param name="para"></param>
		/// <returns></returns>
		public virtual async Task<TResult> GetBySQLAsync<TResult>(string sql, Expression<Func<U_IntegralProductEntity, TResult>> scalar, params DbParameter[] para)
		{
