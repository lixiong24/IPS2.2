...
namespace JX.Application
{
	...
	public partial class StatBrowserServiceApp : IStatBrowserServiceApp
	{
		...
		/// <param name="para"></param>
		/// <returns></returns>
		public virtual TResult GetBySQL<TResult>(string sql, Expression<Func<StatBrowserEntity, TResult>> scalar, params DbParameter[] para)
		{
		...
		/// <param name="para"></param>
		/// <returns></returns>
		public virtual async Task<TResult> GetBySQLAsync<TResult>(string sql, Expression<Func<StatBrowserEntity, TResult>> scalar, params DbParameter[] para)
		{
