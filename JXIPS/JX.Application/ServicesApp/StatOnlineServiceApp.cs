...
namespace JX.Application
{
	...
	public partial class StatOnlineServiceApp : IStatOnlineServiceApp
	{
		...
		/// <param name="para"></param>
		/// <returns></returns>
		public virtual TResult GetBySQL<TResult>(string sql, Expression<Func<StatOnlineEntity, TResult>> scalar, params DbParameter[] para)
		{
		...
		/// <param name="para"></param>
		/// <returns></returns>
		public virtual async Task<TResult> GetBySQLAsync<TResult>(string sql, Expression<Func<StatOnlineEntity, TResult>> scalar, params DbParameter[] para)
		{
