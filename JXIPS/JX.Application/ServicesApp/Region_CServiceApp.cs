...
namespace JX.Application
{
	...
	public partial class Region_CServiceApp : IRegion_CServiceApp
	{
		...
		/// <param name="para"></param>
		/// <returns></returns>
		public virtual TResult GetBySQL<TResult>(string sql, Expression<Func<Region_CEntity, TResult>> scalar, params DbParameter[] para)
		{
		...
		/// <param name="para"></param>
		/// <returns></returns>
		public virtual async Task<TResult> GetBySQLAsync<TResult>(string sql, Expression<Func<Region_CEntity, TResult>> scalar, params DbParameter[] para)
		{
