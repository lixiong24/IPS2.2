...
namespace JX.Application
{
	...
	public partial class AuthorServiceApp : IAuthorServiceApp
	{
		...
		/// <param name="para"></param>
		/// <returns></returns>
		public virtual TResult GetBySQL<TResult>(string sql, Expression<Func<AuthorEntity, TResult>> scalar, params DbParameter[] para)
		{
		...
		/// <param name="para"></param>
		/// <returns></returns>
		public virtual async Task<TResult> GetBySQLAsync<TResult>(string sql, Expression<Func<AuthorEntity, TResult>> scalar, params DbParameter[] para)
		{
