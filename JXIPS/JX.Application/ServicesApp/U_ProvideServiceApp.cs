...
namespace JX.Application
{
	...
	public partial class U_ProvideServiceApp : IU_ProvideServiceApp
	{
		...
		/// <param name="para"></param>
		/// <returns></returns>
		public virtual TResult GetBySQL<TResult>(string sql, Expression<Func<U_ProvideEntity, TResult>> scalar, params DbParameter[] para)
		{
		...
		/// <param name="para"></param>
		/// <returns></returns>
		public virtual async Task<TResult> GetBySQLAsync<TResult>(string sql, Expression<Func<U_ProvideEntity, TResult>> scalar, params DbParameter[] para)
		{
