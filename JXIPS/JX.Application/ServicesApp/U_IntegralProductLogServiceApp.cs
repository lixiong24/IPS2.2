...
namespace JX.Application
{
	...
	public partial class U_IntegralProductLogServiceApp : IU_IntegralProductLogServiceApp
	{
		...
		/// <param name="para"></param>
		/// <returns></returns>
		public virtual TResult GetBySQL<TResult>(string sql, Expression<Func<U_IntegralProductLogEntity, TResult>> scalar, params DbParameter[] para)
		{
		...
		/// <param name="para"></param>
		/// <returns></returns>
		public virtual async Task<TResult> GetBySQLAsync<TResult>(string sql, Expression<Func<U_IntegralProductLogEntity, TResult>> scalar, params DbParameter[] para)
		{
