...
namespace JX.Application
{
	...
	public partial class AdvertisementZoneServiceApp : IAdvertisementZoneServiceApp
	{
		...
		/// <param name="para"></param>
		/// <returns></returns>
		public virtual TResult GetBySQL<TResult>(string sql, Expression<Func<AdvertisementZoneEntity, TResult>> scalar, params DbParameter[] para)
		{
		...
		/// <param name="para"></param>
		/// <returns></returns>
		public virtual async Task<TResult> GetBySQLAsync<TResult>(string sql, Expression<Func<AdvertisementZoneEntity, TResult>> scalar, params DbParameter[] para)
		{
