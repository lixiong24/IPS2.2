...
namespace JX.Application
{
	...
	public partial class TrademarkServiceApp : ITrademarkServiceApp
	{
		...
		/// <param name="para"></param>
		/// <returns></returns>
		public virtual TResult GetBySQL<TResult>(string sql, Expression<Func<TrademarkEntity, TResult>> scalar, params DbParameter[] para)
		{
		...
		/// <param name="para"></param>
		/// <returns></returns>
		public virtual async Task<TResult> GetBySQLAsync<TResult>(string sql, Expression<Func<TrademarkEntity, TResult>> scalar, params DbParameter[] para)
		{
