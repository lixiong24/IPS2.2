...
{
	/// <summary>
	/// 数据库表：DownloadErrorLog 的应用层服务接口实现类.
	/// </summary>
	public partial class DownloadErrorLogServiceApp : IDownloadErrorLogServiceApp
	{
		#region 仓储接口
		private readonly IDownloadErrorLogRepository _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public DownloadErrorLogServiceApp(IDownloadErrorLogRepository repository)
		{
		...
		/// <returns></returns>
		public virtual TResult GetScalar<TResult, TOrderBy>(Expression<Func<DownloadErrorLogEntity, TResult>> scalar, Expression<Func<DownloadErrorLogEntity, bool>> predicate = null, Expression<Func<DownloadErrorLogEntity, TOrderBy>> orderby = null, bool IsAsc = true)
		{
		...
		/// <param name="IsAsc">排序方向，true为正序false为倒序</param>
		/// <returns></returns>
		public virtual async Task<TResult> GetScalarAsync<TResult, TOrderBy>(Expression<Func<DownloadErrorLogEntity, TResult>> scalar, Expression<Func<DownloadErrorLogEntity, bool>> predicate = null, Expression<Func<DownloadErrorLogEntity, TOrderBy>> orderby = null, bool IsAsc = true)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual TResult GetMax<TResult>(Expression<Func<DownloadErrorLogEntity, TResult>> max, Expression<Func<DownloadErrorLogEntity, bool>> predicate = null)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual async Task<TResult> GetMaxAsync<TResult>(Expression<Func<DownloadErrorLogEntity, TResult>> max, Expression<Func<DownloadErrorLogEntity, bool>> predicate = null)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual TResult GetMin<TResult>(Expression<Func<DownloadErrorLogEntity, TResult>> min, Expression<Func<DownloadErrorLogEntity, bool>> predicate = null)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual async Task<TResult> GetMinAsync<TResult>(Expression<Func<DownloadErrorLogEntity, TResult>> min, Expression<Func<DownloadErrorLogEntity, bool>> predicate = null)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual decimal GetAvg(Expression<Func<DownloadErrorLogEntity, decimal>> avg, Expression<Func<DownloadErrorLogEntity, bool>> predicate = null)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual async Task<decimal> GetAvgAsync(Expression<Func<DownloadErrorLogEntity, decimal>> avg, Expression<Func<DownloadErrorLogEntity, bool>> predicate = null)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual decimal GetSum(Expression<Func<DownloadErrorLogEntity, decimal>> sum, Expression<Func<DownloadErrorLogEntity, bool>> predicate = null)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual async Task<decimal> GetSumAsync(Expression<Func<DownloadErrorLogEntity, decimal>> sum, Expression<Func<DownloadErrorLogEntity, bool>> predicate = null)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual int GetCount(Expression<Func<DownloadErrorLogEntity, bool>> predicate = null)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual async Task<int> GetCountAsync(Expression<Func<DownloadErrorLogEntity, bool>> predicate = null)
		{
		...
		/// 验证当前条件是否存在相同项
		/// </summary>
		public virtual bool IsExist(Expression<Func<DownloadErrorLogEntity, bool>> predicate)
		{
		...
		/// 验证当前条件是否存在相同项（异步方式）
		/// </summary>
		public virtual async Task<bool> IsExistAsync(Expression<Func<DownloadErrorLogEntity, bool>> predicate)
		{
		...
		/// <returns></returns>
		public virtual bool Add(DownloadErrorLogEntity entity, bool IsCommit = true)
		{
			if(entity.ErrorID <= 0) entity.ErrorID=GetMax<int>(p=>p.ErrorID)+1;
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(DownloadErrorLogEntity entity, bool IsCommit = true)
		{
			if(entity.ErrorID <= 0) entity.ErrorID=GetMax<int>(p=>p.ErrorID)+1;
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual bool AddList(IList<DownloadErrorLogEntity> entityList, bool IsCommit = true)
		{
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual async Task<bool> AddListAsync(IList<DownloadErrorLogEntity> entityList, bool IsCommit = true)
		{
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual bool AddOrUpdate(DownloadErrorLogEntity entity, bool IsSave, bool IsCommit = true)
		{
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(DownloadErrorLogEntity entity, bool IsSave, bool IsCommit = true)
		{
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual bool Delete(DownloadErrorLogEntity entity, bool IsCommit = true)
		{
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual async Task<bool> DeleteAsync(DownloadErrorLogEntity entity, bool IsCommit = true)
		{
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual bool DeleteList(IList<DownloadErrorLogEntity> entityList, bool IsCommit = true)
		{
			if (entityList == null || entityList.Count == 0) return false;
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual async Task<bool> DeleteListAsync(IList<DownloadErrorLogEntity> entityList, bool IsCommit = true)
		{
			if (entityList == null || entityList.Count == 0) return await Task.Run(() => false);
		...
		/// <returns></returns>
		public virtual bool Delete(Expression<Func<DownloadErrorLogEntity, bool>> predicate, bool IsCommit = true)
		{
		...
		/// <param name="IsCommit"></param>
		/// <returns></returns>
		public virtual async Task<bool> DeleteAsync(Expression<Func<DownloadErrorLogEntity, bool>> predicate, bool IsCommit = true)
		{
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual bool Update(DownloadErrorLogEntity entity, bool IsCommit = true)
		{
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(DownloadErrorLogEntity entity, bool IsCommit = true)
		{
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual bool UpdateList(IList<DownloadErrorLogEntity> entityList, bool IsCommit = true)
		{
			if (entityList == null || entityList.Count == 0) return false;
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateListAsync(IList<DownloadErrorLogEntity> entityList, bool IsCommit = true)
		{
			if (entityList == null || entityList.Count == 0) return await Task.Run(() => false);
		...
		/// <returns></returns>
		public virtual DownloadErrorLogEntity Get(Expression<Func<DownloadErrorLogEntity, bool>> predicate)
		{
		...
		/// <param name="predicate">Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual async Task<DownloadErrorLogEntity> GetAsync(Expression<Func<DownloadErrorLogEntity, bool>> predicate)
		{
		...
		/// <returns></returns>
		public virtual IQueryable<DownloadErrorLogEntity> LoadAll(Expression<Func<DownloadErrorLogEntity, bool>> predicate, params SortModelField[] orderByExpression)
		{
		...
		/// <param name="orderByExpression">多字段排序</param>
		/// <returns></returns>
		public virtual async Task<IQueryable<DownloadErrorLogEntity>> LoadAllAsync(Expression<Func<DownloadErrorLogEntity, bool>> predicate, params SortModelField[] orderByExpression)
		{
		...
		/// <param name="orderByExpression">多字段排序</param>
		/// <returns></returns>
		public virtual List<DownloadErrorLogEntity> LoadListAll(Expression<Func<DownloadErrorLogEntity, bool>> predicate, params SortModelField[] orderByExpression)
		{
		...
		/// <param name="orderByExpression">多字段排序</param>
		/// <returns></returns>
		public virtual async Task<List<DownloadErrorLogEntity>> LoadListAllAsync(Expression<Func<DownloadErrorLogEntity, bool>> predicate, params SortModelField[] orderByExpression)
		{
		...
		/// <returns></returns>
		public virtual IQueryable<DownloadErrorLogEntity> LoadAllBySql(string sql, params DbParameter[] para)
		{
		...
		/// <param name="para">Parameters参数</param>
		/// <returns></returns>
		public virtual async Task<IQueryable<DownloadErrorLogEntity>> LoadAllBySqlAsync(string sql, params DbParameter[] para)
		{
		...
		/// <param name="para">Parameters参数</param>
		/// <returns></returns>
		public virtual List<DownloadErrorLogEntity> LoadListAllBySql(string sql, params DbParameter[] para)
		{
		...
		/// <param name="para">Parameters参数</param>
		/// <returns></returns>
		public virtual async Task<List<DownloadErrorLogEntity>> LoadListAllBySqlAsync(string sql, params DbParameter[] para)
		{
		...
		/// <returns></returns>
		public virtual IList<DownloadErrorLogEntity> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			Total=0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<DownloadErrorLogEntity> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			Total=0;
		...
		/// <param name="para"></param>
		/// <returns></returns>
		public virtual TResult GetBySQL<TResult>(string sql, Expression<Func<DownloadErrorLogEntity, TResult>> scalar, params IDataParameter[] para)
		{
		...
		/// <param name="para"></param>
		/// <returns></returns>
		public virtual async Task<TResult> GetBySQLAsync<TResult>(string sql, Expression<Func<DownloadErrorLogEntity, TResult>> scalar, params IDataParameter[] para)
		{
		...
		/// <param name="paraValue"></param>
		/// <returns></returns>
		public virtual TResult GetBySQL<TResult>(string sql, Expression<Func<DownloadErrorLogEntity, TResult>> scalar, string[] paraName, object[] paraValue)
		{
		...
		/// <param name="paraValue"></param>
		/// <returns></returns>
		public virtual async Task<TResult> GetBySQLAsync<TResult>(string sql, Expression<Func<DownloadErrorLogEntity, TResult>> scalar, string[] paraName, object[] paraValue)
		{
		...
		/// <param name="dict"></param>
		/// <returns></returns>
		public virtual TResult GetBySQL<TResult>(string sql, Expression<Func<DownloadErrorLogEntity, TResult>> scalar, Dictionary<string, object> dict)
		{
		...
		/// <param name="dict"></param>
		/// <returns></returns>
		public virtual async Task<TResult> GetBySQLAsync<TResult>(string sql, Expression<Func<DownloadErrorLogEntity, TResult>> scalar, Dictionary<string, object> dict)
		{
